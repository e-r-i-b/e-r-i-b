...
public class RetailMessagingTest extends RSRetaileGateTestCaselBase
{
	...
	{
		String testXml = "com/rssl/phizicgate/rsV51/messaging/mock/xml/getRateCurrency_q_body.xml";

		Document document = XmlHelper.loadDocumentFromResource(testXml);

		RetailMessageGeneratorB rmg = new RetailMessageGeneratorB();

		RetailMessageData data = rmg.buildMessage(document, null, null);
	...
	public void testResponseParser() throws Exception
	{
		...
		parseFile("com/rssl/phizicgate/rsV51/messaging/mock/xml/commissionPay_a.xml", handler);
		...
		parseFile("com/rssl/phizicgate/rsV51/messaging/mock/xml/error_a.xml", handler);

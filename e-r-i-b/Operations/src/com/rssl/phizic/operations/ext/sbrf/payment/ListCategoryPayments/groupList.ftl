...
FROM (
    ...
    FROM
        ...
        (SELECT id, name, DESCRIPTION, IMAGE_ID, IMAGE_NAME FROM PAYMENT_SERVICES WHERE PAYMENT_SERVICES.PARENT_ID is null AND PAYMENT_SERVICES.SYSTEM = 0 AND PAYMENT_SERVICES.VISIBLE_IN_SYSTEM = 1) servGroup

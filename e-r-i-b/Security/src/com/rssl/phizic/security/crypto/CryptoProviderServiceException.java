...
public class CryptoProviderServiceException extends SystemException
{
	 ...
	 * @since 1.4
	 */
	public CryptoProviderServiceException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 *                #getMessage()} method.
	 */
	public CryptoProviderServiceException(String message)
	{
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public CryptoProviderServiceException(String message, Throwable cause)
	{
		super(message, cause);
	}
}
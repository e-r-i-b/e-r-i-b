package com.rssl.phizic.security.ext.sevb.crypto;

import com.rssl.phizic.security.crypto.AbstractCryptoService;
 ...
 * @ $Revision$
 */
public class SBRFCryptoService extends AbstractCryptoService
{
	...
	public byte[] hash(byte[] m, String algorithm)
	{
		if (HashAlgorithms.GOST_SBERBANK.equals(algorithm))
			return hashSber(m);
		else
			throw new UnsupportedOperationException();
	}

	public synchronized byte[] hash(byte[] data, HashAlgorithms algorithm)
	{
		return hashSber(data);
	}

...
/**
 * Возникает в случае попытки вставить дубликат ПИН
 *
 * @author Roshka
 * @ created 24.08.2006
 * @ $Author$
 * @ $Revision$
 */
public class DuplicatePINException extends SecurityLogicException
{
	/**
	 ...
	 * @since 1.4
	 */
	public DuplicatePINException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @since 1.4
	 */
	public DuplicatePINException(String message, Throwable cause)
	{
		super(message, cause);
	}
}
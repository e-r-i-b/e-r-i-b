 ...
 * @ $Revision$
 */
public class RapidaDocumentManager extends RapidaPaymentRetailSender
{
	...
	public RapidaDocumentManager(GateFactory factory)
	{
		super(factory);
	}
	...
	private void initialize()
	{
		...
		retailParameters.put(RapidaPaymentRetailSender.PARAMETER_OPERATION_TYPE_NAME, retailOperationType);

...
public class RSRetailV6r20Executor implements Executor
{
	private static final String SESSION_FACTORY_JNDI_NAME = "hibernate/session-factory/RSRetailV6r20";
	 ...
	 */
	public static RSRetailV6r20Executor getInstance()
	{
		/*
	 ...
	 */
	public static RSRetailV6r20Executor getInstance(boolean useTransaction)
	{
		try
		{
			return new RSRetailV6r20Executor(useTransaction, sessionStorage, transactionStorage);
		}
	 ...
	 */
	private RSRetailV6r20Executor(boolean useTransaction,

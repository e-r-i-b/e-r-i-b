...
import com.rssl.phizicgate.rsretailV6r20.bankroll.BankrollServiceImpl;
import com.rssl.phizicgate.rsretailV6r20.bankroll.AccountImpl;
...
public class DepositServiceImpl extends AbstractService implements DepositService
{
    ...
    public List<? extends Deposit> getClientDeposits(final Client client) throws GateException
    {
		try
		{
		    List<DepositImpl> list = RSRetailV6r20Executor.getInstance().execute(new HibernateAction<List<DepositImpl>>()
		    {

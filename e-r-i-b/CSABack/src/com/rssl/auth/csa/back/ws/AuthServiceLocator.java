...
public class AuthServiceLocator extends org.apache.axis.client.Service implements com.rssl.auth.csa.back.ws.AuthService {
    ...
    public com.rssl.auth.csa.back.ws.AuthServicePortType getAuthServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.auth.csa.back.ws.AuthServicePortType getAuthServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.auth.csa.back.ws.AuthServiceSoapBindingStub _stub = new com.rssl.auth.csa.back.ws.AuthServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.auth.csa.back.ws.AuthServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.auth.csa.back.ws.AuthServiceSoapBindingStub _stub = new com.rssl.auth.csa.back.ws.AuthServiceSoapBindingStub(new java.net.URL(AuthServicePort_address), this);
                _stub.setPortName(getAuthServicePortWSDDServiceName());
                return _stub;
            }
        }

        ...
        <div class="g-main_inner">
            ...
            <div class="g-content">
                ...
                <div class="b-message">
                    ...
                    <div class="moved">
                        <p>Если вы забыли свой пароль, воспользуйтесь <a href="${form.urlRecover}">формой восстановления пароля</a>.</p>
                        ...
                        <p>Если вы&nbsp;забыли логин, восстановите его, позвонив в&nbsp;Контактный центр Сбербанка по&nbsp;телефону&nbsp;<b>+7&nbsp;(495)&nbsp;500-55-50</b>
                            <c:if test="${form.visibleMultipleRegistrationPart}">
                                <br/><i class="positioned">либо</i><a
                                        href="${form.urlRegistration}">Зарегистрируйтесь заново</a>, создав новые логин и&nbsp;пароль.

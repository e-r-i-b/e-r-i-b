...
<html:form action="/private/payments/check_print" onsubmit="return setEmptyAction(event)">
...
<tiles:insert definition="check">
    ...
    <div id="checkId" class="mainDiv">
        ...
        <div class="checkSize titleAdditional">чек по операции<br><bean:message bundle="commonBundle" key="application.title"/></div><br/>
		${form.html}

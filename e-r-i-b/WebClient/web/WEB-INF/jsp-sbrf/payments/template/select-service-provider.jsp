...
<html:form action="/private/template/select-service-provider" onsubmit="return setEmptyAction();">
    ...
    <tiles:insert definition="autopayProviders">
        ...
        <tiles:put name="data" type="string">
            ...
            <tiles:insert definition="mainWorkspace" flush="false">
                <tiles:put name="title"><span class="size24">Создание шаблона</span></tiles:put>
                ...
                <tiles:put name="data">
                    ...
                    <c:if test="${fromFinanceCalendar}">
                        <c:set var="goBackURL" value="${goBackURL}?fromFinanceCalendar=true?extractId=${extractId}"/>
                    </c:if>
                    ...
                    <tiles:insert definition="formHeader" flush="false">
                        ...
                        <tiles:put name="description" value="Для создания шаблона выберите интересующую Вас операцию или воспользуйтесь поиском.">
                                                ...
                                                <c:if test="${stat.count <= itemsPerPage}">
                                                    <tiles:insert definition="serviceTemplate" flush="false">
                                                        ...
                                                        <tiles:put name="url"><c:url value="/private/template/select-service-provider.do">
                                                            ...
                                                            <phiz:param name="fromFinanceCalendar" value="${fromFinanceCalendar}"/>
                                                            <phiz:param name="extractId" value="${extractId}"/>
                                                         </c:url></tiles:put>
                                            ...
                                            <c:if test="${stat.count le itemsPerPage}">
                                                ...
                                                <tiles:insert definition="serviceTemplate" flush="false">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                           <c:set var="image" value="${imagePath}/IQWave-other.jpg" />
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <tiles:put name="imagePath" value="${image}"/>
                                                    <tiles:put name="defaultImagePath" value="${imagePath}/IQWave-other.jpg"/>
                                                    <tiles:put name="url">
                                                        <c:url value="/private/template/services-payments/edit.do">

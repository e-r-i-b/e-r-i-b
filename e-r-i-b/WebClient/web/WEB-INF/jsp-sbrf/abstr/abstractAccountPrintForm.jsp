             ...
             <tr>
                <td class="labelAbstractPrint">
                    ...
                    <c:if test="${not empty account.openDate}">
                        <span class="bold">${phiz:formatDateWithStringMonth(account.openDate)} г.</span>
                    </c:if>
                </td>
            </tr>
            <tr>
                ...
                <td class="labelAbstractPrint">
                    Счет:&nbsp;
                    <span class="bold">${account.description} в ${account.currency.code}</span>
                </td>
            </tr>
            <tr>
                <td class="labelAbstractPrint">
            ...
            <tr>
                <td class="labelAbstractPrint">
                   Выписка составлена за период&nbsp;
                    <span class="bold">с ${phiz:formatDateWithStringMonth(resourceAbstract.fromDate)} г.по ${phiz:formatDateWithStringMonth(resourceAbstract.toDate)} г.</span>
                </td>
            </tr>
            <tr>
                <td class="labelAbstractPrint">

    ...
    <c:if test="${fn:length(frm.regions) gt 0 and not frm.saved}">
        ...
        <div class="regionsAlphabetList">
            <div class="currentSBNKDRegion">
                ...
                <div>
                    <span id="regionChangeWindowNameSpan">
                        <c:choose>
            ...
            <tiles:insert definition="alphabet" flush="false">
                <tiles:put name="onClickFunctionName" value="selectSbnkdRegion"/>
        ...
        <script type="text/javascript">
            function selectSbnkdRegion(id, name, codeTB, saveRegion)
            {
                clickRegion.click(id, name, codeTB, saveRegion);
                return false;
            }
        </script>
    </c:if>

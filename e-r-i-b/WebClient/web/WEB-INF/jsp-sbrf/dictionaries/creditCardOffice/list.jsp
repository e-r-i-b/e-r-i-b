...
<html:form action="/private/credit-card-office/list">
                    ...
                    <tiles:put name="data">
                        <tiles:insert definition="formHeader" flush="false">
                            ...
                            <tiles:put name="description">
                                Укажите отделение, в котором Вам будет удобно забрать карту! <br>
                                Важно! Для получения карты у Вас должна быть постоянная или временная регистрация в регионе, в котором находится выбранное Вами отделение.
                            </tiles:put>
                        </tiles:insert>
                        <%-- Фильтр --%>
                                            ...
                                            <td>
                                                <div class="selectRegion">
                                                    ...
                                                    <tiles:insert definition="window" flush="false">
                                                        ...
                                                        <tiles:put name="loadAjaxUrl" value="${phiz:calculateActionURL(pageContext,'/dictionaries/regions/list')}?isOpening=true&id=0&saveRegion=false"/>
                        ...
                        <tiles:insert definition="simpleTableTemplate" flush="false">
                            <tiles:put name="id" value="regionsListTable"/>
                            <tiles:put name="grid">

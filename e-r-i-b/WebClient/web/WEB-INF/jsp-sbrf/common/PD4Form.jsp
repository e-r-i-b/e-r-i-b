...
<tiles:insert definition="accountInfo">
	...
	<tiles:put name="submenu" type="string" value="PrintForm/${type}"/>
	<!-- заголовок -->
	...
	<tiles:put name="menu" type="string">
		 <tiles:insert definition="clientButton" flush="false">
		        ...
		        <tiles:put name="onclick" value="clearForm(document.getElementById('PD4Form'))"/>
	     </tiles:insert>
		 <tiles:insert definition="clientButton" flush="false">
	...
	function setBankInfo(bankInfo)
    {
		if(bankOwner==1)
		{
			if(bankInfo["name"].length>18)bankInfo["name"]=bankInfo["shortName"];

			setElement('field(receiverBankName)',bankInfo["name"]);
		...
		{
			if(bankInfo["name"].length>18)bankInfo["name"]=bankInfo["shortName"];
			setElement('field(payerBankName)',bankInfo["name"]);
      		setElement('field(payerBIC)',bankInfo["BIC"]);
	  		setElement('field(payerCorAccount)',bankInfo["account"]);
		}
	}
	function fillBankInfo(bankName,bic,num)
	{
		bankOwner = num;
		openNationalBanksDictionary(setBankInfo,bankName,bic);
	}
	...
	function displayPeriodList(event,action)
	{
		...
		win=window.open("${phiz:calculateActionURL(pageContext, '/private/PD4.do')}?action="+action,"","resizable=1,menubar=0,toolbar=0,scrollbars=1,status=0");
...
//проверить правильность заполнения налогового периода
	...
	function checkFill()
	{
		...
		if(!SC_checkFields(document.getElementById("PD4Form")))
		{
			printErr();
			return false;
		}
		...
		if(!fnCheckField("field(receiverAccount)",TP_NUMB,true,20,20))res = false;
	...
	{
        el = document.getElementById(id);
		if(id == "payerKPPAster" || id == "payerINNAster" || id == "receiverINNAster" || id == "receiverKPPAster"){
            if(el != null)
    ...
    <tiles:insert definition="paymentForm" flush="false">
        <tiles:put name="id" value="RurPayment"/>
        <tiles:put name="name" value="Печать платежного документа"/>
        <tiles:put name="description" value="Используйте данную форму для печати платежных документов: ПД-4, ПД-4сб (налог), инкассовое поручение, платежное поручение"/>
        ...
        <tiles:put name="data">
            <tr>
                <td class="Width120 LabelAll">Налоговый документ</td>
                <td><html:checkbox style="border:none" styleId="field(tax)" property="field(tax)" onclick="javascript:chooseTax(event);"/></td>
            </tr>
            <tr>
				<td class="Width120 LabelAll" valign="top">Вид документа<span class="asterisk">*</span></td>
				<td>
					...
					<bean:define id="type" name="PD4Form" property="type"/>
						 <c:choose>
								...
								<c:when test="${type == 'pay'}">
                                 ...
                                 <c:when test="${type == 'nalog'}">
									<c:set  var="sel" value="pdNalog"/>
								</c:when>
	 							<c:otherwise>
									<c:set  var="sel" value="pd"/>
								</c:otherwise>
            ...
            <!--Плательщик-->
			<tr>
				<td colspan="2" class="pmntInfAreaTitle">&nbsp;<b>Плательщик</b></td>
			</tr>
	        ...
	        <tr>
				...
				<td><html:text property="field(payerAccount)"size="28" maxlength="24" styleId="field(payerAccount)"  onkeydown="enterNumericFld(event,this);"/></td>
			</tr>
		    <tr  id="payerINN" style="display:none">
				<td class="Width120 LabelAll" valign="top">
					<table cellspacing="0" cellpadding="0" border=0><tr><td><b>ИНН&nbsp;</b><span id="payerINNAster" class="asterisk">*</span></td></tr></table>
				</td>
		    ...
		    <tr  id="payerKPP" style="display:none">
				<td class="Width120 LabelAll" valign="top">
					<table cellspacing="0" cellpadding="0" border=0><tr><td><b>КПП&nbsp;</b><span id="payerKPPAster" class="asterisk">*</span></td></tr></table>
				</td>
			...
			<tr id="payerBank"  style="display:none">
				<td colspan="2" class="pmntInfAreaTitle"><b>&nbsp;Банк плательщика</b></td>
			</tr>
			<tr id="payerBankName"  style="display:none">
                ...
                <td>
                    ...
                    <tr>
                        <td>
				        <html:text property="field(payerBankName)" size="67" maxlength="27" styleId="field(payerBankName)"/>
			...
			<tr id="payerBIKCor"  style="display:none">
				...
				<td><html:text property="field(payerBIC)" maxlength="9" size="11" styleId="field(payerBIC)"  onkeydown="enterNumericFld(event,this);"/>
                    <span class="Width120 LabelAll" style="width: 70px;">Корр. счет</span>
            ...
            <!--Получатель платежа-->
			<tr>
				<td colspan="2"  class="pmntInfAreaTitle">&nbsp;<b>Получатель платежа</b></td>
			</tr>
			<tr>
				<td class="Width120 LabelAll">Наименование <span class="asterisk">*</span></td>
				<td>
			...
			<tr>
				...
				<td><html:text property="field(receiverAccount)" maxlength="20" size="24" styleId="field(receiverAccount)"  onkeydown="enterNumericFld(event,this);"/></td>
			</tr>
			<tr>
				<td class="Width120 LabelAll">
					<table cellspacing="0" cellpadding="0" border=0><tr><td><b>ИНН&nbsp;</b><span id="receiverINNAster" class="asterisk">*</span></td></tr></table>
				</td>
			...
			<tr id="receiverKPP">
				<td class="Width120 LabelAll">
					<table cellspacing="0" cellpadding="0" border=0><tr><td><b>КПП&nbsp;</b><span id="receiverKPPAster" class="asterisk">*</span></td></tr></table>
				</td>
            ...
            <!--Банк получателя-->
			<tr>
				<td colspan="2"  class="pmntInfAreaTitle"><b>&nbsp;Банк получателя</b></td>
			</tr>
			<tr>
				<td class="Width120 LabelAll">Наименование<span class="asterisk">*</span></td>
                <td>
			...
			<tr>
				...
				<td><html:text property="field(ground)" size="80" maxlength="48" styleId="field(ground)"/></td>
			</tr>
			<tr>
			...
			<tr id="taxHeader"  style="display:none">
				<td colspan="2"  class="pmntInfAreaTitle">&nbsp;<b>Налоговые поля</b></td>
			</tr>
            ...
            <tr id="kbk" style="display:none">
				...
				<td><html:text property="field(KBK)" maxlength="20" size="24" styleId="field(KBK)"  onkeydown="enterNumericFld(event,this);"/>
					<span class="LabelAll">Код ОКАТО<span class="asterisk">*</span></span>
			...
			<tr id="penalty"  style="display:none">
				...
				<td><html:text property="field(fine)" size="12" maxlength="12" styleId="field(fine)" onkeydown="enterNumericFld(event,this);"/>руб.
					...
					<span class="LabelAll">Штраф</span>

...
<!--TODO использовать шаблон print или printDoc--> 	
...
<tiles:put name="data" type="string">
  ...
  <table>
   <tr>
	...
	<td>
	  <table>
	   <tr>
	    <td colspan="2">
			Информация по счету № <b><bean:write name="account" property="number"/></b> в АКБ «Банк Сбережений и Кредита»
		<td>
	   </tr>
	   <tr>
	    <td>Клиент:</td>
   ...
   <tr>
    <td></td>
	<td>
		<table cellspacing="0" cellpadding="0" class="userTab" width="600px" align="center">
			<tr>

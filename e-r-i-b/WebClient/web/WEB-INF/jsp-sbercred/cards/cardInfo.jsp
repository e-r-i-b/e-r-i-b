...
<tiles:put name="pageTitle" type="string" value="Информация по карте">
</tiles:put>
...
<table width="80%" align="center">
	<tr><td><font class='listPayPart'>Информация по карте</font></td></tr>
	</table>
...
<% int lineNumber = 0;%>
	...
	<%lineNumber++;%>
	<tr class="ListLine<%=lineNumber%2%>">
		<td class="ListItem">Лимит задолженности</td>
		<td class="ListItem">
			<c:choose>
	...
	<c:if test="${card.main}">
		<%lineNumber++;%>
		<tr class="ListLine<%=lineNumber%2%>">
			<td class="ListItem">Текущая задолженность</td>
			<td class="ListItem">
				<c:choose>
					<c:when test="${!empty ShowCardInfoForm.overdraftInfo}">						

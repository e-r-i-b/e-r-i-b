...
<tiles:put name="data" type="string">
  ...
  <table>
   <tr>
	...
	<td>
	  <table>
	   <tr>
	    <td colspan="2">
			Информация по счету № <b><bean:write name="account" property="number"/></b><br>
		    <nobr>в АБ "Таатта" ЗАО</nobr>
		<td>
	   </tr>
	   <tr>
	    <td>Клиент:</td>
   ...
   <tr>
    <td></td>
	<td>
		<table cellspacing="0" cellpadding="0" border="1" width="60%" align="left">
			<tr>

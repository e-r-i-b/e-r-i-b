...
<c:if test="${phiz:impliesOperation('ShowCurrenciesRateOperation','CurrenciesRateInfo')}">
	...
	<tr><td class="infoTitle">Курсы валют</td></tr>
		<tr>
			<td class="rateOfExchange" align="center">
				<table class="UserTab backTransparent" cellpadding="0" cellspacing="0"/>
				<tr class="titleTable" style="padding-top:3px;">
					<td align="center" class="titleTable">Валюта</td>
					<td align="center" class="titleTable">Покупка</td>
					<td align="center" class="titleTable">Продажа</td>
				</tr>
				<tr>
					<td align="center" class="ListItem">USD</td>
				...
				<tr>
					<td align="center" class="ListItem">EUR</td>
					<td align="center" class="ListItem">

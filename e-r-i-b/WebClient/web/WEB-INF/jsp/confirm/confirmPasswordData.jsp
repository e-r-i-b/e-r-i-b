...
<html:form action="/confirm/password" show="true" method="post">
						...
						<td colspan="5" align="center">
							<table cellpadding="0" cellspacing="0" width="480px" height="150px" class="lpBase" border="0">
								<tr>
									...
									<td class="pmntBgBaseTop" colspan="2">
										<img src="${globalImagePath}/1x1.gif" alt="" width="1" height="1" border="0">
									</td>
								...
								<tr>
									...
									<td align="right" valign="top" width="80px" class="lpBtmLeftCorner">
										<img src="${globalImagePath}/logoIB.gif" alt="" height="66px" width="77px" border="0">
									</td>
															...
															<td>
																<table cellpadding="0" cellspacing="0">
																	<tr>
																		...
																		<td width="1%" valign="top" class="lpMessage" colspan="3">Для входа в систему введите:</td>
																		<td><img src="${globalImagePath}/1x1.gif" alt="" height="13px" width="10px" border="0"></td>
																	</tr>
																	<tr>
																	...
																	<tr>
																		...
																		<td class="lpInputArea">
																			<table cellpadding="0" cellspacing="0" width="100%">
																				<tr>
																					<td width="30%" style="white-space:nowrap;">Пароль</td>
																					<td align="center">
																						<html:password property="password" styleClass="inputLogin" maxlength="20"/>
																					</td>
																					<td width="30%" rowspan="3" class="tableArea"></td>
																				</tr>
																			</table>
																		</td>

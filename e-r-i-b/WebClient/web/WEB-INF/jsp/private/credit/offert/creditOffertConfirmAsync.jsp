...
<c:set var="thisActionUrl" value="/private/async/credit/offert/confirm"/>
<html:form action="${thisActionUrl}">
    ...
    <tiles:insert  definition="confirm_sms" flush="false">
        ...
        <tiles:put name="confirmableObject" value="creditOffert"/>
        ...
        <tiles:put name="confirmCommandKey" value="button.getOfferMoney"/>
        <tiles:put name="data">
        </tiles:put>

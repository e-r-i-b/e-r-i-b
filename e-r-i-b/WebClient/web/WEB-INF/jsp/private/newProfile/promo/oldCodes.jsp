...
<html:form action="/private/userprofile/promoCodes">
    ...
    <c:set var="errorBack" value="${imagePath}/tintedNet.gif"/>
    <c:set var="lock" value="${imagePath}/csa/lock.jpg"/>
                    ...
                    <c:choose>
                        ...
                        <c:when test="${(not empty form.activePromoCodes or not empty form.archivePromoCodes) and showList}">
                            <c:if test="${not empty form.activePromoCodes}">
                                <div id="activePromoCode">
                                    <table class="promoOldProfileCodeList">
                                        <tr>
                                ...
                                <tiles:insert definition="window" flush="false">
                                    ...
                                    <tiles:put name="data">
                                        ...
                                        <h2><c:out value="${form.messageSeven.title}" default=""/></h2>
                        ...
                        <c:otherwise>
                            <div id="promoCodeInvite">
                                <div id="promoUpLeft">
                                    <div class="promoTitle"><c:out value="${form.messageNine.title}" default=""/></div>
                                    <div class="promoMessage">${phiz:processBBCodeAndEscapeHtml(form.messageNine.text,false)}</div>
                                </div>
                                <div id="promoDownRight">
                                    <div class="promoTitle"><c:out value="${form.messageTen.title}" default=""/></div>

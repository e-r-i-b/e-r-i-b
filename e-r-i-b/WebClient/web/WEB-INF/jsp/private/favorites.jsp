...
<tiles:insert definition="leftMenuLink" service="Abstract">
	...
	<tiles:put name="text"    value="Выписка"/>
...
<tiles:insert definition="leftMenuLink" service="ElectricPayment">
	<tiles:put name="enabled" value="${submenu != 'ElectricPayment'}"/>
	<tiles:put name="action"  value="/private/payments/payment?form=ElectricPayment"/>

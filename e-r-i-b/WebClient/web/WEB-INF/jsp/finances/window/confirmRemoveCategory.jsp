...
<div class="confirmWindowMessage">
    Вы действительно хотите удалить категорию &laquo;<span id="removedCategoryName"></span>&raquo;?
</div>
...
<div class="tableArea pfpButtonsBlock">
    <tiles:insert definition="clientButton" flush="false">
        ...
        <tiles:put name="onclick" value="win.close('confirmRemoveCategory');"/>
    ...
    <tiles:insert definition="clientButton" flush="false">
        ...
        <tiles:put name="bundle" value="financesBundle"/>
        <tiles:put name="onclick" value="operationCategories.deleteCategory();"/>
    </tiles:insert>
</div>
...
<html:form action="/private/finances/operations" onsubmit="return setEmptyAction(event)">
                ...
                <tiles:put name="data">
                    ...
                    <tiles:insert definition="financeContainer" flush="false">
                        ...
                        <tiles:put name="infoText">
                            На этой странице Вы можете посмотреть историю Ваших поступлений и списаний.
                            Для Вашего удобства расчета по картам, открытым в валюте отличной от рублей,
                            суммы переведены в рубли, по курсу ЦБ на день операции. В диаграммах учтены операции только по картам.
                        </tiles:put>
                        <tiles:put name="data">
                            ...
                            <div class="filter triggerFilter">
                                ...
                                <html:link action="/private/finances/cashOperationsGraph">
                            ...
                            <div class="incomeOutcomeBlock">
                                <div class="sumPart">
                                    ...
                                    <div class="incomeOutcomeSum">${phiz:getStringInNumberFormat(form.income)} <bean:message bundle="financesBundle" key="currency.rub"/></div>
                                </div>
                                <div class="sumPart">
                                ...
                                <div class="sumPart">
                                    ...
                                    <div class="incomeOutcomeSum">${phiz:getStringInNumberFormat(form.outcome)} <bean:message bundle="financesBundle" key="currency.rub"/></div>
                                </div>
                                <div class="sumPart">
                                    <div class="incomeOutcomeSumDescr">&nbsp;</div>
                                    <div class="incomeOutcomeSum"> = </div>
                                ...
                                <div class="sumPart"> 
                                    ...
                                    <div class="incomeOutcomeSum">${phiz:getStringInNumberFormat(form.income - form.outcome)} <bean:message bundle="financesBundle" key="currency.rub"/></div>
                                </div>
                                <div class="clear"></div>
                            </div>

                            <div class="graphLegend">
                                <img src="${commonImagePath}/legend_green.gif"> Поступления
                                <img src="${commonImagePath}/legend_orange.gif"> Списания
                                <img src="${commonImagePath}/legend_blue.gif"> Итого по операциям
                            </div>
                            ...
                            <div class="financeGraphWithOperations">
                                <c:choose>
                                    <c:when test="${curType == 'month'}">
                                        <%@ include file="/WEB-INF/jsp/finances/operationsOnMonth.jsp"%>
                                    </c:when>
                                    <c:otherwise>
                                        <%@ include file="/WEB-INF/jsp/finances/operationsOnPeriod.jsp"%>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        </tiles:put>
    ...
    <c:set var="minDate" value="${phiz:addToDate(currDate, -1, -1, 0)}"/>
    ...
    <script type="text/javascript">
        function checkFilterDates()
        {
            ...
            var minDate = parseMonthDate('<fmt:formatDate value="${minDate}" pattern="MM/yyyy"/>');

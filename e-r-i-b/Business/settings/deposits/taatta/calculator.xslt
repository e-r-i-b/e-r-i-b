		...
		function calculate()
		{
			try
			{
				...
				else
				{
					...
					{
						writeError("<span class='asterisk'>Минимальная сумма вклада должна быть больше или равна " + tuple.minAmount + ".</span><br><span class='asterisk'>Введите корректное значение суммы.</span>");
					}
				}
			}
			catch ( ex )

...
<xsl:template name="html">
	<table border="0" cellspacing="0" cellpadding="2" width="100%">
		<tr>
			<td nowrap="true" class="label120"><b>&nbsp;Вид вклада&nbsp;</b></td>
			<td>&nbsp;<select id="deposit" class="culcInput" onChange="javascript:onDepositChanged();"></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="label120"><b>&nbsp;Валюта вклада&nbsp;</b></td>
			<td>&nbsp;<select id="currency" onChange="javascript:refreshTexts()"></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="label120"><b>&nbsp;Срок вклада&nbsp;</b></td>
			<td>&nbsp;<select id="period" onChange="javascript:refreshTexts()"></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="label120"><b>&nbsp;Минимальная сумма вклада&nbsp;</b></td>
			<td valign="top">&nbsp;<span id="minAmount"></span>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="label120"><b>&nbsp;Сумма вклада&nbsp;</b></td>
			<td>&nbsp;<input type="text" id="amount" class="culcInput"/>&nbsp;<span id="amountCurrency"></span>&nbsp;</td>
		</tr>
        <tr>
				...
				<span>
					<table cellpadding="0" cellspacing="0" width="1%">
						<tr>
							...
							<td class="btnBase"><img src="{$resourceRoot}/skins/green/images/iconSm_calculate.gif" alt="" border="0"/></td>
							<td class="btnBase" onclick="calculate();">Рассчитать</td>

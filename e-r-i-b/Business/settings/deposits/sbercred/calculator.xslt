...
<xsl:choose>
	...
	<script type="text/javascript">
		...
		{
			var text = "<table>"
					 + "<tr><td class='Width200 LabelAll'>Сумма денежных средств в конце срока вклада&nbsp;</td><td valign='top'>&nbsp;" + amount + "&nbsp;" + currency + "&nbsp;</td></tr>"
					 + "<tr><td class='Width200 LabelAll'>Сумма дохода по вкладу&nbsp;</td><td valign='top'>&nbsp;" + profit + "&nbsp;</td></tr>"
					 + "<tr><td class='Width200 LabelAll'>Размер процентной ставки&nbsp;</td><td valign='top'>&nbsp;" + rate + "%&nbsp;</td></tr>"
					 + "</table>"
					 + "<table>"
					 + "<tr><td><b>&nbsp;Приведенный расчет является приблизительным</b></td></tr>"
					 + "<tr><td><b>&nbsp;Реальные данные могут незначительно отличаться от расчета</b></td></tr>"
					 + "</table>";
	...
	<xsl:otherwise>
		<xsl:call-template name="NoDepositsInSelectHtml"/>
	</xsl:otherwise>
</xsl:choose>
</xsl:template>
...
<xsl:template name="html">
	<table border="0" cellspacing="0" cellpadding="2" width="100%">
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Вид вклада&nbsp;</td>
			<td>&nbsp;<select id="deposit" class="culcInput" onChange="javascript:onDepositChanged();"></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Валюта вклада&nbsp;</td>
			<td>&nbsp;<select id="currency" onChange="javascript:refreshTexts()"></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Срок вклада&nbsp;</td>
			<td>&nbsp;<select id="period" onChange="javascript:refreshTexts()"></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Минимальная сумма вклада&nbsp;</td>
			<td valign="top">&nbsp;<span id="minAmount"></span>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Сумма вклада&nbsp;</td>
...
<xsl:template name="NoDepositsInSelectHtml">
	<table border="0" cellspacing="0" cellpadding="2" width="100%">
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Вид вклада&nbsp;</td>
			<td>&nbsp;<select id="deposit" class="culcInput"><option>Нет видов</option></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Валюта вклада&nbsp;</td>
			<td>&nbsp;<select id="currency"><option>Нет валют</option></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Срок вклада&nbsp;</td>
			<td>&nbsp;<select id="period"><option>Нет сроков</option></select>&nbsp;</td>
		</tr>
		<tr>
			<td nowrap="true" class="Width200 LabelAll">Минимальная сумма вклада&nbsp;</td>
			<td valign="top">&nbsp;<span id="minAmount"></span>&nbsp;</td>
				...
				<tr>
				    ...
				    <td valign="center" align="middle" height="18">
				         <table class="submit" height="18" cellSpacing="0" cellPadding="2" width="100%" border="0"
				                onmouseover="this.className = 'submitOver';"
				                onmouseout="this.className = 'submit';">
							<tr><td class="handCursor">Рассчитать</td></tr>
						  </table>
					</td>
				    <td class="buttPartR" width="3" height="18">&nbsp;</td>
				</tr>
	...
	<script type="text/javascript">
		...
		<xsl:for-each select="data/element">
			...
			(
			    ...
			    <xsl:choose>
				    <xsl:when test="value[@field='formContr'] = '0'">
					    '<xsl:value-of select="'00-00-000'"/>',
				    </xsl:when>
				    <xsl:otherwise>

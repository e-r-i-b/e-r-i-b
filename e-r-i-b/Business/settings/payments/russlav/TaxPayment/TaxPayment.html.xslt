	...
	<xsl:template match="/form-data" mode="edit">
		...
		<table cellspacing="2" cellpadding="0" border="0"  class="paymentFon">
			...
			<tr>
				...
				<td><input id="receiverINN" name="receiverINN" type="text" value="{receiverINN}" size="20" maxlength="9"/></td>
			</tr>
			<tr>
				<td class="Width120 LabelAll">КПП<span class="asterisk">*</span></td>
				<td><input id="receiverKPP" name="receiverKPP" type="text" value="{receiverKPP}" size="20" maxlength="12"/></td>
			</tr>
			<tr>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/form-data" mode="edit">
		...
		<input id="receiverSurName" name="receiverSurName" type="hidden">
				<xsl:attribute name="value">
					<xsl:value-of select="receiverSurName"/>
			    </xsl:attribute>
		</input>

		<input id="receiverFirstName" name="receiverFirstName" type="hidden">
				<xsl:attribute name="value">
					<xsl:value-of select="receiverFirstName"/>
			    </xsl:attribute>
		</input>

		<input id="receiverPatrName" name="receiverPatrName" type="hidden">
				<xsl:attribute name="value">
		...
		<table cellspacing="2" cellpadding="0" border="0"  class="paymentFon">
		        ...
		        <td colspan="2" >
		            ...
		            <tr>
		                <td align="center" class="silverBott paperTitle">
		                    ...
		                    <tr>
		                        <td class="titleHelp">
		                             <span class="formTitle">Отзыв перевода по сети Contact</span>
		                             <br/>
		                             Используйте данную форму для отзыва перевода по сети CONTACT
		                        </td>
		                    </tr>
		                    </table>
		                </td>
			...
			<tr>
				<td class="Width120 LabelAll">Дата отзываемого перевода</td>
				<td>
			...
			<tr>
				...
				<td><input id="receiverSurName" name="receiverSurName" type="text" value="{receiverSurName}" size="20"  disabled="true"/></td>
			</tr>
			<tr>
				<td class="Width120 LabelAll">Имя</td>
				<td><input id="receiverFirstName" name="receiverFirstName" type="text" value="{receiverFirstName}" size="20"  disabled="true"/></td>
			</tr>
			<tr>
				<td class="Width120 LabelAll">Отчество</td>
				<td><input id="receiverPatrName" name="receiverPatrName" type="text" value="{receiverPatrName}" size="20" disabled="true"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input id="receiverBankCodeV" name="receiverBankCodeV" type="text" value="{receiverBankCode}" size="6" disabled="true"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input id="addInformation" name="addInformation" type="text" value="{addInformation}" size="60"  disabled="true"/></td>
			</tr>
			<tr><td colspan="2">&nbsp;</td></tr>
		</table>

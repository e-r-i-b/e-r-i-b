...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/list-data/filter-data">
		...
		<select name="state" onkeydown="onTabClick(event,'fromDate')">
			...
			<option value="S">Отправлен в банк получателя</option>
			<option value="A">Получен банком получателем</option>
			<option value="X">Выдан</option>
			<option value="C">Аннулирование</option>
			<option value="M">Изменение</option>
			<option value="L">Отозван</option>
			<option value="N">Возвращен</option>
			<option value="W">Принят</option>

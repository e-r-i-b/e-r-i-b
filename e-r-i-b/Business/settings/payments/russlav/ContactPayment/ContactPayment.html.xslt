...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/form-data" mode="edit">
		...
		<table cellspacing="2" cellpadding="0" border="0"  class="paymentFon">
		        ...
		        <td colspan="2" >
		            ...
		            <tr>
		                <td align="center" class="silverBott paperTitle">
		                    ...
		                    <tr>
		                        <td class="titleHelp">
		                             <span class="formTitle">Перевод по сети Contact</span>
		                             <br/>
		                             Быстрый перевод денежных средств с вашего счета в пользу физических лиц без открытия счета получателя.  
		                        </td>
		                    </tr>
		                    </table>
		                </td>
			...
			<tr>
				<td class="Width120 LabelAll">Валюта перевода</td>
				<td>
					...
					<select name="сurrencyCodeSelect"
						...
						<option>
							<xsl:attribute name="value">RUR</xsl:attribute>
							<xsl:if test="$currencyV = 'RUR'">
			...
			<tr>
				...
				<td><input id="receiverSurName" name="receiverSurName" type="text" value="{receiverSurName}" size="20"/><input type="button" class="buttWhite smButt"
						       onclick="javascript:openSelectReceiver();" value="..."/></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="Width120 LabelAll">Дата рождения</td>
				<td><input id="receiverBirthDay" name="receiverBirthday" type="text" value="{receiverBirthday}" size="12"/></td>
			</tr>
			<tr>
    ...
    <xsl:template match="/form-data" mode="view">
		<table cellspacing="2" cellpadding="0" class="PaymentFon" style="width:540px;">
			...
			<tr>
				<td class="Width120 LabelAll">Дата рождения</td>
				<td><xsl:value-of select="receiverBirthday"/></td>
			</tr>
			<tr>
				<td class="Width120 LabelAll" colspan="2" style="text-align:left;">&nbsp;<b>Реквизиты банка получателя</b></td>
			</tr>

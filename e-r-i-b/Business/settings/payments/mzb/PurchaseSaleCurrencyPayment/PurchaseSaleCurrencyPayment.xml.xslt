...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/form-data">
		<payment>
			...
			<extra-parameters>
				<parameter name="rur-currency"
						   value="RUB"
						   type="string"
						   />

				<parameter name="foreign-currency"
	            ...
	            <parameter name="from-account-type"
                           ...
                           type="string"
                           />
				<parameter name="to-account-currency"
                           value="{toAccountCurrency}"
                           type="string"
                           />
	            <parameter name="to-account-amount"
                           value="{toAccountAmount}"
                           type="string"
                           />
	            <parameter name="to-account-type"
                           value="{toAccountType}"
                           type="string"
                           />
                <parameter name="type"

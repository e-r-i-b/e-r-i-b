	...
	<xsl:template match="/list-data/filter-data">
		...
		<tr>
			...
			<select name="state" onkeydown="onTabClick(event,'fromDate')">
			   ...
			   <option value="W">На исполнении</option>
		...
		<tr>
			<td class="filter">Счет списания</td>
			<td class="filter">
		...
		<tr>
			<td class="filter">Счет получателя</td>
		    <td class="filter">
				<input name="receiverAccount" value="{receiverAccount}" type="text" style="width:200px" maxlength="20" class="filterInput"/>
			</td>
		</tr>
		</table>
	</xsl:template>

				...
				<tr>
					<td>
						...
						<tr style="7mm">
						  ...
						  <td></td>
						  <td colspan="4" align="center" class="ul" valign="bottom" style="font-size:9pt;">&nbsp;</td>
						  <td colspan="4"></td>
						</tr>
						<tr style="height:7mm">
						  <td colspan="7"></td>
						...
						<tr style="height:5mm">
                           ...
                           <td colspan="10">&nbsp;<xsl:value-of select="amount"/></td>
						</tr>
						...
						<tr style="height:10mm">
						   ...
						   <td colspan="10" valign="top">&nbsp;<xsl:value-of select="payerAccountSelect"/></td>
						</tr>
						<tr style="height:5mm">

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<tr>
		...
		<select name="state">
			...
			<option value="DISPATCHED,SENDED">Принят</option>
	...
	<tr>
		<td class="filter">Тип&nbsp;заявки</td>
		<td class="filter" style="font-weight:normal;">
		<select name="claimType">
			<option value=''>Все</option>
			<option value='AccountOpeningClaim'>Открытие счета</option>
			<option value='DepositOpeningClaim'>Открытие вклада</option>
		</select>
		</td>
	</tr>
	</table>

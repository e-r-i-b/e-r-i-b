...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<td>
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<td  class="filter">Причина перевыпуска</td>
				<td class="filter" style="font-weight:normal;">
					<select id="reason" name="reason">
						<option value="">Все</option>
						<option value="Смена фамилии">Смена фамилии</option>
						<option value="Порча карты">Порча карты</option>
						<option value="Утеря карты">Утеря карты</option>
						<option value="Утеря ПИН-конверта">Утеря ПИН-конверта</option>
						<option value="Досрочный перевыпуск">Досрочный перевыпуск</option>
						<option value="Кража">Кража</option>
						<option value="Переход на другую платежную систему">Переход на другую платежную систему</option>
					</select>
				</td>
			</tr>
			<tr>

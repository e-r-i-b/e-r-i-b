				...
				<tr>
					<td>
						<table style="width:172mm;height:100%;" cellpadding="0" cellspacing="0" class="textDoc">
							...
							<tr>
								<td align="center">
							<b><nobr>Коммерческий банк "ДЕМО Банк"</nobr><br/>
						...
						<table style="width:172mm;height:100%;" cellpadding="0" cellspacing="0" class="textDoc">
							<tr>
								<td>
                                 <table width='100%'>
                                  <tr>
                                   <td height="30"><nobr>Фамилия, имя, отчество:&nbsp;</nobr></td>
                                   <td class="insertInput" width='100%'>&nbsp;
							...
							<tr>
								<td>
                                    <table width='100%'>
                                     <tr>
                                      <td height="30"><nobr>Почтовый адрес:&nbsp;</nobr></td>
                                      <td class="insertInput" width='100%'>&nbsp;
                                          <xsl:variable name="currentPerson" select="document('currentPerson.xml')/entity-list"/>
							...
							<tr>
                                ...
                                <xsl:variable name="currentPerson" select="document('currentPerson.xml')/entity-list"/>
                                    ...
                                    <td class="insertInput" width='50%'>&nbsp;<xsl:value-of select="$currentPerson/entity/field[@name='homePhone']"/>&nbsp;&nbsp;<xsl:value-of select="$currentPerson/entity/field[@name='jobPhone']"/></td>
                                    <td>Телефакс:&nbsp;</td>
                                    <td class="insertInput" width='30%'>&nbsp;</td>
                                   </tr>
                                  </table>
								</td>
							</tr>
							<tr>
								<td height="30">
									...
									<input type="Text" readonly="true" class="insertInput" style="width:50%" align="center">
										<xsl:attribute name="value">&nbsp;<xsl:value-of select="toAccountSelect"/></xsl:attribute>
									</input>
								</td>
							</tr>
							<tr>
						...
						<table style="width:172mm;height:100%;" cellpadding="0" cellspacing="0" class="textDoc">
							<tr>
								<td align="left" width="620"  height="30">
									Прошу Демо Банк продать мне иностранную валюту на нижеследующих условиях:
								</td>
							</tr>
						</table>
				...
				<tr>
					<td>
						...
						по курсу банка:<input type="Text" readonly="true" class="insertInput" style="width:32%" align="center">
										<xsl:attribute name="value">
                                                                                        <xsl:value-of select="format-number(currencyRate, '#0.00')"/>&nbsp;
										</xsl:attribute>
									</input>
							...
							<tr>
								<td>
									...
									<input type="Text" readonly="true" class="insertInput" style="width:32%" align="center">
										<xsl:attribute name="value">&nbsp;<xsl:value-of select="fromAccountSelect"/>&nbsp;</xsl:attribute>
									</input>
									в АКБ "ДЕМОБАНК" (ЗАО).
								</td>
							</tr>
				...
				<tr>
					<td>
						<table style="width:172mm;height:100%;" cellpadding="0" cellspacing="0" class="textDoc">
							<tr>
								<td align="left" width="620"  height="30">
									Прошу Демо Банк приобрести у меня иностранную валюту на нижеследующих условиях:
								</td>
							</tr>
						</table>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/list-data/entity-list">
		<!-- заголовок списка -->
				<tr class="tblInfHeader">
					...
					<td nowrap="true">Сотовый оператор</td>
					<td nowrap="true">Номер телефона</td>
	...
	<xsl:template name="tableRow" match="/list-data/entity-list/entity">
		<tr>
			...
			<td class="listItem">
				&nbsp;<xsl:value-of select="attributes.operator-select.value"/>&nbsp;
			</td>
			<td class="listItem">
				 &nbsp;<xsl:value-of select="attributes.phone-code.value"/> - <xsl:value-of select="attributes.phone-number.value"/>&nbsp;
			</td>
			<td class="listItem">
...
<metaInformation>
<scenarios ><scenario default="yes" name="list&#x2D;>html" userelativepaths="yes" externalpreview="no" url="..\..\..\..\..\..\..\..\settings\claims\SecuritiesOperationsClaimDebugData\list&#x2D;data.xml" htmlbaseurl="" outputurl="" processortype="internal" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator=""/></scenarios><MapperMetaTag><MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no"/><MapperBlockPosition></MapperBlockPosition><TemplateContext></TemplateContext><MapperFilter side="source"></MapperFilter></MapperMetaTag>
</metaInformation>
-->
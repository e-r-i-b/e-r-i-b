	...
	<xsl:template match="/form-data">
		<document>
			<extra-parameters>
				...
				<parameter name="operator-select" value="{operatorSelect}" type="string"/>
				<parameter name="phone-code" value="{phoneCode}" type="string"/>
				<parameter name="phone-number" value="{phoneNumber}" type="string"/>

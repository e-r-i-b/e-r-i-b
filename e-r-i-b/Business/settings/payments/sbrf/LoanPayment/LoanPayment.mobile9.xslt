...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/form-data" mode="edit">
        <xsl:variable name="activeCards" select="document('stored-active-not-virtual-not-credit-cards.xml')/entity-list/*"/>
                    ...
                    <resourceType>
                        <availableValues>
                            ...
                            <valueItem>
                                ...
                                <xsl:if test="string-length(fromResourceCurrency)>0">
    ...
    <xsl:template match="/form-data" mode="edit-long-offer">
        <xsl:variable name="cards" select="document('stored-active-not-virtual-not-credit-cards.xml')/entity-list/*"/>
        <xsl:variable name="loans" select="document('different-loans.xml')/entity-list/*"/>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                exclude-result-prefixes="xalan au">
    ...
    <xsl:template match="/form-data" mode="edit">
        <initialData>
            ...
            <AccountClosingPayment>
                ...
                <xsl:variable name="activeCards" select="document('atm-possible-transfer-cards-at-closing.xml')/entity-list/*"/>
    ...
    <xsl:template name="resourceField">
        ...
        <xsl:param name="cards" select="''"/>
        <xsl:param name="activeCardsNotCredit" select="''"/>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                exclude-result-prefixes="xalan mu mask ph au pu">
    ...
    <xsl:template name="initialData">
        <xsl:variable name="activeAccounts" select="document('active-debit-allowed-external-phiz-accounts.xml')/entity-list/*"/>
    ...
    <xsl:template match="/form-data" mode="view">
        ...
        <document>
            ...
            <autoTransferAllowed><xsl:value-of select="boolean(receiverSubType = 'ourCard' or receiverSubType = 'ourPhone')"/></autoTransferAllowed>
            <RurPaymentDocument>
                <documentNumber>
                    <xsl:call-template name="integerField">
                        <xsl:with-param name="name">documentNumber</xsl:with-param>
                ...
                <receiverName>
                    <xsl:choose>
                        <xsl:when test="receiverSubType = 'masterCardExternalCard' or receiverSubType = 'visaExternalCard'">
                            <xsl:call-template name="stringField">
                        ...
                        <xsl:otherwise>
                            <xsl:variable name="receiverNameEdited" select="ph:getFormattedPersonName(receiverFirstName, receiverSurname, receiverPatrName)"/>
                            <xsl:call-template name="stringField">
                                <xsl:with-param name="name">receiverName</xsl:with-param>
                                <xsl:with-param name="title">ФИО получателя</xsl:with-param>
                                <xsl:with-param name="required" select="true()"/>
                                <xsl:with-param name="editable" select="false()"/>
                                <xsl:with-param name="visible" select="true()"/>
                                <xsl:with-param name="value" select="$receiverNameEdited"/>
                            </xsl:call-template>
                        </xsl:otherwise>
                    </xsl:choose>
                </receiverName>
                ...
                <xsl:if test="pu:impliesService('MessageWithCommentToReceiverService') and (receiverSubType = 'ourCard' or receiverSubType = 'ourPhone') and string-length(messageToReceiver)>0">
                        <messageToReceiver>
                            <xsl:call-template name="stringField">
                                <xsl:with-param name="name">messageToReceiver</xsl:with-param>
                                <xsl:with-param name="title">Сообщение получателю</xsl:with-param>
        ...
        <initialData>
            ...
            <RurPaymentLongOffer>
                ...
                <longOfferDetails>
                    ...
                    <isSumModify>
                        <xsl:call-template name="booleanField">
                            <xsl:with-param name="title">Признак, указывающий изменена ли клиентом сумма платежа</xsl:with-param>
    ...
    <xsl:template name="receiverSubTypeList">
        ...
        <xsl:call-template name="simpleField">
            ...
            <xsl:with-param name="valueTag">
                <listType>
                    <availableValues>
                        <xsl:if test="$value = '' or $value = 'ourCard'">
                            <xsl:call-template name="receiverSubTypeListPrintValueTitle">
                                ...
                                <xsl:with-param name="currentReceiverSubType"><xsl:value-of select="receiverSubType"/></xsl:with-param>
                            </xsl:call-template>
                        </xsl:if>

                        <xsl:if test="$value = '' or $value = 'ourPhone'">
                            <xsl:call-template name="receiverSubTypeListPrintValueTitle">
                        ...
                        <xsl:if test="$value = '' or $value = 'ourAccount'">
                            <xsl:call-template name="receiverSubTypeListPrintValueTitle">
                        ...
                        <xsl:if test="$value = '' or $value = 'externalAccount'">
                            <xsl:call-template name="receiverSubTypeListPrintValueTitle">
                        ...
                        <xsl:if test="$value = '' or $value = 'masterCardExternalCard'">
                            <xsl:if test="pu:impliesService('MastercardMoneySendService')">
                                <xsl:call-template name="receiverSubTypeListPrintValueTitle">
                        ...
                        <xsl:if test="$value = '' or $value = 'visaExternalCard'">
                            <xsl:if test="pu:impliesService('VisaMoneySendService')">
                                <xsl:call-template name="receiverSubTypeListPrintValueTitle">
    ...
    <xsl:template name="receiverSubTypeListPrintValueTitle">
        <xsl:param name="key"/>
        <xsl:param name="title"/>
        <xsl:param name="currentReceiverSubType"/>
        ...
        <valueItem>
            ...
            <selected>
                <xsl:choose>
                    <xsl:when test="$currentReceiverSubType != '' and contains($key, $currentReceiverSubType)">

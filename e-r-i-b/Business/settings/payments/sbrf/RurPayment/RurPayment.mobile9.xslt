...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="initialData">
        ...
        <xsl:variable name="isByFundRequest" select="string-length(fundResponseId) > 0"/>
        <xsl:variable name="templateEditableField" select="not($isByTemplate) and not($isByFundRequest)"/>
        <xsl:variable name="editableField" select="not($isByFundRequest)"/>
        ...
        <receiverSubType>
            <xsl:call-template name="receiverSubTypeList">
                ...
                <xsl:with-param name="required" select="true()"/>
                <xsl:with-param name="editable" select="$templateEditableField"/>
                <xsl:with-param name="visible" select="true()"/>
            </xsl:call-template>
        </receiverSubType>
        <cardFields>
            <fromResource>
                <xsl:call-template name="resourceField">
                    ...
                    <xsl:with-param name="required" select="true()"/>
                    <xsl:with-param name="editable" select="$editableField"/>
                    <xsl:with-param name="visible" select="true()"/>
            ...
            <xsl:if test="isFundPayment='true'">
                <isFundPayment>
                    <xsl:call-template name="booleanField">
                        <xsl:with-param name="name">isFundPayment</xsl:with-param>
                        <xsl:with-param name="title">Является ли перевод оплатой сбора средств</xsl:with-param>
                        <xsl:with-param name="required" select="false()"/>
                        <xsl:with-param name="editable" select="false()"/>
                        <xsl:with-param name="visible" select="false()"/>
                        <xsl:with-param name="value" select="isFundPayment"/>
                    </xsl:call-template>
                </isFundPayment>
            </xsl:if>
            <xsl:if test="$isByFundRequest">
                <fundResponseId>
                    <xsl:call-template name="stringField">
                        <xsl:with-param name="name">fundResponseId</xsl:with-param>
                        <xsl:with-param name="title">Внешний идентификатор ответа сбора средств</xsl:with-param>
                        <xsl:with-param name="required" select="false()"/>
                        <xsl:with-param name="editable" select="false()"/>
                        <xsl:with-param name="visible" select="false()"/>
                        <xsl:with-param name="maxLength" select="100"/>
                        <xsl:with-param name="value" select="fundResponseId"/>
                    </xsl:call-template>
                </fundResponseId>
            </xsl:if>
            <ourCard>
                <xsl:if test="not($isByFundRequest)">
                    <externalCardNumber>
                        <xsl:call-template name="integerField">
            ...
            <social>
               <externalSocialId>
                    <xsl:call-template name="stringField">
                        <xsl:with-param name="name">externalSocialId</xsl:with-param>
                        <xsl:with-param name="title">Идентификатор клиента во внешнем приложении</xsl:with-param>
                        <xsl:with-param name="required" select="true()"/>
                        <xsl:with-param name="editable" select="not($isByTemplate) and not($isMobileLightScheme)"/>
                        <xsl:with-param name="visible" select="true()"/>
                        <xsl:with-param name="value" select="externalSocialId"/>
                        <xsl:with-param name="fieldDictType">
                            <xsl:choose>
                                <xsl:when test="not($isByTemplate)"><xsl:value-of select="'social'"/></xsl:when>
                                <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                            </xsl:choose>
                        </xsl:with-param>
                        <xsl:with-param name="fieldInfoType">
        ...
        <accountFields>
            ...
            <ourAccount>
                <xsl:call-template name="accountFieldsTemplate">
                    <xsl:with-param name="accountType" select="'ourAccount'"/>
                </xsl:call-template>
            </ourAccount>
            <externalAccount>
                <xsl:call-template name="accountFieldsTemplate">
                    <xsl:with-param name="accountType" select="'externalAccount'"/>
                </xsl:call-template>
            </externalAccount>
            <receiverINN>
                <xsl:call-template name="integerField">
        ...
        <dictField>
            <xsl:call-template name="dictField">
                ...
                <xsl:with-param name="value" select="dictFieldId"/>
            </xsl:call-template>
        </dictField>
    </xsl:template>
    ...
    <xsl:template match="/form-data" mode="view">
        ...
        <document>
            ...
            <RurPaymentDocument>
                ...
                <xsl:choose>
                    <xsl:when test="string-length(fundResponseId)>0">
                        <fundResponseId>
                            <xsl:call-template name="stringField">
                                <xsl:with-param name="name">fundResponseId</xsl:with-param>
                                <xsl:with-param name="title">Внешний идентификатор ответа сбора средств</xsl:with-param>
                    ...
                    <xsl:otherwise>
                        <receiverAccount>
                            <xsl:choose>
                                <xsl:when test="receiverSubType = 'ourCard' or receiverSubType = 'ourPhone' or receiverSubType = 'social' or receiverSubType = 'masterCardExternalCard' or receiverSubType = 'visaExternalCard'">
                                    <xsl:call-template name="stringField">
                ...
                <xsl:if test="pu:impliesService('MessageWithCommentToReceiverService') and (receiverSubType = 'ourCard' or receiverSubType = 'ourPhone' or receiverSubType = 'social')">
    ...
    <xsl:template name="receiverSubTypeList">
        ...
        <listType>
            <availableValues>
                ...
                <xsl:call-template name="receiverSubTypeListPrintValueTitle">
                    <xsl:with-param name="key">social</xsl:with-param>
                    <xsl:with-param name="title">На карту Сбербанка по идентификатору клиента во внешнем приложении</xsl:with-param>
                </xsl:call-template>
    ...
    <xsl:template name="accountFieldsTemplate">
        <xsl:param name="accountType"/>

        <xsl:choose>
            <xsl:when test="$accountType = 'ourAccount'">
                <receiverAccountInternal>
                    <xsl:call-template name="integerField">
                        ...
                        <xsl:with-param name="fieldDictType">
                            <xsl:choose>
                                <xsl:when test="not($isByTemplate)"><xsl:value-of select="'ourAccount'"/></xsl:when>
                                <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                            </xsl:choose>
                        </xsl:with-param>
                        <xsl:with-param name="fieldInfoType">
            ...
            <xsl:otherwise>
                <receiverAccountExternal>
                    <xsl:call-template name="integerField">
                        ...
                        <xsl:with-param name="fieldDictType">
                            <xsl:choose>
                                <xsl:when test="not($isByTemplate)"><xsl:value-of select="'externalAccount'"/></xsl:when>
                                <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                            </xsl:choose>
                        </xsl:with-param>
                        <xsl:with-param name="fieldInfoType">
        ...
        <receiverSurname>
            <xsl:call-template name="stringField">
                ...
                <xsl:with-param name="fieldDictType">
                    <xsl:choose>
                        <xsl:when test="not($isByTemplate)"><xsl:value-of select="$accountType"/></xsl:when>
                        <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                    </xsl:choose>
                </xsl:with-param>
                <xsl:with-param name="fieldInfoType">
                    <xsl:choose>
                        <xsl:when test="not($isByTemplate)"><xsl:value-of select="'surName'"/></xsl:when>
                        <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                    </xsl:choose>
                </xsl:with-param>
                <xsl:with-param name="dictTypeFieldName" select="'dictFieldId'"/>
        ...
        <receiverFirstName>
            <xsl:call-template name="stringField">
                ...
                <xsl:with-param name="fieldInfoType">
                    <xsl:choose>
                        <xsl:when test="not($isByTemplate)"><xsl:value-of select="'firstName'"/></xsl:when>
                        <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                    </xsl:choose>
                </xsl:with-param>
                <xsl:with-param name="dictTypeFieldName" select="'dictFieldId'"/>
        ...
        <receiverPatrName>
            <xsl:call-template name="stringField">
                ...
                <xsl:with-param name="fieldInfoType">
                    <xsl:choose>
                        <xsl:when test="not($isByTemplate)"><xsl:value-of select="'patrName'"/></xsl:when>
                        <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                    </xsl:choose>
                </xsl:with-param>
                <xsl:with-param name="dictTypeFieldName" select="'dictFieldId'"/>
        ...
        <bankInfo>
            <bank>
                <xsl:call-template name="stringField">
                    ...
                    <xsl:with-param name="fieldInfoType">
                        <xsl:choose>
                            <xsl:when test="not($isByTemplate)"><xsl:value-of select="'BankName'"/></xsl:when>
                            <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                        </xsl:choose>
                    </xsl:with-param>
                    <xsl:with-param name="dictTypeFieldName" select="'dictFieldId'"/>
            ...
            <receiverBIC>
                <xsl:call-template name="integerField">
                    ...
                    <xsl:with-param name="fieldInfoType">
                        <xsl:choose>
                            <xsl:when test="not($isByTemplate)"><xsl:value-of select="'BIC'"/></xsl:when>
                            <xsl:otherwise><xsl:value-of select="''"/></xsl:otherwise>
                        </xsl:choose>
                    </xsl:with-param>
                    <xsl:with-param name="dictTypeFieldName" select="'dictFieldId'"/>

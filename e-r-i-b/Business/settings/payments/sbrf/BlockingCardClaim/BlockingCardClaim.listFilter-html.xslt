...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<td>
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				<td  class="filter">Причина блокирования</td>
				<td  class="filter" style="font-weight:normal;">
			...
			<tr>
				...
				<td  class="filter" style="font-weight:normal;">
					<select name="state" onkeydown="onTabClick(event,'fromDate')">
						<option value="">Все</option>
						<option value="SAVED">Введена</option>
						<option value="INITIAL">Введена</option>
                        <option value="DELAYED_DISPATCH">Ожидание обработки</option>                                    
						<option value="DISPATCHED">Принята</option>
						<option value="ACCEPTED">Одобрена</option>
						<option value="EXECUTED">Исполнена</option>
						<option value="REFUSED">Отказана</option>
					</select>
				</td>
			</tr>
			<tr>

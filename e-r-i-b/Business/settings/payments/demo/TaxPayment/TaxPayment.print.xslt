	  ...
	  <col  style="width:7mm"/>
		...
		<tr style="height:5mm">
		   ...
		   <td colspan="10" style="border-top:1px solid black;">&nbsp;
			  <xsl:value-of select="phizic:cvtSum(amount)"/>
		   </td>
		</tr>
		...
		<tr style="height:5mm">
		   <td colspan="9" rowspan="2" style="border-right:1px solid black" valign="top">
							  <xsl:value-of select="$currentBankConfig//entity[@key='bankConfig']/field[@name='name']"/>&nbsp;г.&nbsp;Москва
		   </td>
		...
		<tr style="height:5mm">
			<td colspan="2" class="ul" style="border-right:1px solid black"><nobr>Вид оп.</nobr></td>
			<td colspan="3" style="border-top:1px solid black; border-right:1px solid black">&nbsp;01 </td>
			<td colspan="2" class="ul" style="border-right:1px solid black"><nobr>Срок плат.</nobr></td>
			<td colspan="5" style="border-top:1px solid black;">&nbsp;</td>
		</tr>
		<tr style="height:5mm">
			<td colspan="2" class="ul" style="border-right:1px solid black"><nobr>Наз. пл.</nobr></td>
			<td colspan="3" style="border-right:1px solid black">&nbsp;</td>
			<td colspan="2" class="ul" style="border-right:1px solid black"><nobr>Очер.плат.</nobr></td>
			<td colspan="5">&nbsp;4</td>
		</tr>
		<tr style="height:5mm">
			<td colspan="9" style="border-bottom:1px solid black;border-right:1px solid black">Получатель</td>
			<td colspan="2" class="ul" style="border-right:1px solid black">&nbsp;Код</td>
			<td colspan="3" style="border-bottom:1px solid black;border-right:1px solid black">&nbsp;</td>
			<td colspan="2" style="border-bottom:1px solid black;border-right:1px solid black"><nobr>&nbsp;Рез. поле.</nobr></td>
			<td colspan="5" class="ul" style="border-bottom:1px solid black">&nbsp;</td>
		</tr>
		<tr style="height:5mm" >

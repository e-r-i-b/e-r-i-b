...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<td>
		...
		<select name="state" onkeydown="onTabClick(event,'fromDate')">
			...
			<option value="RECEIVED">Получен банком получателем</option>
			<option value="SUCCESSED">Выдан</option>
			<option value="CANCELATION">Аннулирование</option>
			<option value="MODIFICATION">Изменение</option>

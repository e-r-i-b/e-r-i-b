			...
			<tr>
				...
				<td valign="top">                     
					...
					<xsl:if test="not($personAvailable)">
						<select id="accountsSelect" name="accountsSelect" disabled="disabled">
	...
	<xsl:template match="/form-data" mode="view">
		...
		<table cellspacing="o" cellpadding="0" border="0">
			...
			<tr>
				...
				<td valign="top">
					<xsl:value-of select="accountsSelect"/>&nbsp;<xsl:value-of select="payerAccountCurrency"/></td>
				<td valign="top" rowspan="3">
					<table cellspacing="0" cellpadding="2"
					       style="border:1px solid #67747F;border-collapse:collapse;margin-left:10px">
						<tr>
			...
			<tr>
				<td align="right" valign="top" class="fontBold">Статус документа:</td>
				<td colSpan="2">

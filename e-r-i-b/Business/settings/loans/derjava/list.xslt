				   ...
				   <xsl:if test="count($currentProducts) != 0">
					   <xsl:for-each select="set:distinct($currencies)">
							...
							<xsl:variable name="tableTitle">
								<img src="{$resourceRoot}/images/imagesDemo/iconMid_credits.gif" alt="" border="0"/>
						   ...
						   <table cellpadding="0" cellspacing="0" width="100%">
							<tr>
								<td class="tblHeaderLeftCorner"><img src="{$resourceRoot}/imagesDemo/1x1.gif" alt="" width="9" height="1" border="0"/></td>
								<td class="tblHeader"><img src="{$resourceRoot}/images/imagesDemo/iconMid_credits.gif" alt="" border="0"/></td>
								<td class="tblHeader" width="100%">
									<span>«<xsl:value-of select="$tableTitle"/>»</span></td>
								<td class="tblHeaderRightCorner"><img src="{$resourceRoot}/imagesDemo/1x1.gif" alt="" width="9" height="1" border="0"/></td>
							</tr>
							<tr>
								<td colspan="4">
						...
						<tr>
							<td class="tblFooterLeftCorner"><img src="{$resourceRoot}/imagesDemo/1x1.gif" alt="" width="1" height="10" border="0"/></td>
							<td colspan="2" class="tblFooter"><img src="{$resourceRoot}/imagesDemo/1x1.gif" alt="" width="1" height="10" border="0"/></td>
							<td class="tblFooterRightCorner"><img src="{$resourceRoot}/imagesDemo/1x1.gif" alt="" width="1" height="10" border="0"/></td>
						</tr>
					</table>
						   <br/>
					   </xsl:for-each>

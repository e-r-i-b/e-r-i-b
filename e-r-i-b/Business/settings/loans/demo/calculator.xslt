							  ...
							  <tr>
								 ...
								 <td valign="center" align="middle" height="18">
									<table class="btnBase" height="18" cellSpacing="0"
									   ...
									   <tr>
										  <td class="handCursor" onclick="calculate();"><img src="{$resourceRoot}/skins/green/images/iconSm_calculate.gif" alt="" border="0"/></td>
								  ...
								  <td valign="center" align="middle" height="18">
									<table class="btnBase" height="18" cellSpacing="0"
										   ...
										   onmouseout="this.className = 'btnBase';">
									   <tr>
										  <td class="handCursor" onclick="claimEdit();"><img src="{$resourceRoot}/skins/green/images/iconSm_addClaim.gif" alt="" border="0"/></td> 

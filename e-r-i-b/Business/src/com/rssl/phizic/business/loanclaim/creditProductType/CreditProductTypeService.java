...
public class CreditProductTypeService
{
	...
	public void addOrUpdate(CreditProductType creditType) throws BusinessException, CreditTypeCodeNotUnique
	{
		...
		{
			throw new CreditTypeCodeNotUnique(e,creditType.getCode());
		}
	}
	 ...
	 * @throws BusinessException
	 */
	public void remove(final CreditProductType creditType) throws BusinessException
	{
	 ...
	 * @throws BusinessException
	 */
	public CreditProductType findeByCode(final Long code) throws BusinessException
	{

 ...
 * @ $Revision$
 */
public class IMAccountWidgetAccessor extends GenericWidgetAccessor
{
	@Override
	protected boolean impliesMainPermission(WidgetDefinition widgetDefinition)
	{
		return PermissionUtil.impliesServiceRigid("IMAccountInfoService");
	}
	...
	protected boolean checkData(WidgetDefinition widgetDefinition) throws BusinessException, BusinessLogicException
	{
		...
		return CollectionUtils.isNotEmpty(personData.getIMAccountLinks());
	}
}

 ...
 * @ $Author$
 * @ $Revision$
 * экшен для парсинга ОМСа из xml
 */
public class IMAProductsAction extends ProductsAction<IMAProduct>
{
	...
	public void execute(Element element) throws BusinessException, BusinessLogicException
	{
		...
		//Для раздела ключ "IMA", сам раздел завернут в обертку, поэтому получать только так
	    ProductTypeParameters type = (ProductTypeParameters)(productTypes.get("IMA").getRecord());

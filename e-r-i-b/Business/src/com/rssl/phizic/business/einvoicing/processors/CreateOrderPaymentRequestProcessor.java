 ...
 * @ $Revision$
 */
public class CreateOrderPaymentRequestProcessor extends RequestProcessorBase
{
	@Override
	protected String getResponceType()
	{
		return "CreateOrderPaymentResponce";
	}
	...
	protected ResponseInfo processRequest(RequestInfo requestInfo) throws Exception
	{
		...
		GateSingleton.getFactory().service(InvoiceGateBackService.class).createOrderPayment(shopOrder);

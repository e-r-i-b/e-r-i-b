...
/**
 * Заявка на возобновление действия автоплатежа
 *
 * @author khudyakov
 * @ created 24.02.2012
 * @ $Author$
	...
	public void initialize(Document document, MessageCollector messageCollector) throws DocumentException, DocumentLogicException
	{
		...
		try
		{
			...
			if(statusType != AutoPayStatusType.Paused)
				throw new DocumentException("Возобновление автоплатежа разрешено только, если он находится в статусе " +
						"Активный или Приостановлен");

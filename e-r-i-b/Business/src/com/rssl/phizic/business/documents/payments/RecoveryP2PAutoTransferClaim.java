...
import com.rssl.phizic.gate.payments.autosubscriptions.RecoveryCardToCardLongOffer;
...
/**
 * Заявка на возобновление выполнения автоплатежа карта-карта
 * @author lukina
 * @ created 10.09.2014
 * @ $Author$
 * @ $Revision$
 */
public class RecoveryP2PAutoTransferClaim extends P2PAutoTransferClaimBase implements RecoveryCardToCardLongOffer
{
	public Class<? extends GateDocument> getType()
	{
		return RecoveryCardToCardLongOffer.class;
	}

	@Override
	public FormType getFormType()
	{
		return FormType.RECOVERY_P2P_AUTO_TRANSFER_CLAIM;
	}
	...
	public void initialize(Document document, MessageCollector messageCollector) throws DocumentException, DocumentLogicException
	{
		...
		{
			throw new DocumentException("Возобновление автоплатежа разрешено только, если он находится в статусе Приостановлен");
		}
	...
	{
		return subscriptionLink.getAutoPayStatusType() != AutoPayStatusType.Paused;
	}
}

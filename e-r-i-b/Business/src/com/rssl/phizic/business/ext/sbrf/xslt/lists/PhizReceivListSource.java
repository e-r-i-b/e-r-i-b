...
public class PhizReceivListSource implements EntityListSource
{
	public static final String FILTER_CLASS_NAME_PARAMETR = "filter";
	private ReceiverFilter receiverFilter;

	public PhizReceivListSource()
	{
		this (new NullReceiverFilter());
	}

	public PhizReceivListSource(ReceiverFilter receiverFilter)
	{
		this.receiverFilter = receiverFilter;
	}

	public PhizReceivListSource(Map parametrs) throws BusinessException
	{
		try
		{

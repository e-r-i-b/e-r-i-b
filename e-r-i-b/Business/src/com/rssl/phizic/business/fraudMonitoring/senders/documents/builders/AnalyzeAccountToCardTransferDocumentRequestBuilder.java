...
/**
 * Билдер запроса перевода со счета на карту (тип analyze)
 *
 * @author khudyakov
 * @ created 14.06.15
 * @ $Author$
 * @ $Revision$
 */
public class AnalyzeAccountToCardTransferDocumentRequestBuilder extends AnalyzeInternalTransferDocumentRequestBuilderBase
{

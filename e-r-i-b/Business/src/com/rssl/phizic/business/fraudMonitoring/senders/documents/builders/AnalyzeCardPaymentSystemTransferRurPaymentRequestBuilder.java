...
/**
 * Билдер запросов перевода с карты по произвольным реквизитам (тип analyze)
 *
 * @author khudyakov
 * @ created 18.06.15
 * @ $Author$
 * @ $Revision$
 */
public class AnalyzeCardPaymentSystemTransferRurPaymentRequestBuilder extends AnalyzeDocumentRequestBuilderBase<RurPayment>
{

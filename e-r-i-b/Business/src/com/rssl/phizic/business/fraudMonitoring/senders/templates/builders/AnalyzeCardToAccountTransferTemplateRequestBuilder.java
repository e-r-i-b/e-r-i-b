...
/**
 * Билдер запросов для шаблонов перевода с карты на счет (тип analyze)
 *
 * @author khudyakov
 * @ created 19.06.15
 * @ $Author$
 * @ $Revision$
 */
public class AnalyzeCardToAccountTransferTemplateRequestBuilder<TD extends InternalTransferTemplate> extends AnalyzeInternalTransferTemplateRequestBuilderBase<TD>
{
	private TD template;

...
import com.rssl.phizic.rsa.senders.builders.offline.FraudMonitoringDocumentOfflineRequestBuilder;
...
/**
 * Базовый класс сендеров во Фрод-мониторинг по документу
 *
 * @author khudyakov
 * @ created 03.02.15
 * @ $Author$
 * @ $Revision$
 */
public abstract class DocumentFraudMonitoringSenderBase<ID extends InitializationData> extends FraudMonitoringAnalyzeSenderBase<ID>
{
	...
	{
		return new FraudMonitoringDocumentOfflineRequestBuilder();
	}
}

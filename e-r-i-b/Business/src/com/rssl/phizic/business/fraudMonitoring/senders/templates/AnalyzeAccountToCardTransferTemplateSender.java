...
/**
 * Cендер во ФМ для шаблонов перевода со счета на карту (тип analyze)
 *
 * @author khudyakov
 * @ created 16.02.15
 * @ $Author$
 * @ $Revision$
 */
public class AnalyzeAccountToCardTransferTemplateSender extends TemplateFraudMonitoringSenderBase
{
	...
	public AnalyzeAccountToCardTransferTemplateSender(InternalTransferTemplate internalTransferTemplate)
	{
		this.internalTransferTemplate = internalTransferTemplate;
		this.type = Type.InternalTransferTemplate;
	}

	public AnalyzeAccountToCardTransferTemplateSender(ConvertCurrencyTransferTemplate convertCurrencyTransferTemplate)
	{
		this.convertCurrencyTransferTemplate = convertCurrencyTransferTemplate;
		this.type = Type.ConvertCurrencyTransferTemplate;
	}

	public AnalyzeAccountToCardTransferTemplateSender(IMATransferTemplate imaTransferTemplate)
	{

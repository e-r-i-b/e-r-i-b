...
/**
 * Билдер запроса перевода между моими счетами (тип analyze)
 *
 * @author khudyakov
 * @ created 19.06.15
 * @ $Author$
 * @ $Revision$
 */
public class AnalyzeClientAccountsTransferDocumentRequestBuilder extends AnalyzeInternalTransferDocumentRequestBuilderBase
{
	...
	protected AccountData createMyAccountData()
	{
		...
		accountData.setAccountNumber(document.getChargeOffAccount());

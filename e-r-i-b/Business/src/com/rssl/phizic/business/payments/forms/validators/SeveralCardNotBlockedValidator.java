...
/**
 * Проверка своей карты на блокировку
 *
 * @author khudyakov
 * @ created 15.11.14
 * @ $Author$
 * @ $Revision$
 */
public class SeveralCardNotBlockedValidator extends AccountAndCardValidatorBase
{
	...
	public boolean validate(Map values) throws TemporalDocumentException
	{
		...
		try
		{
			...
			return new NotBlockedCardFilter().accept(cardLink.getCard());
		}

 ...
 * @ $Revision$
 *
 * * ’эндлер, провер€ющий возможность подтверждени€ за€вки на закрытие автопоиска
 */
public class CheckCloseInvoiceSubscriptionHandler extends CheckInvoiceSubscriptionOperationHandler
{
	...
	{
		return "«а€вка на закрытие автопоиска счетов доступна только дл€ активной или приостановленной услуги. ѕожалуйста, создайте новую за€вку.";
	}

...
/**
 * Установить дату оформления заявки на предодобренную кредитную карту
 * @author Moshenko
 * @ created 27.02.14
 * @ $Author$
 * @ $Revision$
 */
public class SetReqistrationDateLoanCardOfferHandler extends LoanCardOfferHandlerBase
{
	@Override
	...
	{
		PersonData personData = PersonContext.getPersonDataProvider().getPersonData();
		personData.updateLoanCardOfferRegistrationDate(offer.getOfferId());
	}
}

...
public class PrepareBillingPayment implements MockQHandler
{
	public Document makeRequest(MessageData messageData, MessageInfo messageInfo) throws GateException
	{
		try
		{
			return XmlHelper.loadDocumentFromResource("com/rssl/phizicgate/enisey/messaging/mock/xml/prepareBillingPayment_a.xml");
		}
		catch (Exception e)
		{

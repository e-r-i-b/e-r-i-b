...
public class ExecuteBillingPayment implements MockQHandler
{
	public Document makeRequest(MessageData messageData, MessageInfo messageInfo) throws GateException
	{
		try
		{
			return XmlHelper.loadDocumentFromResource("com/rssl/phizicgate/enisey/messaging/mock/xml/executeBillingPayment_a.xml");
		}
		catch (Exception e)
		{

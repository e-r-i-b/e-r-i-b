...
public class EniseyResponseHandler extends DefaultHandler implements ResponseHandler
{
	...
	public EniseyResponseHandler(MessageInfo messageInfo)
	{
		reset();
		...
		switch (state)
		{
			...
			case messageDateTag:
				if (StringHelper.isEmpty(tagText))
					messageDate = null;
				else messageDate = XMLDatatypeHelper.parseDate(tagText);

package ru.softlab.phizicgate.rsloansV64.hibernate;
...
import ru.softlab.phizicgate.rsloansV64.money.CurrencyHelper;
 ...
 * @ $Revision$
 */
public class RSLoansMoneyType implements CompositeUserType
{
	...
	private static final CurrencyHelper RSLoansCurrencyHelper = new CurrencyHelper();
	...
	private Object newInstance(BigDecimal amount, Long currencyId)
	{
        ...
        try
		{
			Currency currency = RSLoansCurrencyHelper.getCurrencyById(currencyId);
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session) throws HibernateException, SQLException
	{
		...
		else
		{
			...
			currencyId = RSLoansCurrencyHelper.getCurrencyId(money.getCurrency().getCode());
		}
	...
	public Object getPropertyValue(Object component, int propertyIndex)
	{
		...
		switch(propertyIndex)
		{
			...
			case 1:
				return RSLoansCurrencyHelper.getCurrencyId(money.getCurrency().getCode());
			default:

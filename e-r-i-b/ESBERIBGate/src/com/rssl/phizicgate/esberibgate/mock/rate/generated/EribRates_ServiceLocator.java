...
public class EribRates_ServiceLocator extends org.apache.axis.client.Service implements EribRates_Service
{
    ...
    public EribRates_PortType geteribRates() throws javax.xml.rpc.ServiceException {
    ...
    public EribRates_PortType geteribRates(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            EribRatesStub _stub = new EribRatesStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (EribRates_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                EribRatesStub _stub = new EribRatesStub(new java.net.URL(eribRates_address), this);
                _stub.setPortName(geteribRatesWSDDServiceName());
                return _stub;
            }
        }

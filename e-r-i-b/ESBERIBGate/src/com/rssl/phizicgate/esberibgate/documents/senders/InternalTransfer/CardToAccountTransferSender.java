 ...
 * @ $Revision$
 *
 * Сендер платежа "Перевод с карты на счет"
 */
...
public class CardToAccountTransferSender extends AbstractOnlineJMSDocumentSender
{
	...
	{
		throw new UnsupportedOperationException("Повторная отправка платежа \"Перевод с карты на счет\" не поддерживается");
	}
	...
	{
		throw new UnsupportedOperationException("Подготовка платежа \"Перевод с карты на счет\" не поддерживается");
	}

	public void confirm(GateDocument document)
	{
		throw new UnsupportedOperationException("Подтверждение платежа \"Перевод с карты на счет\" не поддерживается");
	}

	public void validate(GateDocument document)
	{
		throw new UnsupportedOperationException("Валидация платежа \"Перевод с карты на счет\" не поддерживается");
	}
}

 ...
 * @ $Revision$
 */
public class CardRUSPaymentImpl extends AbstractPhizTransferImpl implements CardRUSPayment
{
	...
	public CardRUSPaymentImpl()
	{
	}

	public CardRUSPaymentImpl(LongOffer longOffer) throws GateException
	{
		super(longOffer);
	}

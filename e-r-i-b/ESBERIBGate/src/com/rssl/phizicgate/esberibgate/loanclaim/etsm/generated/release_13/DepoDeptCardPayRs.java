...
/**
 * Ответ интерфейса DEPO_DEPTP погашения задолженности по счету депо со счета МБК или со счета вклада
 * 
 * <p>Java class for DepoDeptCardPayRsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DepoDeptCardPayRsType">
 *   &lt;complexContent>
...
@XmlType(name = "DepoDeptCardPayRsType", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "status",
...
@XmlRootElement(name = "DepoDeptCardPayRs")
public class DepoDeptCardPayRs {

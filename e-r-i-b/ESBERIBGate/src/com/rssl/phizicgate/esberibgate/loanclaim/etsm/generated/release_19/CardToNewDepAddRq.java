...
/**
 * Тип запроса для интерфейса TCDO. Открытие вклада с переводом на него денежных средств с МБК
 * 
 * <p>Java class for CardToNewDepAddRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CardToNewDepAddRq_Type">
 *   &lt;complexContent>
...
@XmlType(name = "CardToNewDepAddRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "CardToNewDepAddRq")
public class CardToNewDepAddRq {

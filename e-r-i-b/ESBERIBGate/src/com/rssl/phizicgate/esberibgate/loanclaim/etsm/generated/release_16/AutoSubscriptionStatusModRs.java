...
/**
 * Тип сообщения-ответа для интерфейса ASSM - приостановка/возобновление/закрытие подписки
 * 
 * <p>Java class for AutoSubscriptionStatusModRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AutoSubscriptionStatusModRs_Type">
 *   &lt;complexContent>
...
@XmlType(name = "AutoSubscriptionStatusModRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "status"
})
@XmlRootElement(name = "AutoSubscriptionStatusModRs")
public class AutoSubscriptionStatusModRs {

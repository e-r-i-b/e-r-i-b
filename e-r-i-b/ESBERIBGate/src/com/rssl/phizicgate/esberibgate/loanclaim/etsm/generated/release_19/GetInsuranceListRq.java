...
/**
 * Тип сообщения-запроса для просмотра общего списка страховых/НПФ продуктов клиента
 * 
 * <p>Java class for GetInsuranceListRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetInsuranceListRq_Type">
 *   &lt;complexContent>
...
@XmlType(name = "GetInsuranceListRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "GetInsuranceListRq")
public class GetInsuranceListRq {

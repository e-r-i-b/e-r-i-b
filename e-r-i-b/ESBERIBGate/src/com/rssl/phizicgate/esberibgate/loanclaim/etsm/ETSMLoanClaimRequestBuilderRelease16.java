...
import com.rssl.phizicgate.esberibgate.loanclaim.etsm.generated.release_16.*;
 ...
 * @ $Revision$
 */
class ETSMLoanClaimRequestBuilderRelease16
{
	...
	private ApplicationType makeApplication(ETSMLoanClaim claim)
	{
		...
		// 11. Номер заявки
		application.setClaimNumber(claim.getOperationUID());

...
/**
 * Тип сообщения-запроса для интерфейса GCLCN - получение списка основных карт клиента с информацией о сумме суточного лимита по номеру одной из карт клиента
 * 
 * <p>Java class for GetCardListByCardNumRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetCardListByCardNumRq_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="GetUsageInfo" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GetCardListByCardNumRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "GetCardListByCardNumRq")
public class GetCardListByCardNumRq {
    ...
    @XmlElement(name = "GetUsageInfo")
    protected boolean getUsageInfo;
    ...
    /**
     * Gets the value of the getUsageInfo property.
     * 
     */
    ...
    /**
     * Sets the value of the getUsageInfo property.
     * 
     */
    public void setGetUsageInfo(boolean value) {
        this.getUsageInfo = value;
    }

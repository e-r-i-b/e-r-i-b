...
/**
 * Тип сообщения-ответа для интерфейса OTPR - изменение ограничения на печать и использование одноразовых паролей по карте
 * 
 * <p>Java class for OTPRestrictionModRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OTPRestrictionModRs_Type">
 *   &lt;complexContent>
...
@XmlType(name = "OTPRestrictionModRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "status",
...
@XmlRootElement(name = "OTPRestrictionModRs")
public class OTPRestrictionModRs {

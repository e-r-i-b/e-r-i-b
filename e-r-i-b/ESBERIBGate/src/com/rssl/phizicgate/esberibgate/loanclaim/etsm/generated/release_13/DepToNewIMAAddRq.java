...
/**
 * Тип запроса для интерфейса TDIO. Открытие ОМС с переводом на него денежных средств со вклада
 * 
 * <p>Java class for DepToNewIMAAddRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DepToNewIMAAddRq_Type">
 *   &lt;complexContent>
...
@XmlType(name = "DepToNewIMAAddRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "DepToNewIMAAddRq")
public class DepToNewIMAAddRq {

...
/**
 * Тип сообщения-ответа для интерфейса GCLCN - получение списка основных карт клиента с информацией о сумме суточного лимита по номеру одной из карт клиента
 * 
 * <p>Java class for GetCardListByCardNumRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetCardListByCardNumRs_Type">
 *   &lt;complexContent>
...
@XmlType(name = "GetCardListByCardNumRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "status",
...
@XmlRootElement(name = "GetCardListByCardNumRs")
public class GetCardListByCardNumRs {

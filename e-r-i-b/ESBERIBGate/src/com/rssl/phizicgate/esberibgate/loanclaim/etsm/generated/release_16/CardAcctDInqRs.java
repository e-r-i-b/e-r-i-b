...
/**
 * Тип данных исходящего сообщения интерфейса CRDWI получение детализированной информации о карте
 * 
 * <p>Java class for CardAcctDInqRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CardAcctDInqRs_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="BankAcctRec" type="{}CardAcctRec_Type" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CardAcctDInqRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "status",
...
@XmlRootElement(name = "CardAcctDInqRs")
public class CardAcctDInqRs {
    ...
    protected List<CardAcctRec> bankAcctRecs;
     ...
     * 
     */
    public List<CardAcctRec> getBankAcctRecs() {
        if (bankAcctRecs == null) {
            bankAcctRecs = new ArrayList<CardAcctRec>();
        }

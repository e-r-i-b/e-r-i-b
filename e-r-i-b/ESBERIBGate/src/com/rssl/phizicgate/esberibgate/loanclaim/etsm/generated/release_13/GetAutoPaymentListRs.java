...
/**
 * Тип сообщения-ответа для интерфейса GAPL - получение списка платежей по подписке
 * 
 * <p>Java class for GetAutoPaymentListRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetAutoPaymentListRs_Type">
 *   &lt;complexContent>
...
@XmlType(name = "GetAutoPaymentListRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "status",
...
@XmlRootElement(name = "GetAutoPaymentListRs")
public class GetAutoPaymentListRs {

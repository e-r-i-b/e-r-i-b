...
/**
 * Запрос интерфейса DEPO_DEPTP погашения задолженности по счету депо со счета МБК или со счета вклада
 * 
 * <p>Java class for DepoDeptCardPayRqType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DepoDeptCardPayRqType">
 *   &lt;complexContent>
...
@XmlType(name = "DepoDeptCardPayRqType", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "DepoDeptCardPayRq")
public class DepoDeptCardPayRq {

...
/**
 * Тип сообщения-запроса для интерфейса OTPR - изменение ограничения на печать и использование одноразовых паролей по карте
 * 
 * <p>Java class for OTPRestrictionModRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OTPRestrictionModRq_Type">
 *   &lt;complexContent>
...
@XmlType(name = "OTPRestrictionModRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "OTPRestrictionModRq")
public class OTPRestrictionModRq {

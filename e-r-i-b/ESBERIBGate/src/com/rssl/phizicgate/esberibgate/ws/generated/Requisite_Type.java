...
public class Requisite_Type  implements java.io.Serializable {
    ...
    /* Описание длины поля */
    private com.rssl.phizicgate.esberibgate.ws.generated.AttributeLength_Type attributeLength;

    /* Валидаторы (контроли), используемые для дополнительного атрибута.
     * Неприменимо для типов set и list. */
    private com.rssl.phizicgate.esberibgate.ws.generated.Validator_Type[] validators;
    ...
    public Requisite_Type(
           ...
           com.rssl.phizicgate.esberibgate.ws.generated.AttributeLength_Type attributeLength,
           com.rssl.phizicgate.esberibgate.ws.generated.Validator_Type[] validators,
     ...
     */
    public com.rssl.phizicgate.esberibgate.ws.generated.AttributeLength_Type getAttributeLength() {
     ...
     */
    public void setAttributeLength(com.rssl.phizicgate.esberibgate.ws.generated.AttributeLength_Type attributeLength) {
        this.attributeLength = attributeLength;
    }
     ...
     * Неприменимо для типов set и list.
     */
    public com.rssl.phizicgate.esberibgate.ws.generated.Validator_Type[] getValidators() {
        return validators;
    }
     ...
     * Неприменимо для типов set и list.
     */
    public void setValidators(com.rssl.phizicgate.esberibgate.ws.generated.Validator_Type[] validators) {
        this.validators = validators;
    }

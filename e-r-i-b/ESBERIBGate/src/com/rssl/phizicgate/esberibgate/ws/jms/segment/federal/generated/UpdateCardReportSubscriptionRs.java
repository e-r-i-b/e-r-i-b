...
/**
 * Тип данных результата выполнения запроса на изменение адреса доставки электронных отчетов
 * 
 * <p>Java class for UpdateCardReportSubscriptionRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateCardReportSubscriptionRs_Type">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateCardReportSubscriptionRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "status",
...
@XmlRootElement(name = "UpdateCardReportSubscriptionRs")
public class UpdateCardReportSubscriptionRs {

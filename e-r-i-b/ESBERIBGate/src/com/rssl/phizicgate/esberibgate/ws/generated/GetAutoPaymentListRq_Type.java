...
public class GetAutoPaymentListRq_Type  implements java.io.Serializable {
    ...
    private com.rssl.phizicgate.esberibgate.ws.generated.PaymentStatusASAP_Type[] paymentStatusList;
    ...
    private com.rssl.phizicgate.esberibgate.ws.generated.SelRangeDtTm_Type selRangeDtTm;
    ...
    public GetAutoPaymentListRq_Type(
           ...
           com.rssl.phizicgate.esberibgate.ws.generated.PaymentStatusASAP_Type[] paymentStatusList,
           com.rssl.phizicgate.esberibgate.ws.generated.SelRangeDtTm_Type selRangeDtTm) {
           this.rqUID = rqUID;
           this.rqTm = rqTm;
     ...
     * фильтрация по состояниям  не осуществляется
     */
    public com.rssl.phizicgate.esberibgate.ws.generated.PaymentStatusASAP_Type[] getPaymentStatusList() {
     ...
     * фильтрация по состояниям  не осуществляется
     */
    public void setPaymentStatusList(com.rssl.phizicgate.esberibgate.ws.generated.PaymentStatusASAP_Type[] paymentStatusList) {
        this.paymentStatusList = paymentStatusList;
    }
     ...
     * 10 последних платежей по подписке
     */
    public com.rssl.phizicgate.esberibgate.ws.generated.SelRangeDtTm_Type getSelRangeDtTm() {
        return selRangeDtTm;
    }
     ...
     * 10 последних платежей по подписке
     */
    public void setSelRangeDtTm(com.rssl.phizicgate.esberibgate.ws.generated.SelRangeDtTm_Type selRangeDtTm) {
        this.selRangeDtTm = selRangeDtTm;
    }

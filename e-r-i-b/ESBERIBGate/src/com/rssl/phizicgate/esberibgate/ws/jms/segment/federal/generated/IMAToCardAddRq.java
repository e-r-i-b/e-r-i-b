...
/**
 * Тип запроса для интерфейса SrvIMAToCardAdd (TIС). Продажа обезличенного металла с зачислением денежных средств на МБК того же клиента. Операция ОМС-Карта
 * 
 * <p>Java class for IMAToCardAddRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IMAToCardAddRq_Type">
 *   &lt;complexContent>
...
@XmlType(name = "IMAToCardAddRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "IMAToCardAddRq")
public class IMAToCardAddRq {

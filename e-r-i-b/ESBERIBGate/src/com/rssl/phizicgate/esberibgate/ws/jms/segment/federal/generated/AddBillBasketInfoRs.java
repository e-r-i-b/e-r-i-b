...
/**
 * Тип сообщения-ответа для интерфейса "Передача информации о задолженности клиента"
 * 
 * <p>Java class for AddBillBasketInfoRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AddBillBasketInfoRs_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Payment" type="{}PaymentStatusInfoList_Type" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AddBillBasketInfoRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "AddBillBasketInfoRs")
public class AddBillBasketInfoRs {
    ...
    protected List<PaymentStatusInfoListType> payments;
     ...
     * {@link PaymentStatusInfoListType }
     * 
     * 
     */
    public List<PaymentStatusInfoListType> getPayments() {
        if (payments == null) {
            payments = new ArrayList<PaymentStatusInfoListType>();
        }

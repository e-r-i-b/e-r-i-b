...
/**
 * Тип сообщения-запроса для интерфейса "Передача информации о задолженности клиента"
 * 
 * <p>Java class for AddBillBasketInfoRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AddBillBasketInfoRq_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Payment" type="{}PaymentList_Type" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AddBillBasketInfoRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
public class AddBillBasketInfoRq {
    ...
    protected List<PaymentListType> payments;
     ...
     * 
     */
    public List<PaymentListType> getPayments() {
        if (payments == null) {
            payments = new ArrayList<PaymentListType>();
        }

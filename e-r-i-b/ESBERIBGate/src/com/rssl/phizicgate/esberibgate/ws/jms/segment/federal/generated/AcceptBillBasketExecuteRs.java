...
/**
 * Тип сообщения ответа на запрос на оповещение об изменении статуса подписки
 * 
 * <p>Java class for AcceptBillBasketExecuteRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AcceptBillBasketExecuteRs_Type">
 *   &lt;complexContent>
...
@XmlType(name = "AcceptBillBasketExecuteRs_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "AcceptBillBasketExecuteRs")
public class AcceptBillBasketExecuteRs {

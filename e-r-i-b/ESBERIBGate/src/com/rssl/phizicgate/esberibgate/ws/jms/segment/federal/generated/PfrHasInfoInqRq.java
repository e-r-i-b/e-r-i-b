...
/**
 * Тип для запроса интерфейса ESK_HAS_PFRINFO проверки наличия выписки клиента
 * 
 * <p>Java class for PfrHasInfoInqRq_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PfrHasInfoInqRq_Type">
 *   &lt;complexContent>
...
@XmlType(name = "PfrHasInfoInqRq_Type", propOrder = {
    "rqUID",
    "rqTm",
    "operUID",
    "spName",
...
@XmlRootElement(name = "PfrHasInfoInqRq")
public class PfrHasInfoInqRq {

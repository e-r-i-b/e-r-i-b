...
public class IPASWS_Impl extends com.sun.xml.rpc.client.BasicService implements IPASWS {
    ...
    private static final Class IPASWSSoap_PortClass = com.rssl.auth.csa.back.integration.ipas.generated.IPASWSSoap.class;
    
    public IPASWS_Impl() {
        super(serviceName, new QName[] {
                        ns1_iPASWSSoap_QNAME
                    },
            new com.rssl.auth.csa.back.integration.ipas.generated.IPASWS_SerializerRegistry().getRegistry());
    ...
    public com.rssl.auth.csa.back.integration.ipas.generated.IPASWSSoap getIPASWSSoap() {
        ...
        com.rssl.auth.csa.back.integration.ipas.generated.IPASWSSoap_Stub stub = new com.rssl.auth.csa.back.integration.ipas.generated.IPASWSSoap_Stub(handlerChain);
        try {

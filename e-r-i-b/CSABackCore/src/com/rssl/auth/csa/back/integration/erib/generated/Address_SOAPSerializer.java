...
public class Address_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns1_unparseableAddress_QNAME = new QName("", "unparseableAddress");
    ...
    private static final int myPOSTALCODE_INDEX = 7;
    private static final int myPROVINCE_INDEX = 8;
    private static final int mySTREET_INDEX = 9;
    private static final int myTYPE_INDEX = 10;
    private static final int myUNPARSEABLEADDRESS_INDEX = 11;
    private static final int myWORKPHONE_INDEX = 12;
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.auth.csa.back.integration.erib.generated.Address instance = new com.rssl.auth.csa.back.integration.erib.generated.Address();
        com.rssl.auth.csa.back.integration.erib.generated.Address_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_building_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.auth.csa.back.integration.erib.generated.Address_SOAPBuilder();
                    }
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_unparseableAddress_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_unparseableAddress_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.auth.csa.back.integration.erib.generated.Address_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myUNPARSEABLEADDRESS_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setUnparseableAddress((java.lang.String)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.auth.csa.back.integration.erib.generated.Address instance = (com.rssl.auth.csa.back.integration.erib.generated.Address)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getUnparseableAddress(), ns1_unparseableAddress_QNAME, null, writer, context);

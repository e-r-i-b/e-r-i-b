 ...
 * @ $Revision$
 *
 * Обработчик запроса на снятие лока с профиля после исполнения документа сотрудником
 */

public class UnlockProfileForExecuteDocumentRequestProcessor extends RequestProcessorBase
{
	private static final String REQUEST_TYPE  = "unlockProfileForExecuteDocumentRq";
	private static final String RESPONSE_TYPE = "unlockProfileForExecuteDocumentRs";
	...
	protected ResponseInfo processRequest(RequestInfo requestInfo) throws Exception
	{
		...
		responseBuilder.addParameter("unlock", profile.unlockForExecuteDocument());

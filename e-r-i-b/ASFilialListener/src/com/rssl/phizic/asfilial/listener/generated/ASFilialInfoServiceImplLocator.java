...
public class ASFilialInfoServiceImplLocator extends org.apache.axis.client.Service implements com.rssl.phizic.asfilial.listener.generated.ASFilialInfoServiceImpl {
    ...
    public com.rssl.phizic.asfilial.listener.generated.ASFilialInfoService getASFilialInfoServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.phizic.asfilial.listener.generated.ASFilialInfoService getASFilialInfoServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.asfilial.listener.generated.ASFilialInfoServiceSoapBindingStub _stub = new com.rssl.phizic.asfilial.listener.generated.ASFilialInfoServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.phizic.asfilial.listener.generated.ASFilialInfoService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.asfilial.listener.generated.ASFilialInfoServiceSoapBindingStub _stub = new com.rssl.phizic.asfilial.listener.generated.ASFilialInfoServiceSoapBindingStub(new java.net.URL(ASFilialInfoServicePort_address), this);
                _stub.setPortName(getASFilialInfoServicePortWSDDServiceName());
                return _stub;
            }
        }

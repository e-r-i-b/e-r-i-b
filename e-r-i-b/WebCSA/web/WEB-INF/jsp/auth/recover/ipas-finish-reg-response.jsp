...
<%@ taglib uri="http://rssl.com/tags/csa" prefix="csa" %>
    <c:set var="form" value="${RecoverPasswordForm}"/>
        <tiles:insert definition="jSonResponseFail">
            ...
            <tiles:put name="popupId" value="CustomMessage"/>
            <tiles:put name="messageText" value="Вам было отправлено смс-сообщение с новым паролем"/>
            <tiles:put name="onCloseRedirect" value="${csa:calculateActionURL(pageContext, '/index')}"/>

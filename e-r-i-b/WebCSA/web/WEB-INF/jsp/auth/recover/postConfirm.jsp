        ...
        <html:form action="/recover-password" styleClass="safetyRegulations" onsubmit="return false;">
            ...
            <c:set var="operationInfo" value="${form.operationInfo}"/>
                <tiles:insert definition="formRow" flush="false">
                    <tiles:put name="title" value="Введите новый пароль:"/>
                    <tiles:put name="data">
                        <input id="password" type="password" size="30" name="field(password)" maxlength="30" tabindex="1"/>
                        <a href="#" onclick="win.open('passwordHelp'); return false;" tabindex="4">Как правильно составить безопасный пароль?</a>
                ...
                <tiles:insert definition="formRow" flush="false">
                    <tiles:put name="title" value="Повторите новый пароль:"/>
                    <tiles:put name="data">

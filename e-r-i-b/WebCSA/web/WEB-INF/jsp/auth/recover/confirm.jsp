...
<tiles:insert definition="stage" flush="false">
    <tiles:put name="title" value="Подтверждение восстановления пароля" type="string"/>
    <tiles:put name="description" type="string">
        Пожалуйста, для восстановления пароля введите SMS-пароль, полученный в сообщении.
        Убедитесь, что пароль введен верно, и нажмите на кнопку «Подтвердить».
    </tiles:put>
    <tiles:put name="data" type="string">
        <html:form action="/recover-password" onsubmit="stageForm.send('button.next'); return false">
            ...
            <tiles:insert definition="formRow" flush="false">
                ...
                <tiles:put name="data">
                    <span class="bold"><c:out value="${operationInfo.login}"/></span>
                </tiles:put>
            </tiles:insert>
            <hr/>
            <tiles:insert definition="formRow" flush="false">

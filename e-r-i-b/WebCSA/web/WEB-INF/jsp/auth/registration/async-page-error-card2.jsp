    ...
    <div class="g-main">
        <div class="g-main_inner">
            ...
            <div class="g-content">
                ...
                <div class="b-message">
                    <h1>По&nbsp;введенному номеру карты регистрация невозможна</h1>
                    <div class="moved">
                        <p><a href="${csa:calculateActionURL(pageContext,'async/page/registration')}">Попробуйте пройти процесс регистрации заново</a> с&nbsp;номером основной действующей карты. Если решить проблему не&nbsp;удалось, обратитесь в&nbsp;Контактный центр Сбербанка по&nbsp;телефонам:</p>

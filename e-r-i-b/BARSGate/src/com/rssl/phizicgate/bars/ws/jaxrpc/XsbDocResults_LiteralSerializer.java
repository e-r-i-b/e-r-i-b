...
public class XsbDocResults_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public XsbDocResults_LiteralSerializer(javax.xml.namespace.QName type, java.lang.String encodingStyle) {
        this(type, encodingStyle, false);
    }
    
    public XsbDocResults_LiteralSerializer(javax.xml.namespace.QName type, java.lang.String encodingStyle, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        com.rssl.phizicgate.bars.ws.jaxrpc.XsbDocResults instance = new com.rssl.phizicgate.bars.ws.jaxrpc.XsbDocResults();
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_docID_QNAME)) {
                ...
                throw new DeserializationException("literal.unexpectedElementName", new Object[] { ns1_docID_QNAME, reader.getName() });
            }
        }
        else {

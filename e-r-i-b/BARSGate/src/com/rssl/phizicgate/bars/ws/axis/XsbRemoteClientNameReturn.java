...
public class XsbRemoteClientNameReturn  extends com.rssl.phizicgate.bars.ws.axis.XsbReturn  implements java.io.Serializable {
    private com.rssl.phizicgate.bars.ws.axis.XsbRemoteClientNameResult[] documents;
    ...
    public XsbRemoteClientNameReturn(
           ...
           com.rssl.phizicgate.bars.ws.axis.XsbRemoteClientNameResult[] documents) {
        super(
            exceptionItems);
     ...
     * @return documents
     */
    public com.rssl.phizicgate.bars.ws.axis.XsbRemoteClientNameResult[] getDocuments() {
        return documents;
    }
     ...
     * @param documents
     */
    public void setDocuments(com.rssl.phizicgate.bars.ws.axis.XsbRemoteClientNameResult[] documents) {
        this.documents = documents;
    }

 ...
 * @ $Revision$
 */
public class ChooseDepartmentATMAction extends ChooseDepartmentAction
{
	...
	@Override public ActionForward choose(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		ChooseDepartmentATMForm frm = (ChooseDepartmentATMForm) form;

...
public abstract class FinanceFilterATMActionBase extends FinanceFilterActionBase
{
	...
	{
		return ShowFinanceStructureForm.ATM_FILTER_FORM;
	}

	protected MapValuesSource getMapValueSource(FinanceFormBase frm)
	{
		FinanceATMFormBase form = (FinanceATMFormBase) frm;

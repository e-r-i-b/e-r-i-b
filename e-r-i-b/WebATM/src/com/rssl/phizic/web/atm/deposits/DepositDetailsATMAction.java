...
public class DepositDetailsATMAction extends DepositDetailsExtendedAction
{
	...
	{
		DepositDetailsATMForm form =  (DepositDetailsATMForm)frm;
	...
	{
		DepositDetailsATMForm frm = (DepositDetailsATMForm)form;
		...
		if (ConfigFactory.getConfig(DepositConfig.class).isUseCasNsiDictionaries())
		{
			...
			{
				Map<String, String> oldCodes = ConfigFactory.getConfig(AtmApiConfig.class).getOldDepositCodesList();
		...
		if (depositProduct != null)
		{
			...
			try
			{
				...
				converter.setParameter("showNewDeposits", ConfigFactory.getConfig(AtmApiConfig.class).isShowDepositCodes());
				converter.setParameter("group", StringHelper.getEmptyIfNull(frm.getDepositGroup()));
				converter.setParameter("isATM", true);

...
<%--
    ...
    STATUS_OK и STATUS_LOGIC_ERROR используютс€ в login.jsp и atm.jsp
...
<c:set var="STATUS_LOGIC_ERROR" value="1"/><%-- логическа€ ошибка --%>
<c:set var="STATUS_CRITICAL_ERROR" value="2"/><%-- критическа€ ошибка --%>
<c:set var="STATUS_END_SESSION" value="3"/><%-- сесси€ более недоступна --%>
<c:set var="STATUS_PRODUCT_ERROR" value="4"/><%-- ошибка пролучени€ продукта --%>

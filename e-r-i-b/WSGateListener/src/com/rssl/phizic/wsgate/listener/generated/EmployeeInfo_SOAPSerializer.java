...
public class EmployeeInfo_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ...
        ns2_myPersonName_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.wsgate.listener.generated.PersonName.class, ns2_PersonName_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        com.rssl.phizic.wsgate.listener.generated.EmployeeInfo instance = new com.rssl.phizic.wsgate.listener.generated.EmployeeInfo();
        com.rssl.phizic.wsgate.listener.generated.EmployeeInfo_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_employeeOffice_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.wsgate.listener.generated.EmployeeInfo_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myEMPLOYEEOFFICE_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setEmployeeOffice((com.rssl.phizic.wsgate.listener.generated.Office)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_personName_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setPersonName((com.rssl.phizic.wsgate.listener.generated.PersonName)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.wsgate.listener.generated.EmployeeInfo instance = (com.rssl.phizic.wsgate.listener.generated.EmployeeInfo)obj;

...
public class BusinessRecipientInfo_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ...
        ns3_myResidentBank_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.wsgate.recipients.generated.ResidentBank.class, ns3_ResidentBank_TYPE_QNAME);
        ...
        ns3_myOffice_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.wsgate.recipients.generated.Office.class, ns3_Office_TYPE_QNAME);
        ns3_myService_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.wsgate.recipients.generated.Service.class, ns3_Service_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        com.rssl.phizic.wsgate.recipients.generated.BusinessRecipientInfo instance = new com.rssl.phizic.wsgate.recipients.generated.BusinessRecipientInfo();
        com.rssl.phizic.wsgate.recipients.generated.BusinessRecipientInfo_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_INN_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.wsgate.recipients.generated.BusinessRecipientInfo_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_bank_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setBank((com.rssl.phizic.wsgate.recipients.generated.ResidentBank)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_office_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setOffice((com.rssl.phizic.wsgate.recipients.generated.Office)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_service_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setService((com.rssl.phizic.wsgate.recipients.generated.Service)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.wsgate.recipients.generated.BusinessRecipientInfo instance = (com.rssl.phizic.wsgate.recipients.generated.BusinessRecipientInfo)obj;

...
package com.rssl.phizic.business.ermb.newclient.generated;

public class Sberbank_SetNewClientsLocator extends org.apache.axis.client.Service implements com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClients {
    ...
    public com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap getSberbank_SetNewClientsSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap getSberbank_SetNewClientsSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap12Stub _stub = new com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap12Stub(portAddress, this);
    ...
    public com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap getSberbank_SetNewClientsSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap getSberbank_SetNewClientsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoapStub _stub = new com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap12Stub _stub = new com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap12Stub(new java.net.URL(Sberbank_SetNewClientsSoap12_address), this);
                _stub.setPortName(getSberbank_SetNewClientsSoap12WSDDServiceName());
                return _stub;
            }
            if (com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoapStub _stub = new com.rssl.phizic.business.ermb.newclient.generated.Sberbank_SetNewClientsSoapStub(new java.net.URL(Sberbank_SetNewClientsSoap_address), this);
                _stub.setPortName(getSberbank_SetNewClientsSoapWSDDServiceName());
                return _stub;
            }
        }

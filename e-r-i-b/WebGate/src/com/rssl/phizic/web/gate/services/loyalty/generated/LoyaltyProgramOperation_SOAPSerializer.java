...
public class LoyaltyProgramOperation_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ns2_myMoney_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.services.loyalty.generated.Money.class, ns2_Money_TYPE_QNAME);
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.services.loyalty.generated.LoyaltyProgramOperation instance = new com.rssl.phizic.web.gate.services.loyalty.generated.LoyaltyProgramOperation();
        com.rssl.phizic.web.gate.services.loyalty.generated.LoyaltyProgramOperation_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_moneyOperationalBalance_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.loyalty.generated.LoyaltyProgramOperation_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myMONEYOPERATIONALBALANCE_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setMoneyOperationalBalance((com.rssl.phizic.web.gate.services.loyalty.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.loyalty.generated.LoyaltyProgramOperation instance = (com.rssl.phizic.web.gate.services.loyalty.generated.LoyaltyProgramOperation)obj;

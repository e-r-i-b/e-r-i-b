 ...
 * @ $Revision$
 */
public class CurrenciesGateService_Server_Impl implements GateService
{
	public List getAll(int int_1, int int_2) throws RemoteException
	{
		try
		{
			com.rssl.phizic.gate.dictionaries.CurrenciesGateService service = GateSingleton.getFactory().service(com.rssl.phizic.gate.dictionaries.CurrenciesGateService.class);

			List<com.rssl.phizic.common.types.Currency> currencies = service.getAll(int_1, int_2);

			List<com.rssl.phizic.web.gate.dictionaries.generated.Currency> generatedCurrencies = new ArrayList<com.rssl.phizic.web.gate.dictionaries.generated.Currency>();
			BeanHelper.copyPropertiesWithDifferentTypes(generatedCurrencies, currencies, TypesCorrelation.types);

			return generatedCurrencies;

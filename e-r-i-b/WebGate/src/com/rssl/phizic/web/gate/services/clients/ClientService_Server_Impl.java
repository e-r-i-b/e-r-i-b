...
import com.rssl.phizic.web.gate.services.clients.generated.ClientService;
 ...
 * @ $Revision$
 */
public class ClientService_Server_Impl implements ClientService
{
	public Client getClientById(String string_1) throws RemoteException
	{
		try
		{
			String decoded = decodeData(string_1);
			com.rssl.phizic.gate.clients.ClientService service = GateSingleton.getFactory().service(com.rssl.phizic.gate.clients.ClientService.class);

			com.rssl.phizic.gate.clients.Client client = service.getClientById(decoded);
			if (client == null) return null;

            com.rssl.phizic.web.gate.services.clients.generated.Client generatedClient = new com.rssl.phizic.web.gate.services.clients.generated.Client();
	...
	public List getClientsByTemplate(Client client_1, Office office_2, int int_3, int int_4) throws RemoteException
	{
		try
		{
			String decoded = decodeData(office_2.getSynchKey());
			office_2.setSynchKey(decoded);
			...
			BeanHelper.copyPropertiesWithDifferentTypes(client, client_1, ClientServiceTypesCorrelation.toGateTypes);
			BeanHelper.copyPropertiesWithDifferentTypes(office, office_2, ClientServiceTypesCorrelation.toGateTypes);

			List<com.rssl.phizic.gate.clients.Client>  clients = service.getClientsByTemplate(client, office, int_3, int_4);
			List<Client> generatedClients = new ArrayList<Client>();

			BeanHelper.copyPropertiesWithDifferentTypes(generatedClients, clients, ClientServiceTypesCorrelation.toGeneratedTypes);
	...
	public com.rssl.phizic.web.gate.services.clients.generated.Client getClientByCardNumber(java.lang.String rbTbBranchId, java.lang.String cardNumber) throws java.rmi.RemoteException
	{
		try
		{
			com.rssl.phizic.gate.clients.ClientService service = GateSingleton.getFactory().service(com.rssl.phizic.gate.clients.ClientService.class);

			com.rssl.phizic.gate.clients.Client client = service.getClientByCardNumber(rbTbBranchId, cardNumber);
			if (client == null) return null;

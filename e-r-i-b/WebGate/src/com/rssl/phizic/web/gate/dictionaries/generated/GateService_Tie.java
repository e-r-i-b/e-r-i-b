...
public class GateService_Tie
    extends com.sun.xml.rpc.server.TieBase implements SerializerConstants {
    
    
    
    public GateService_Tie() throws Exception {
        super(new com.rssl.phizic.web.gate.dictionaries.generated.GateServiceImpl_SerializerRegistry().getRegistry());
    ...
    private void invoke_getAll(StreamingHandlerState state) throws Exception {
        ...
        com.rssl.phizic.web.gate.dictionaries.generated.GateService_getAll_RequestStruct myGateService_getAll_RequestStruct = null;
        Object myGateService_getAll_RequestStructObj =
            state.getRequest().getBody().getValue();
        
        if (myGateService_getAll_RequestStructObj instanceof SOAPDeserializationState) {
            myGateService_getAll_RequestStruct = (com.rssl.phizic.web.gate.dictionaries.generated.GateService_getAll_RequestStruct)((SOAPDeserializationState)myGateService_getAll_RequestStructObj).getInstance();
        } else {
            myGateService_getAll_RequestStruct = (com.rssl.phizic.web.gate.dictionaries.generated.GateService_getAll_RequestStruct)myGateService_getAll_RequestStructObj;
        }
        
        try {
            java.util.List result = 
                ((com.rssl.phizic.web.gate.dictionaries.generated.GateService) getTarget()).getAll(myGateService_getAll_RequestStruct.getInt_1(), myGateService_getAll_RequestStruct.getInt_2());
            com.rssl.phizic.web.gate.dictionaries.generated.GateService_getAll_ResponseStruct myGateService_getAll_ResponseStruct =
                new com.rssl.phizic.web.gate.dictionaries.generated.GateService_getAll_ResponseStruct();
            SOAPHeaderBlockInfo headerInfo;
            myGateService_getAll_ResponseStruct.setResult(result);
            
            SOAPBlockInfo bodyBlock = new SOAPBlockInfo(ns1_getAll_getAllResponse_QNAME);
            bodyBlock.setValue(myGateService_getAll_ResponseStruct);
            bodyBlock.setSerializer(ns1_myGateService_getAll_ResponseStruct_SOAPSerializer);
    ...
    protected void peekFirstBodyElement(XMLReader bodyReader, SOAPDeserializationContext deserializationContext, StreamingHandlerState state) throws Exception {
        if (bodyReader.getName().equals(ns1_getAll_getAll_QNAME)) {
    ...
    private void deserialize_getAll(XMLReader bodyReader, SOAPDeserializationContext deserializationContext, StreamingHandlerState state) throws Exception {
        java.lang.Object myGateService_getAll_RequestStructObj =
            ns1_myGateService_getAll_RequestStruct_SOAPSerializer.deserialize(ns1_getAll_getAll_QNAME,
                bodyReader, deserializationContext);
        
        SOAPBlockInfo bodyBlock = new SOAPBlockInfo(ns1_getAll_getAll_QNAME);
        bodyBlock.setValue(myGateService_getAll_RequestStructObj);
            ...
            case getAll_OPCODE:
                {
                    ...
                    theMethod = (com.rssl.phizic.web.gate.dictionaries.generated.GateService.class).getMethod("getAll", carray);
                }
                break;
    ...
    private void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns1_myGateService_getAll_ResponseStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.dictionaries.generated.GateService_getAll_ResponseStruct.class, ns1_getAllResponse_TYPE_QNAME);
        ns1_myGateService_getAll_RequestStruct_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.dictionaries.generated.GateService_getAll_RequestStruct.class, ns1_getAll_TYPE_QNAME);
    }
    
    private static final javax.xml.namespace.QName portName = new QName("http://generated.dictionaries.gate.web.phizic.rssl.com", "GateServicePort");

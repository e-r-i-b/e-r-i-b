...
public class Account_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns2_Money_TYPE_QNAME = new QName("http://generated.notification.services.gate.web.phizic.rssl.com", "Money");
    ...
    private static final javax.xml.namespace.QName ns2_Currency_TYPE_QNAME = new QName("http://generated.notification.services.gate.web.phizic.rssl.com", "Currency");
    ...
    private static final javax.xml.namespace.QName ns2_Office_TYPE_QNAME = new QName("http://generated.notification.services.gate.web.phizic.rssl.com", "Office");
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ...
        ns2_myMoney_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.services.notification.generated.Money.class, ns2_Money_TYPE_QNAME);
        ...
        ns2_myCurrency_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.services.notification.generated.Currency.class, ns2_Currency_TYPE_QNAME);
        ...
        ns2_myOffice_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.services.notification.generated.Office.class, ns2_Office_TYPE_QNAME);
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.services.notification.generated.Account instance = new com.rssl.phizic.web.gate.services.notification.generated.Account();
        com.rssl.phizic.web.gate.services.notification.generated.Account_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_accountState_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.notification.generated.Account_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_balance_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setBalance((com.rssl.phizic.web.gate.services.notification.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_currency_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setCurrency((com.rssl.phizic.web.gate.services.notification.generated.Currency)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_maxSumWrite_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setMaxSumWrite((com.rssl.phizic.web.gate.services.notification.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_minimumBalance_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setMinimumBalance((com.rssl.phizic.web.gate.services.notification.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_office_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setOffice((com.rssl.phizic.web.gate.services.notification.generated.Office)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.notification.generated.Account instance = (com.rssl.phizic.web.gate.services.notification.generated.Account)obj;

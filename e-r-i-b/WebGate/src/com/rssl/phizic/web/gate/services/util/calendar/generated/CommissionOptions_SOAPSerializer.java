...
public class CommissionOptions_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.services.util.calendar.generated.CommissionOptions instance = new com.rssl.phizic.web.gate.services.util.calendar.generated.CommissionOptions();
        com.rssl.phizic.web.gate.services.util.calendar.generated.CommissionOptions_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_account_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.util.calendar.generated.CommissionOptions_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_target_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setTarget((com.rssl.phizic.web.gate.services.util.calendar.generated.CommissionOptions)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.util.calendar.generated.CommissionOptions instance = (com.rssl.phizic.web.gate.services.util.calendar.generated.CommissionOptions)obj;

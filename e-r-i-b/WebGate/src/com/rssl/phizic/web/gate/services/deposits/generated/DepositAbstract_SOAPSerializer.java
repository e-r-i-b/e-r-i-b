...
public class DepositAbstract_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.services.deposits.generated.DepositAbstract instance = new com.rssl.phizic.web.gate.services.deposits.generated.DepositAbstract();
        com.rssl.phizic.web.gate.services.deposits.generated.DepositAbstract_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_closingBalance_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.deposits.generated.DepositAbstract_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myCLOSINGBALANCE_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setClosingBalance((com.rssl.phizic.web.gate.services.deposits.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_openingBalance_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setOpeningBalance((com.rssl.phizic.web.gate.services.deposits.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.deposits.generated.DepositAbstract instance = (com.rssl.phizic.web.gate.services.deposits.generated.DepositAbstract)obj;

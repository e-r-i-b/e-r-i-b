...
import com.rssl.phizic.web.gate.dictionaries.generated.Country;
 ...
 * @ $Revision$
 */
public class CountriesGateService_Server_Impl implements GateService
{
	public List getAll(int int_1, int int_2) throws RemoteException
	{
		try
		{
			com.rssl.phizic.gate.dictionaries.CountriesGateService service = GateSingleton.getFactory().service(com.rssl.phizic.gate.dictionaries.CountriesGateService.class);

			List<com.rssl.phizic.gate.dictionaries.Country> countries = service.getAll(int_1, int_2);

			List<com.rssl.phizic.web.gate.dictionaries.generated.Country> generatedCountries = new ArrayList<Country>();
			BeanHelper.copyPropertiesWithDifferentTypes(generatedCountries, countries, TypesCorrelation.types);

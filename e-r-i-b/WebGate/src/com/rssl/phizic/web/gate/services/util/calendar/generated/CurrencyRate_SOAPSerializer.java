...
public class CurrencyRate_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.services.util.calendar.generated.CurrencyRate instance = new com.rssl.phizic.web.gate.services.util.calendar.generated.CurrencyRate();
        com.rssl.phizic.web.gate.services.util.calendar.generated.CurrencyRate_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_dynamicExchangeRate_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.util.calendar.generated.CurrencyRate_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_fromCurrency_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setFromCurrency((com.rssl.phizic.web.gate.services.util.calendar.generated.Currency)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_toCurrency_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setToCurrency((com.rssl.phizic.web.gate.services.util.calendar.generated.Currency)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.util.calendar.generated.CurrencyRate instance = (com.rssl.phizic.web.gate.services.util.calendar.generated.CurrencyRate)obj;

...
import com.rssl.phizic.web.gate.services.deposits.generated.DepositProductService_PortType;
import com.rssl.phizic.web.gate.services.deposits.generated.Office;
 ...
 * @ $Revision$
 */
public class DepositProductService_Server_Impl implements DepositProductService_PortType
{
	public String getDepositProduct(String string_1, Office office_2) throws RemoteException
	{
		String decoded = decodeData(office_2.getSynchKey());
		office_2.setSynchKey(decoded);
		DepositProductService service = GateSingleton.getFactory().service(DepositProductService.class);
		OfficeImpl office = new OfficeImpl();
		try
		{
			BeanHelper.copyPropertiesWithDifferentTypes(office, office_2, TypesCorrelation.types);
			Document product = service.getDepositProduct(convert2DOM(string_1), office);
			return convert2String(product);
		}
	...
	public String getDepositsInfo(Office office_1) throws RemoteException
	{
		...
		try
		{
			...
			Document info = service.getDepositsInfo(office);
			return convert2String(info);
		}
		catch(GateLogicException e)
		{
			PhizICLogFactory.getLog(com.rssl.phizic.logging.Constants.LOG_MODULE_GATE).error(e);

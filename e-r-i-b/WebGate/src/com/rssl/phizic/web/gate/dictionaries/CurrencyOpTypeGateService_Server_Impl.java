 ...
 * @ $Revision$
 */
public class CurrencyOpTypeGateService_Server_Impl implements GateService
{
	public List getAll(int int_1, int int_2) throws RemoteException
	{
		try
		{
			com.rssl.phizic.gate.dictionaries.CurrencyOpTypeGateService service = GateSingleton.getFactory().service(com.rssl.phizic.gate.dictionaries.CurrencyOpTypeGateService.class);

			List<CurrencyOperationType> types = service.getAll(int_1, int_2);

			List<com.rssl.phizic.web.gate.dictionaries.generated.CurrencyOperationType> generatedTypes = new ArrayList<com.rssl.phizic.web.gate.dictionaries.generated.CurrencyOperationType>();
			BeanHelper.copyPropertiesWithDifferentTypes(generatedTypes, types, TypesCorrelation.types);

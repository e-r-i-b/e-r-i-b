...
public class Currency_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.dictionaries.generated.Currency instance = new com.rssl.phizic.web.gate.dictionaries.generated.Currency();
        com.rssl.phizic.web.gate.dictionaries.generated.Currency_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_code_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.dictionaries.generated.Currency_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.rssl.phizic.web.gate.dictionaries.generated.Currency instance = (com.rssl.phizic.web.gate.dictionaries.generated.Currency)obj;

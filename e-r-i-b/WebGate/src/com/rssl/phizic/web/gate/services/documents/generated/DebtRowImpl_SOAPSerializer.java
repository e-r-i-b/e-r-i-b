...
public class DebtRowImpl_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.services.documents.generated.DebtRowImpl instance = new com.rssl.phizic.web.gate.services.documents.generated.DebtRowImpl();
        com.rssl.phizic.web.gate.services.documents.generated.DebtRowImpl_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_code_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.documents.generated.DebtRowImpl_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_debt_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setDebt((com.rssl.phizic.web.gate.services.documents.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_fine_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setFine((com.rssl.phizic.web.gate.services.documents.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.documents.generated.DebtRowImpl instance = (com.rssl.phizic.web.gate.services.documents.generated.DebtRowImpl)obj;

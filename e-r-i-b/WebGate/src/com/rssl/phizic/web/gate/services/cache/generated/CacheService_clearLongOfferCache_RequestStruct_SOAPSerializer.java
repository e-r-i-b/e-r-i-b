...
public class CacheService_clearLongOfferCache_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ns2_myLongOffer_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.services.cache.generated.LongOffer.class, ns2_LongOffer_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.cache.generated.CacheService_clearLongOfferCache_RequestStruct instance = new com.rssl.phizic.web.gate.services.cache.generated.CacheService_clearLongOfferCache_RequestStruct();
        com.rssl.phizic.web.gate.services.cache.generated.CacheService_clearLongOfferCache_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_LongOffer_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.cache.generated.CacheService_clearLongOfferCache_RequestStruct_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myLONGOFFER_1_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setLongOffer_1((com.rssl.phizic.web.gate.services.cache.generated.LongOffer)member);
                }
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.cache.generated.CacheService_clearLongOfferCache_RequestStruct instance = (com.rssl.phizic.web.gate.services.cache.generated.CacheService_clearLongOfferCache_RequestStruct)obj;

...
public class Throwable_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ...
        ns2_myns2_ArrayOfStackTraceElement__StackTraceElementArray_SOAPSerializer1 = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.services.bankroll.generated.StackTraceElement[].class, ns2_ArrayOfStackTraceElement_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.bankroll.generated.Throwable instance = new com.rssl.phizic.web.gate.services.bankroll.generated.Throwable();
        com.rssl.phizic.web.gate.services.bankroll.generated.Throwable_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_backtrace_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.bankroll.generated.Throwable_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_stackTrace_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setStackTrace((com.rssl.phizic.web.gate.services.bankroll.generated.StackTraceElement[])member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.bankroll.generated.Throwable instance = (com.rssl.phizic.web.gate.services.bankroll.generated.Throwable)obj;

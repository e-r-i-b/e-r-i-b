...
public class Money_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ns2_myCurrency_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Currency.class, ns2_Currency_TYPE_QNAME);
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Money instance = new com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Money();
        com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Money_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_currency_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Money_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myCURRENCY_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setCurrency((com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Currency)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Money instance = (com.rssl.phizic.web.gate.services.payments.systems.recipients.generated.Money)obj;

 ...
 * @ $Revision: 3337 $
 */
class AccountInfoDemandQCache extends MessagesCache
{
	private static final String ACCOUNT_NUMBER_PATH = "/accountInfoDemand_q/account";
	private List<Class> classes;

	protected String getCacheName ()
	{
		return AccountInfoDemandQCache.class.getName();
	}

...
/**
 * —ендер перевода между счетами клиента.
 *
 * @author gladishev
 * @ created 22.04.2014
 * @ $Author$
...
public class DepoCodInternalPaymentSender extends DepoCodSenderBase
{
	public DepoCodInternalPaymentSender(GateFactory factory)
	{
		super(factory);
	}

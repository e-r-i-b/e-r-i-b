...
<tr>
<td>
<table cellpadding="0" class="font10" width="100%" >
	<tr>
...
<tr>
	...
	<td align="center">
			<input type="Text" readonly="true" class="insertInput font10" style="width:98%;text-align:center;">
			<xsl:attribute name="value">
...
<metaInformation>
<scenarios ><scenario default="yes" name="f360" userelativepaths="yes" externalpreview="no" url="extract.xml" htmlbaseurl="" outputurl="" processortype="internal" useresolver="yes" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator=""/></scenarios><MapperMetaTag><MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no"/><MapperBlockPosition></MapperBlockPosition><TemplateContext></TemplateContext><MapperFilter side="source"></MapperFilter></MapperMetaTag>
</metaInformation>
-->
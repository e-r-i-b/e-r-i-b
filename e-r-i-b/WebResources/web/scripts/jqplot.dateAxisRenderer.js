...
(function($) {  
    ...
    $.jqplot.DateTickFormatter = function(format, val) {
        ...
        if (format == '%Q') {
            var mnth = $.jsDate.strftime(val, '%#m');
            var quarter = parseInt((mnth - 1) / 3) + 1;
            /*return quarter + ' квартал<br>\n' + $.jsDate.strftime(val, '%Y');*/
            return quarter + ' квартал ' + $.jsDate.strftime(val, '%Y');
        }

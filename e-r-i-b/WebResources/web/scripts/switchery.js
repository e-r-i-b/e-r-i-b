...
function Switchery(element, options) {
    ...
    if (element.initSwitchery == true)
        return;

    if (!(this instanceof Switchery))
    {
        element.initSwitchery = true;
...
Switchery.prototype.show = function(element) {
  var switcher = this.create(element);
...
Switchery.prototype.create = function(element) {
    var parent = $(element).parent();
    this.switcher = parent.find('.switchery-css3')[0];
    this.jack = parent.find('small')[0];
    this.onText = parent.find('.onText')[0];
    this.offText = parent.find('.offText')[0];
...
Switchery.prototype.setPosition = function (clicked) {
  ...
  if (checked === true) 
  {
	this.onText.style.display = '';
	this.offText.style.display = 'none';
  ...
  {
	this.onText.style.display = 'none';
	this.offText.style.display = '';
    jack.style.left = 0;
...
Switchery.prototype.colorize = function() {
  ...
  this.switcher.style.borderColor = this.options.borderColor;
...
Switchery.prototype.init = function(element) {
  this.hide();
  this.show(element);
  this.setPosition();
  this.setAttributes();

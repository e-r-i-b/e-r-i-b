...
public class PfrDoneServiceImplLocator extends org.apache.axis.client.Service implements com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneServiceImpl {
    ...
    public com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneService getPfrDoneServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneService getPfrDoneServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneServiceSoapBindingStub _stub = new com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneServiceSoapBindingStub _stub = new com.rssl.phizic.ws.esberiblistener.pfr.generated.PfrDoneServiceSoapBindingStub(new java.net.URL(PfrDoneServicePort_address), this);
                _stub.setPortName(getPfrDoneServicePortWSDDServiceName());
                return _stub;
            }
        }

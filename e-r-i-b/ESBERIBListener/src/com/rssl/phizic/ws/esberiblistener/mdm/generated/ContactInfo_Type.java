...
public class ContactInfo_Type  implements java.io.Serializable {
    ...
    private com.rssl.phizic.ws.esberiblistener.mdm.generated.MessageDeliveryType_Type messageDeliveryType;

    /* Блок нетипизированных контактных данных */
    private com.rssl.phizic.ws.esberiblistener.mdm.generated.ContactData_Type[] contactData;

    /* Полный адрес */
    private com.rssl.phizic.ws.esberiblistener.mdm.generated.FullAddress_Type[] postAddr;
    ...
    public ContactInfo_Type(
           ...
           com.rssl.phizic.ws.esberiblistener.mdm.generated.MessageDeliveryType_Type messageDeliveryType,
           com.rssl.phizic.ws.esberiblistener.mdm.generated.ContactData_Type[] contactData,
           com.rssl.phizic.ws.esberiblistener.mdm.generated.FullAddress_Type[] postAddr) {
     ...
     */
    public com.rssl.phizic.ws.esberiblistener.mdm.generated.MessageDeliveryType_Type getMessageDeliveryType() {
     ...
     */
    public void setMessageDeliveryType(com.rssl.phizic.ws.esberiblistener.mdm.generated.MessageDeliveryType_Type messageDeliveryType) {
        this.messageDeliveryType = messageDeliveryType;
    }
     ...
     */
    public com.rssl.phizic.ws.esberiblistener.mdm.generated.ContactData_Type[] getContactData() {
        return contactData;
    }
     ...
     */
    public void setContactData(com.rssl.phizic.ws.esberiblistener.mdm.generated.ContactData_Type[] contactData) {
        this.contactData = contactData;
    }

    public com.rssl.phizic.ws.esberiblistener.mdm.generated.ContactData_Type getContactData(int i) {
        return this.contactData[i];
    }

    public void setContactData(int i, com.rssl.phizic.ws.esberiblistener.mdm.generated.ContactData_Type _value) {
     ...
     */
    public com.rssl.phizic.ws.esberiblistener.mdm.generated.FullAddress_Type[] getPostAddr() {
        return postAddr;
    }
     ...
     */
    public void setPostAddr(com.rssl.phizic.ws.esberiblistener.mdm.generated.FullAddress_Type[] postAddr) {
        this.postAddr = postAddr;
    }

    public com.rssl.phizic.ws.esberiblistener.mdm.generated.FullAddress_Type getPostAddr(int i) {
        return this.postAddr[i];
    }

    public void setPostAddr(int i, com.rssl.phizic.ws.esberiblistener.mdm.generated.FullAddress_Type _value) {

...
<body>
<h1>Редактирование автоплатежа (шина): подтверждение</h1>

<html:form action="/atm/editAutoSubscriptionPayment" show="true">
    ...
    <tiles:insert definition="atm" flush="false">
        ...
        <tiles:put name="data">
            <c:set var="document" value="${form.response.document.editAutoSubscriptionDocument}"/>
            <tiles:insert page="fields-table.jsp" flush="false">
                <tiles:put name="data">
                    ...
                    <c:set var="extendedFields" value="${document.paymentDetails.externalFields}"/>
                    ...
                    <c:if test="${not empty document.paymentDetails.promoCode}">
                        <tiles:insert page="field.jsp" flush="false">
                            <tiles:put name="field" beanName="document" beanProperty="paymentDetails.promoCode"/>
                        </tiles:insert>
                    </c:if>

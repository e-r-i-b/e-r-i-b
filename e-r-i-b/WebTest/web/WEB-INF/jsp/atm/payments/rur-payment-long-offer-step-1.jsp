...
<script type="text/javascript">
    var receiverSubType; //тип счета получател€ (ourAccount, externalAccount)
    var fromResourceFields; //тип ресурса списани€ (fromCardFields, fromAccountFields)
    ...
    //обновление полей в зависимости от типа счета получател€ (receiverSubType) и типа ресурса списани€ (fromResource). Ќужен однократно на старте
    ...
    //изменение типа исполнени€ автоплатежа (eventType)
    ...
    //установить событие: при вводе символов в пол€ с суммами взводить флаг isSumModify
...
<html:html>
<head>
    <title>—оздание автоплатежа перевода частному лицу</title>
</head>

<body>
<h1>ѕодключение автоплатежа</h1>

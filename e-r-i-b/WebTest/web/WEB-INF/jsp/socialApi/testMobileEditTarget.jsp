...
<html:form action="/socialApi/multipartFormData/ALFTarget" enctype="multipart/form-data" show="true">
    <tiles:insert definition="social" flush="false">
        <tiles:put name="address" value="/private/finances/targets/edit.do?operation=save"/>

...
<html:html>
    ...
    <body>
    <h1>Изменение порядка уплаты процентов по вкладу</h1>
    ...
    <html:form action="/mobileApi/accountChangeInterestDestinationClaim" show="true">
        ...
        <tiles:insert definition="mobile" flush="false">
            ...
            <tiles:put name="data">
                <c:set var="document" value="${form.response.document.accountChangeInterestDestinationClaimDocument}"/>
                <tiles:insert page="fields-table.jsp" flush="false">
                    <tiles:put name="data">
                        ...
                        <c:if test="${document.percentTransferCardSource != null}">
                            <tiles:insert page="field.jsp" flush="false">

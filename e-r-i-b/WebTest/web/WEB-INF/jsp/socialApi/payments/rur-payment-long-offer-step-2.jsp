...
<html:form action="/mobileApi/rurPaymentLongOffer" show="true">
    ...
    <tiles:insert definition="mobile" flush="false">
        ...
        <tiles:put name="data">
            <c:set var="document" value="${form.response.document.rurPaymentLongOfferDocument}"/>
            <tiles:insert page="fields-table.jsp" flush="false">
                <tiles:put name="data">
                    ...
                    <tiles:insert page="field.jsp" flush="false">
                        <tiles:put name="field" beanName="receiver" beanProperty="fio"/>
                    </tiles:insert>
                    <tiles:insert page="field.jsp" flush="false">
                    ...
                    <c:set var="bank" value="${document.bank}"/>
                    <tiles:insert page="field.jsp" flush="false">
                    ...
                    <c:if test="${not empty paymentDetails.buyAmountCurrency}">
                        <tiles:insert page="field.jsp" flush="false">
                            <tiles:put name="field" beanName="paymentDetails" beanProperty="buyAmountCurrency"/>
                        </tiles:insert>
                    </c:if>

...
<body>
<h1>Отмена длительного поручения: подтверждение</h1>
...
<html:form action="/mobileApi/refuseLongOffer" show="true">
    ...
    <tiles:insert definition="mobile" flush="false">
        ...
        <tiles:put name="data">
            <c:set var="document" value="${form.response.document.refuseLongOfferDocument}"/>
            <tiles:insert page="fields-table.jsp" flush="false">
                <tiles:put name="data">
                    <tiles:insert page="field.jsp" flush="false">
                        <tiles:put name="field" beanName="document" beanProperty="longOfferType"/>
                    </tiles:insert>
                    <tiles:insert page="field.jsp" flush="false">
                        <tiles:put name="field" beanName="document" beanProperty="longOfferId"/>
                    </tiles:insert>
                    ...
                    <c:set var="payment" value="${document.payment}"/>
                    <tiles:insert page="field.jsp" flush="false">
                    ...
                    <c:choose>
                        <c:when test="${form.version >= 6.00}">
                            <tiles:insert page="field.jsp" flush="false">
                                <tiles:put name="field" beanName="longOfferDetails" beanProperty="executionEventDescription"/>
                            </tiles:insert>
                        </c:when>
                        <c:otherwise>
                            <tiles:insert page="field.jsp" flush="false">

...
<c:set var="version" value="5.30"/>

<html:html>
  <head><title>mAPI v5.x test</title>
   <script type="text/javascript" src="${initParam.resourcesRealPath}/scripts/XMLDisplay.js"></script>
   <script type="text/javascript">
	var operations = {};


	operations['/login.do'] = "version=${version}&appType=iPhone&appVersion=82&deviceName=SiemensA35&operation=button.login&isLightScheme=false&mGUID=27B9590B2F6B4BF7B2FEF500399481E3";
    operations['/registerApp.do?operation=register'] = "version=${version}&appType=iPhone&appVersion=82&deviceName=SiemensA35&login=123";
    operations['/registerApp.do?operation=checkCaptcha'] = "version=${version}&appType=iPhone&login=123&captcha=";
    operations['/registerApp.do?operation=refreshCaptcha'] = "";
    operations['/registerApp.do?operation=confirm'] = "version=${version}&appType=iPhone&appVersion=82&deviceName=SiemensA35&isLightScheme=false&mGUID=&password=&smsPassword=";
    ...
    operations['/private/dictionary/servicesPayments.do'] = "id=&autoPaymentOnly=";
    ...
    operations['/private/loan/loanOffer/show.do'] = "";
  ...
  <html:form action="/mobile5" show="true">
      ...
      <select name="address" onchange="changeAddress (this);" id="address">
          ...
          <optgroup label="Информация по автоплатежам">
              ...
              <option value="/private/autopayments/list.do">/private/autopayments/list.do Список автоплатежей (mAPI < 5.10)</option>  
          ...
          <optgroup label="Справочники">
              ...
              <option value="/private/dictionary/popularPayments.do">/private/dictionary/popularPayments.do Популярные платежи (mAPI < 5.20)</option>
          </optgroup>
      ...
      <c:choose>
          ...
          <c:otherwise>
              <textarea cols="60" rows="5" name="note">Заметки: Авторизация:version=5.20&appType=iPhone&appVersion=82&deviceName=SamsungGalaxyMini2&operation=button.login&isLightScheme=false&mGUID=27B9590B2F6B4BF7B2FEF500399481E3</textarea>
          </c:otherwise>
      </c:choose>
      <br/>

...
<html:html>
<head><title>mAPI v8.x test</title>
...
<html:form action="/mobile8" show="true">
...
Root: <select onchange="setUrl()" id="root">
    ...
    <option value="mobile8">mobile8</option>
</select>
...
<c:choose>
    ...
    <c:otherwise>
        <textarea cols="60" rows="5" name="note">Заметки:
            Авторизация:version=8.00&appType=iPhone&appVersion=82&deviceName=SamsungGalaxyMini2&operation=button.login&isLightScheme=false&mGUID=27B9590B2F6B4BF7B2FEF500399481E3</textarea>
    </c:otherwise>
</c:choose>
<br/>

...
<html:html>
    ...
    <body>
    <h1>Редактирование автопоиска: сохранение</h1>
        ...
        <tiles:insert definition="mobile" flush="false">
            ...
            <tiles:put name="data">
                <c:if test="${not empty form.response}">
                    <c:set var="initialData" value="${form.response.initialData.editInvoiceSubscriptionClaim}"/>
                    <tiles:insert page="../payments/fields-table.jsp" flush="false">
                        <tiles:put name="data">
                            <tiles:insert page="../payments/field.jsp" flush="false">
                                <tiles:put name="field" beanName="initialData" beanProperty="nameService"/>
                            </tiles:insert>
                            <tiles:insert page="../payments/field.jsp" flush="false">
                                <tiles:put name="field" beanName="initialData" beanProperty="invoiceAccountName"/>
                            </tiles:insert>
                            ...
                            <c:set var="requisites" value="${initialData.requisites}"/>
                            ...
                            <tiles:insert page="../payments/field.jsp" flush="false">
                                <tiles:put name="field" beanName="initialData" beanProperty="subscriptionName"/>
                            </tiles:insert>
                            <tiles:insert page="../payments/field.jsp" flush="false">
                                <tiles:put name="field" beanName="initialData" beanProperty="fromResource"/>
                            </tiles:insert>
                            <tiles:insert page="../payments/field.jsp" flush="false">
                                <tiles:put name="field" beanName="initialData" beanProperty="accountingEntity"/>
                            </tiles:insert>
                            <tiles:insert page="../payments/field.jsp" flush="false">
                                <tiles:put name="field" beanName="initialData" beanProperty="eventType"/>
                            </tiles:insert>
                            <tiles:insert page="../payments/field.jsp" flush="false">
                                <tiles:put name="field" beanName="initialData" beanProperty="dayPay"/>
                            </tiles:insert>
                        </tiles:put>
                    </tiles:insert>
                </c:if>

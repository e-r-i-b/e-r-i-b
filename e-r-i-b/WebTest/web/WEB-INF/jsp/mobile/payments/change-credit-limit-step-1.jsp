...
<html:html>
<head>
    <title>Отказ или согласие с кредитным лимитом</title>
</head>

<body>
<h1>Отказ или согласие с кредитным лимитом: сохранение</h1>
...
<html:form action="/mobileApi/changeCreditLimitClaim" show="true">
    ...
    <tiles:insert definition="mobile" flush="false">
        ...
        <c:set var="initialData" value="${form.response.initialData.changeCreditLimitClaim}"/>

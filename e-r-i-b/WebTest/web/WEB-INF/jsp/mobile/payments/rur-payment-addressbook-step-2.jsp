...
<body>
<h1>Универсальный перевод на карту частному лицу: подтверждение</h1>

<html:form action="/mobileApi/rurPaymentAddressBook" show="true">
    <tiles:insert definition="mobile" flush="false">
        <tiles:put name="address" value="/private/payments/payment.do"/>
        <tiles:put name="data">
            <%@include file="rur-payment-addressbook-document.jsp"%>
...
<script type="text/javascript">
    ...
    {
        var confirmUrl = "${phiz:calculateActionURL(pageContext, '/mobileApi/confirmPayment')}?id=${curForm.response.document.id}";

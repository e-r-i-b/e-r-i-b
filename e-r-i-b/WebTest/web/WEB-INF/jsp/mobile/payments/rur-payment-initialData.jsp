    ...
    <tiles:put name="data">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="cardFields.fromResource"/>
                    <tiles:put name="tdClass" value="floatField ourCard ourPhone masterCardExternalCard visaExternalCard social"/>
                </tiles:insert>
            </c:otherwise>
        </c:choose>
        <tiles:insert page="field.jsp" flush="false">
        ...
        <c:choose>
            <c:when test="${form.version >= 8.00}">
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="cardFields.social.externalSocialId"/>
                    <tiles:put name="tdClass" value="floatField social"/>
                </tiles:insert>
                <c:if test="${not empty initialData.cardFields.social.messageToReceiver}">
                    <tiles:insert page="field.jsp" flush="false">
                        <tiles:put name="field" beanName="initialData" beanProperty="cardFields.social.messageToReceiver"/>
                        <tiles:put name="tdClass" value="floatField social"/>
                    </tiles:insert>
                </c:if>
            </c:when>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.ourAccount.receiverAccountInternal"/>
                    <tiles:put name="tdClass" value="floatField ourAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.externalAccount.receiverAccountExternal"/>
                    <tiles:put name="tdClass" value="floatField externalAccount"/>
                </tiles:insert>
            </c:otherwise>
        </c:choose>
        <tiles:insert page="field.jsp" flush="false">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.ourAccount.receiverSurname"/>
                    <tiles:put name="tdClass" value="floatField ourAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.externalAccount.receiverSurname"/>
                    <tiles:put name="tdClass" value="floatField externalAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.ourAccount.receiverFirstName"/>
                    <tiles:put name="tdClass" value="floatField ourAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.externalAccount.receiverFirstName"/>
                    <tiles:put name="tdClass" value="floatField externalAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.ourAccount.receiverPatrName"/>
                    <tiles:put name="tdClass" value="floatField ourAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.externalAccount.receiverPatrName"/>
                    <tiles:put name="tdClass" value="floatField externalAccount"/>
                </tiles:insert>

                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.ourAccount.bankInfo.bank"/>
                    <tiles:put name="tdClass" value="floatField ourAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.externalAccount.bankInfo.bank"/>
                    <tiles:put name="tdClass" value="floatField externalAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.ourAccount.bankInfo.receiverBIC"/>
                    <tiles:put name="tdClass" value="floatField ourAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.externalAccount.bankInfo.receiverBIC"/>
                    <tiles:put name="tdClass" value="floatField externalAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.ourAccount.bankInfo.receiverCorAccount"/>
                    <tiles:put name="tdClass" value="floatField ourAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
                    <tiles:put name="field" beanName="initialData" beanProperty="accountFields.externalAccount.bankInfo.receiverCorAccount"/>
                    <tiles:put name="tdClass" value="floatField externalAccount"/>
                </tiles:insert>
                <tiles:insert page="field.jsp" flush="false">
        ...
        <c:if test="${form.version >= 9.00}">
            <tiles:insert page="field.jsp" flush="false">
                <tiles:put name="field" beanName="initialData" beanProperty="cardFields.isFundPayment"/>
            </tiles:insert>
            <tiles:insert page="field.jsp" flush="false">
                <tiles:put name="field" beanName="initialData" beanProperty="cardFields.fundResponseId"/>
            </tiles:insert>
        </c:if>
    </tiles:put>
</tiles:insert>

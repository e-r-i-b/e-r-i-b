...
public class CommonRqType_InterfaceSOAPSerializer extends InterfaceSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_myVerifySIDRqType_InterfaceSOAPSerializer = (CombinedSerializer)registry.getSerializer("", com.rssl.phizic.test.way4.ws.mock.generated.VerifySIDRqType.class, ns1_VerifySIDRqType_TYPE_QNAME);
        ...
        CombinedSerializer interfaceSerializer = new com.rssl.phizic.test.way4.ws.mock.generated.CommonRqType_LiteralSerializer(type, "", DONT_ENCODE_TYPE);
    ...
    public void doSerializeInstance(java.lang.Object obj, javax.xml.namespace.QName name, SerializerCallback callback,
        ...
        if (obj instanceof com.rssl.phizic.test.way4.ws.mock.generated.PrepareOTPRqType) {
            ns1_myPrepareOTPRqType_LiteralSerializer.serialize(obj, name, callback, writer, context);
        } else if (obj instanceof com.rssl.phizic.test.way4.ws.mock.generated.VerifyPasswordRqType) {
            ns1_myVerifyPasswordRqType_LiteralSerializer.serialize(obj, name, callback, writer, context);
        } else if (obj instanceof com.rssl.phizic.test.way4.ws.mock.generated.VerifySPRqType) {
            ns1_myVerifySPRqType_LiteralSerializer.serialize(obj, name, callback, writer, context);
        } else if (obj instanceof com.rssl.phizic.test.way4.ws.mock.generated.VerifySIDRqType) {

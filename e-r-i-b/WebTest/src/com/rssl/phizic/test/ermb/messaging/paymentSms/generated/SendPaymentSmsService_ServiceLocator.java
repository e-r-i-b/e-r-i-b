...
public class SendPaymentSmsService_ServiceLocator extends org.apache.axis.client.Service implements com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsService_Service {
    ...
    public com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsService_PortType getSendPaymentSmsServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsService_PortType getSendPaymentSmsServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsServiceBindingStub _stub = new com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsServiceBindingStub _stub = new com.rssl.phizic.test.ermb.messaging.paymentSms.generated.SendPaymentSmsServiceBindingStub(new java.net.URL(SendPaymentSmsServicePort_address), this);
                _stub.setPortName(getSendPaymentSmsServicePortWSDDServiceName());
                return _stub;
            }
        }

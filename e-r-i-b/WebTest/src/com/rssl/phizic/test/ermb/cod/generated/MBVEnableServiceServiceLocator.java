...
public class MBVEnableServiceServiceLocator extends org.apache.axis.client.Service implements com.rssl.phizic.test.ermb.cod.generated.MBVEnableServiceService {
    ...
    public com.rssl.phizic.test.ermb.cod.generated.MBVEnableService getMBVEnableService() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.phizic.test.ermb.cod.generated.MBVEnableService getMBVEnableService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.test.ermb.cod.generated.MBVEnableServiceSoapBindingStub _stub = new com.rssl.phizic.test.ermb.cod.generated.MBVEnableServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.phizic.test.ermb.cod.generated.MBVEnableService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.test.ermb.cod.generated.MBVEnableServiceSoapBindingStub _stub = new com.rssl.phizic.test.ermb.cod.generated.MBVEnableServiceSoapBindingStub(new java.net.URL(MBVEnableService_address), this);
                _stub.setPortName(getMBVEnableServiceWSDDServiceName());
                return _stub;
            }
        }

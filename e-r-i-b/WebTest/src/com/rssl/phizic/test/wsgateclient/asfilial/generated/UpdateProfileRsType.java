...
public class UpdateProfileRsType  implements java.io.Serializable {
    ...
    private com.rssl.phizic.test.wsgateclient.asfilial.generated.StatusType status;

    private com.rssl.phizic.test.wsgateclient.asfilial.generated.PhoneNumberType[] engagedPhones;

    public UpdateProfileRsType() {
    }
    ...
    public UpdateProfileRsType(
           ...
           com.rssl.phizic.test.wsgateclient.asfilial.generated.StatusType status,
           com.rssl.phizic.test.wsgateclient.asfilial.generated.PhoneNumberType[] engagedPhones) {
           this.rqUID = rqUID;
           this.rqTm = rqTm;
    ...
    /**
     * Gets the rqUID value for this UpdateProfileRsType.
     * 
    ...
    /**
     * Sets the rqUID value for this UpdateProfileRsType.
     * 
    ...
    /**
     * Gets the rqTm value for this UpdateProfileRsType.
     * 
     * @return rqTm
     */
    ...
    /**
     * Sets the rqTm value for this UpdateProfileRsType.
     * 
     * @param rqTm
     */
    ...
    /**
     * Gets the operUID value for this UpdateProfileRsType.
     * 
    ...
    /**
     * Sets the operUID value for this UpdateProfileRsType.
     * 
    ...
    /**
     * Gets the status value for this UpdateProfileRsType.
     * 
     * @return status
     */
    public com.rssl.phizic.test.wsgateclient.asfilial.generated.StatusType getStatus() {
        return status;
    }


    /**
     * Sets the status value for this UpdateProfileRsType.
     * 
     * @param status
     */
    public void setStatus(com.rssl.phizic.test.wsgateclient.asfilial.generated.StatusType status) {
        this.status = status;
    }


    /**
     * Gets the engagedPhones value for this UpdateProfileRsType.
     * 
     * @return engagedPhones
     */
    public com.rssl.phizic.test.wsgateclient.asfilial.generated.PhoneNumberType[] getEngagedPhones() {
        return engagedPhones;
    }


    /**
     * Sets the engagedPhones value for this UpdateProfileRsType.
     * 
     * @param engagedPhones
     */
    public void setEngagedPhones(com.rssl.phizic.test.wsgateclient.asfilial.generated.PhoneNumberType[] engagedPhones) {
        this.engagedPhones = engagedPhones;
    }

    public com.rssl.phizic.test.wsgateclient.asfilial.generated.PhoneNumberType getEngagedPhones(int i) {
        return this.engagedPhones[i];
    }

    public void setEngagedPhones(int i, com.rssl.phizic.test.wsgateclient.asfilial.generated.PhoneNumberType _value) {
        this.engagedPhones[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateProfileRsType)) return false;
        UpdateProfileRsType other = (UpdateProfileRsType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateProfileRsType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://generated.listener.asfilial.phizic.rssl.com", "UpdateProfileRsType"));

...
public class ConsumeOutMessageArg  implements java.io.Serializable {
    private com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.Auth auth;

    private com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.OutMessage[] outMessage;

    public ConsumeOutMessageArg() {
    }

    public ConsumeOutMessageArg(
           com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.Auth auth,
           com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.OutMessage[] outMessage) {
           this.auth = auth;
     ...
     * @return auth
     */
    public com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.Auth getAuth() {
        return auth;
    }
     ...
     * @param auth
     */
    public void setAuth(com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.Auth auth) {
        this.auth = auth;
    }
     ...
     * @return outMessage
     */
    public com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.OutMessage[] getOutMessage() {
        return outMessage;
    }
     ...
     * @param outMessage
     */
    public void setOutMessage(com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.OutMessage[] outMessage) {
        this.outMessage = outMessage;
    }

    public com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.OutMessage getOutMessage(int i) {
        return this.outMessage[i];
    }

    public void setOutMessage(int i, com.rssl.phizic.test.wsgateclient.mfm.outmessageconsumer.generated.OutMessage _value) {

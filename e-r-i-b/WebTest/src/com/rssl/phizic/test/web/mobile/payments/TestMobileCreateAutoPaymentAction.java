...
/**
 * Тест создания автоплатежа оплаты услуг (iqwave и шинные) с нуля
...
public class TestMobileCreateAutoPaymentAction extends TestMobileDocumentAction
{
	...
	private ActionForward init(ActionMapping mapping, TestMobileDocumentForm form)
	{
		if (send(form) == 0)
	...
	private ActionForward submitSaveAutoPayment(ActionMapping mapping, TestMobileDocumentForm form)
	{
		send(form);
		return mapping.findForward(FORWARD_EDIT_AND_VIEW_DOCUMENT);
	}

 ...
 */
public class TestATMLoanProductOpeningClaimAction extends TestATMDocumentAction
{
	...
	protected ActionForward submitInit(ActionMapping mapping, TestATMDocumentForm form)
	{
		...
		if (stateCode == 0)
		{
			if (form.getResponse() instanceof ResponseElement)
			{
				...
				if (respMob4.getLoanProductStage()!=null)
					return mapping.findForward(FORWARD_STAGE);
				else if (respMob4.getInitialData() != null && respMob4.getInitialData().getLoanProduct()!=null)
					return mapping.findForward(FORWARD_CONDITIONS_AND_REGISTRATION);
				else if (respMob4.getDocument() != null && respMob4.getDocument().getLoanProductDocument() != null)
					return mapping.findForward(FORWARD_CONDITIONS_AND_REGISTRATION);
			}
		}
		return  mapping.findForward(FORWARD_INIT);

 ...
 */
public class TestMobileLoanProductOpeningClaimAction extends TestMobileDocumentAction
{
		...
		if (stateCode == 0)
		{
			try
			{
				...
				if (response != null)
				{
					...
					Method getLoanProductStage = responseClass.getMethod("getLoanProductStage");
					if (getLoanProductStage.invoke(response) != null)
					...
					if (initialData != null) {
						...
						Method getLoanProduct = initialDataClass.getMethod("getLoanProduct");
						if (getLoanProduct.invoke(initialData) != null)
					...
					if (document != null) {
						...
						Method getLoanProductDocument = documentClass.getMethod("getLoanProductDocument");
						if (getLoanProductDocument.invoke(document) != null)
							return mapping.findForward(FORWARD_CONDITIONS_AND_REGISTRATION);
					}
				}

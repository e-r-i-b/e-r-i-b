/**
 * GetAutoSubscriptionDetailInfoRs_Type.java
 *
...
/**
 * Тип сообщения-ответа для интерфейса GASDI - получение детальной
 * информации по подписке
 */
public class GetAutoSubscriptionDetailInfoRs_Type  implements java.io.Serializable {
    ...
    public GetAutoSubscriptionDetailInfoRs_Type() {
    }
    ...
    /**
     * Gets the rqUID value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @return rqUID
     */
    ...
    /**
     * Sets the rqUID value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @param rqUID
     */
    ...
    /**
     * Gets the rqTm value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @return rqTm
     */
    ...
    /**
     * Sets the rqTm value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @param rqTm
     */
    ...
    /**
     * Gets the operUID value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @return operUID
     */
    ...
    /**
     * Sets the operUID value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @param operUID
     */
    ...
    /**
     * Gets the status value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
     * @param status
     */
    ...
    /**
     * Gets the autoSubscriptionRec value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
    ...
    /**
     * Sets the autoSubscriptionRec value for this GetAutoSubscriptionDetailInfoRs_Type.
     * 
    ...
    public com.rssl.phizic.test.webgate.esberib.generated.AutoSubscriptionRec_Type getAutoSubscriptionRec(int i) {
        return this.autoSubscriptionRec[i];
    }

    public void setAutoSubscriptionRec(int i, com.rssl.phizic.test.webgate.esberib.generated.AutoSubscriptionRec_Type _value) {
        this.autoSubscriptionRec[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetAutoSubscriptionDetailInfoRs_Type)) return false;
        GetAutoSubscriptionDetailInfoRs_Type other = (GetAutoSubscriptionDetailInfoRs_Type) obj;
        ...
        _equals = true && 
            ...
            ((this.autoSubscriptionRec==null && other.getAutoSubscriptionRec()==null) || 
             (this.autoSubscriptionRec!=null &&
              java.util.Arrays.equals(this.autoSubscriptionRec, other.getAutoSubscriptionRec())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getAutoSubscriptionRec() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getAutoSubscriptionRec());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getAutoSubscriptionRec(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAutoSubscriptionDetailInfoRs_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "GetAutoSubscriptionDetailInfoRs_Type"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "AutoSubscriptionRec"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);

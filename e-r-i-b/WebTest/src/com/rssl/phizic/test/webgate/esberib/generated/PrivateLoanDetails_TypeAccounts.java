...
public class PrivateLoanDetails_TypeAccounts  implements java.io.Serializable {
    private com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsCardElement[] card;

    private com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsAccountElement[] account;

    public PrivateLoanDetails_TypeAccounts() {
    }

    public PrivateLoanDetails_TypeAccounts(
           com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsCardElement[] card,
           com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsAccountElement[] account) {
           this.card = card;
     ...
     * @return card
     */
    public com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsCardElement[] getCard() {
        return card;
    }
     ...
     * @param card
     */
    public void setCard(com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsCardElement[] card) {
        this.card = card;
    }
     ...
     * @return account
     */
    public com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsAccountElement[] getAccount() {
        return account;
    }
     ...
     * @param account
     */
    public void setAccount(com.rssl.phizic.test.webgate.esberib.generated.PrivateLoanDetails_TypeAccountsAccountElement[] account) {
        this.account = account;
    }

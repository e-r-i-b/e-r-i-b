/**
 * CreateCardContractRq_Type.java
 *
...
/**
 * Тип запроса для интерфейса SrvCreateCardContract. Создание договора
 * на карту
 */
public class CreateCardContractRq_Type  implements java.io.Serializable {
    ...
    private com.rssl.phizic.test.webgate.esberib.generated.CardContract_Type cardContract;

    /* Признак того, что договор подписан или не подписан */
    private boolean notSigned;

    public CreateCardContractRq_Type() {
    }
    ...
    public CreateCardContractRq_Type(
           ...
           com.rssl.phizic.test.webgate.esberib.generated.CardContract_Type cardContract,
           boolean notSigned) {
           this.rqUID = rqUID;
           this.rqTm = rqTm;
           ...
           this.cardContract = cardContract;
           this.notSigned = notSigned;
    }


    /**
     * Gets the rqUID value for this CreateCardContractRq_Type.
     * 
     * @return rqUID
     */
    ...
    /**
     * Sets the rqUID value for this CreateCardContractRq_Type.
     * 
     * @param rqUID
     */
    ...
    /**
     * Gets the rqTm value for this CreateCardContractRq_Type.
     * 
     * @return rqTm
     */
    ...
    /**
     * Sets the rqTm value for this CreateCardContractRq_Type.
     * 
     * @param rqTm
     */
    ...
    /**
     * Gets the operUID value for this CreateCardContractRq_Type.
     * 
     * @return operUID
     */
    ...
    /**
     * Sets the operUID value for this CreateCardContractRq_Type.
     * 
     * @param operUID
     */
    ...
    /**
     * Gets the SPName value for this CreateCardContractRq_Type.
     * 
     * @return SPName
     */
    ...
    /**
     * Sets the SPName value for this CreateCardContractRq_Type.
     * 
     * @param SPName
     */
    ...
    /**
     * Gets the bankInfo value for this CreateCardContractRq_Type.
     * 
     * @return bankInfo
     */
    ...
    /**
     * Sets the bankInfo value for this CreateCardContractRq_Type.
     * 
     * @param bankInfo
     */
    ...
    /**
     * Gets the custRec value for this CreateCardContractRq_Type.
     * 
     * @return custRec
     */
    ...
    /**
     * Sets the custRec value for this CreateCardContractRq_Type.
     * 
     * @param custRec
     */
    ...
    /**
     * Gets the cardContract value for this CreateCardContractRq_Type.
     * 
     * @return cardContract
     */
    public com.rssl.phizic.test.webgate.esberib.generated.CardContract_Type getCardContract() {
        return cardContract;
    }


    /**
     * Sets the cardContract value for this CreateCardContractRq_Type.
     * 
     * @param cardContract
     */
    public void setCardContract(com.rssl.phizic.test.webgate.esberib.generated.CardContract_Type cardContract) {
        this.cardContract = cardContract;
    }


    /**
     * Gets the notSigned value for this CreateCardContractRq_Type.
     * 
    ...
    /**
     * Sets the notSigned value for this CreateCardContractRq_Type.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateCardContractRq_Type)) return false;
        CreateCardContractRq_Type other = (CreateCardContractRq_Type) obj;
        ...
        _equals = true && 
            ...
            ((this.cardContract==null && other.getCardContract()==null) || 
             (this.cardContract!=null &&
              this.cardContract.equals(other.getCardContract()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getCardContract() != null) {
            _hashCode += getCardContract().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateCardContractRq_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "CreateCardContractRq_Type"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("cardContract");
        elemField.setXmlName(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "CardContract"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "CardContract_Type"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();

...
public class FraudMonitoringAsyncInteractionService_ServiceLocator extends org.apache.axis.client.Service implements com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionService_Service {
    ...
    private java.lang.String FraudMonitoringAsyncInteractionService_address = "http://localhost:8080/FraudMonitoringBackGateApp/services/FraudMonitoringAsyncInteractionService";
    ...
    public com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionService_PortType getFraudMonitoringAsyncInteractionService() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionService_PortType getFraudMonitoringAsyncInteractionService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionServiceSoapBindingStub _stub = new com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionServiceSoapBindingStub _stub = new com.rssl.phizic.test.webgate.rsa.integration.ws.back.generated.FraudMonitoringAsyncInteractionServiceSoapBindingStub(new java.net.URL(FraudMonitoringAsyncInteractionService_address), this);
                _stub.setPortName(getFraudMonitoringAsyncInteractionServiceWSDDServiceName());
                return _stub;
            }
        }

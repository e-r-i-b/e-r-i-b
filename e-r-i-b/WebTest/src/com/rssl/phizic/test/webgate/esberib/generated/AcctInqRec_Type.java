...
public class AcctInqRec_Type  implements java.io.Serializable {
    private com.rssl.phizic.test.webgate.esberib.generated.BankAcctRes_Type[] bankAcctRes;

    private com.rssl.phizic.test.webgate.esberib.generated.DepAcctRes_Type[] depAcctRes;

    private com.rssl.phizic.test.webgate.esberib.generated.CardAcctRes_Type[] cardAcctRes;

    public AcctInqRec_Type() {
    }

    public AcctInqRec_Type(
           com.rssl.phizic.test.webgate.esberib.generated.BankAcctRes_Type[] bankAcctRes,
           com.rssl.phizic.test.webgate.esberib.generated.DepAcctRes_Type[] depAcctRes,
           com.rssl.phizic.test.webgate.esberib.generated.CardAcctRes_Type[] cardAcctRes) {
     ...
     * @return bankAcctRes
     */
    public com.rssl.phizic.test.webgate.esberib.generated.BankAcctRes_Type[] getBankAcctRes() {
        return bankAcctRes;
    }
     ...
     * @param bankAcctRes
     */
    public void setBankAcctRes(com.rssl.phizic.test.webgate.esberib.generated.BankAcctRes_Type[] bankAcctRes) {
        this.bankAcctRes = bankAcctRes;
    }

    public com.rssl.phizic.test.webgate.esberib.generated.BankAcctRes_Type getBankAcctRes(int i) {
        return this.bankAcctRes[i];
    }

    public void setBankAcctRes(int i, com.rssl.phizic.test.webgate.esberib.generated.BankAcctRes_Type _value) {
     ...
     * @return depAcctRes
     */
    public com.rssl.phizic.test.webgate.esberib.generated.DepAcctRes_Type[] getDepAcctRes() {
        return depAcctRes;
    }
     ...
     * @param depAcctRes
     */
    public void setDepAcctRes(com.rssl.phizic.test.webgate.esberib.generated.DepAcctRes_Type[] depAcctRes) {
        this.depAcctRes = depAcctRes;
    }

    public com.rssl.phizic.test.webgate.esberib.generated.DepAcctRes_Type getDepAcctRes(int i) {
        return this.depAcctRes[i];
    }

    public void setDepAcctRes(int i, com.rssl.phizic.test.webgate.esberib.generated.DepAcctRes_Type _value) {
     ...
     * @return cardAcctRes
     */
    public com.rssl.phizic.test.webgate.esberib.generated.CardAcctRes_Type[] getCardAcctRes() {
        return cardAcctRes;
    }
     ...
     * @param cardAcctRes
     */
    public void setCardAcctRes(com.rssl.phizic.test.webgate.esberib.generated.CardAcctRes_Type[] cardAcctRes) {
        this.cardAcctRes = cardAcctRes;
    }

    public com.rssl.phizic.test.webgate.esberib.generated.CardAcctRes_Type getCardAcctRes(int i) {
        return this.cardAcctRes[i];
    }

    public void setCardAcctRes(int i, com.rssl.phizic.test.webgate.esberib.generated.CardAcctRes_Type _value) {

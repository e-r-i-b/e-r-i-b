/**
 * OobEmailManagementRequest.java
 *
 ...
 */
public class OobEmailManagementRequest  implements java.io.Serializable {
    ...
    private com.rssl.phizic.test.webgate.rsa.integration.ws.control.generated.EmailManagementRequestPayload payload;

    public OobEmailManagementRequest() {
    }
    ...
    public OobEmailManagementRequest(
           ...
           com.rssl.phizic.test.webgate.rsa.integration.ws.control.generated.EmailManagementRequestPayload payload) {
    ...
    /**
     * Gets the credentialProvisioningStatus value for this OobEmailManagementRequest.
     * 
    ...
    /**
     * Sets the credentialProvisioningStatus value for this OobEmailManagementRequest.
     * 
    ...
    /**
     * Gets the payload value for this OobEmailManagementRequest.
     * 
     * @return payload
     */
    public com.rssl.phizic.test.webgate.rsa.integration.ws.control.generated.EmailManagementRequestPayload getPayload() {
        return payload;
    }


    /**
     * Sets the payload value for this OobEmailManagementRequest.
     * 
     * @param payload
     */
    public void setPayload(com.rssl.phizic.test.webgate.rsa.integration.ws.control.generated.EmailManagementRequestPayload payload) {
        this.payload = payload;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OobEmailManagementRequest)) return false;
        OobEmailManagementRequest other = (OobEmailManagementRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OobEmailManagementRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.csd.rsa.com", "OobEmailManagementRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ws.csd.rsa.com", "EmailManagementRequestPayload"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

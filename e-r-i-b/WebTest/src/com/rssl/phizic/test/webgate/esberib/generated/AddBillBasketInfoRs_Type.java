...
/**
 * Тип сообщения-ответа для интерфейса "Передача информации о задолженности
 * клиента"
 */
public class AddBillBasketInfoRs_Type  implements java.io.Serializable {
     ...
     * SPName из запроса AddBillBasketInfoRq */
    private java.lang.String systemId;

    /* Результат выполнения запроса */
    private com.rssl.phizic.test.webgate.esberib.generated.Status_Type status;

    private com.rssl.phizic.test.webgate.esberib.generated.PaymentStatusInfoList_Type[] payment;

    public AddBillBasketInfoRs_Type() {
    }
    ...
    public AddBillBasketInfoRs_Type(
           ...
           com.rssl.phizic.test.webgate.esberib.generated.PaymentStatusInfoList_Type[] payment) {
           this.rqUID = rqUID;
           this.rqTm = rqTm;
    ...
    /**
     * Gets the rqUID value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Sets the rqUID value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Gets the rqTm value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Sets the rqTm value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Gets the operUID value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Sets the operUID value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Gets the SPName value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Sets the SPName value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Gets the systemId value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Sets the systemId value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Gets the status value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Sets the status value for this AddBillBasketInfoRs_Type.
     * 
    ...
    /**
     * Gets the payment value for this AddBillBasketInfoRs_Type.
     * 
     * @return payment
     */
    public com.rssl.phizic.test.webgate.esberib.generated.PaymentStatusInfoList_Type[] getPayment() {
        return payment;
    }


    /**
     * Sets the payment value for this AddBillBasketInfoRs_Type.
     * 
     * @param payment
     */
    public void setPayment(com.rssl.phizic.test.webgate.esberib.generated.PaymentStatusInfoList_Type[] payment) {
        this.payment = payment;
    }

    public com.rssl.phizic.test.webgate.esberib.generated.PaymentStatusInfoList_Type getPayment(int i) {
        return this.payment[i];
    }

    public void setPayment(int i, com.rssl.phizic.test.webgate.esberib.generated.PaymentStatusInfoList_Type _value) {
        this.payment[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AddBillBasketInfoRs_Type)) return false;
        AddBillBasketInfoRs_Type other = (AddBillBasketInfoRs_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddBillBasketInfoRs_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "AddBillBasketInfoRs_Type"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "PaymentStatusInfoList_Type"));
        elemField.setNillable(false);

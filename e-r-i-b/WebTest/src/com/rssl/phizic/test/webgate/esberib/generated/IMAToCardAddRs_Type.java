...
/**
 * Тип ответа для интерфейса SrvIMAToCardAdd (TIC). Продажа обезличенного
 * металла с зачислением денежных средств на МБК того же клиента. Операция
 * ОМС-Карта
 */
public class IMAToCardAddRs_Type  implements java.io.Serializable {
    ...
    /**
     * Gets the rqUID value for this IMAToCardAddRs_Type.
     * 
     * @return rqUID
     */
    ...
    /**
     * Sets the rqUID value for this IMAToCardAddRs_Type.
     * 
     * @param rqUID
     */
    ...
    /**
     * Gets the rqTm value for this IMAToCardAddRs_Type.
     * 
     * @return rqTm
     */
    ...
    /**
     * Sets the rqTm value for this IMAToCardAddRs_Type.
     * 
     * @param rqTm
     */
    ...
    /**
     * Gets the operUID value for this IMAToCardAddRs_Type.
     * 
     * @return operUID
     */
    ...
    /**
     * Sets the operUID value for this IMAToCardAddRs_Type.
     * 
     * @param operUID
     */
    ...
    /**
     * Gets the status value for this IMAToCardAddRs_Type.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this IMAToCardAddRs_Type.
     * 
     * @param status
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IMAToCardAddRs_Type)) return false;
        IMAToCardAddRs_Type other = (IMAToCardAddRs_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IMAToCardAddRs_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "IMAToCardAddRs_Type"));

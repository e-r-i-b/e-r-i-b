...
public class GetAutoPaymentDetailInfoRq_Type  implements java.io.Serializable {
    ...
    public com.rssl.phizic.test.webgate.esberib.generated.AutoPaymentId_Type getAutoPaymentId(int i) {
        return this.autoPaymentId[i];
    }

    public void setAutoPaymentId(int i, com.rssl.phizic.test.webgate.esberib.generated.AutoPaymentId_Type _value) {

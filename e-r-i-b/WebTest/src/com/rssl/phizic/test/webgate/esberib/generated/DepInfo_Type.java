...
public class DepInfo_Type  implements java.io.Serializable {
    ...
    private com.rssl.phizic.test.webgate.esberib.generated.IntRate_Type earlyTermRate;
    ...
    public DepInfo_Type(
           ...
           com.rssl.phizic.test.webgate.esberib.generated.IntRate_Type earlyTermRate,
     ...
     * Значение обязательно заполняется для операций с закрытием вкладов
     */
    public com.rssl.phizic.test.webgate.esberib.generated.IntRate_Type getEarlyTermRate() {
     ...
     * Значение обязательно заполняется для операций с закрытием вкладов
     */
    public void setEarlyTermRate(com.rssl.phizic.test.webgate.esberib.generated.IntRate_Type earlyTermRate) {
        this.earlyTermRate = earlyTermRate;
    }

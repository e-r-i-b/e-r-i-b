...
/**
 * Тип ответа для интерфейса SrvCardToIMAAdd (TCI). Покупка обезличенного
 * металла за счет денежных средств на МБК того же клиента. Операция
 * Карта-ОМС
 */
public class CardToIMAAddRs_Type  implements java.io.Serializable {
    ...
    /**
     * Gets the rqUID value for this CardToIMAAddRs_Type.
     * 
     * @return rqUID
     */
    ...
    /**
     * Sets the rqUID value for this CardToIMAAddRs_Type.
     * 
     * @param rqUID
     */
    ...
    /**
     * Gets the rqTm value for this CardToIMAAddRs_Type.
     * 
     * @return rqTm
     */
    ...
    /**
     * Sets the rqTm value for this CardToIMAAddRs_Type.
     * 
     * @param rqTm
     */
    ...
    /**
     * Gets the operUID value for this CardToIMAAddRs_Type.
     * 
     * @return operUID
     */
    ...
    /**
     * Sets the operUID value for this CardToIMAAddRs_Type.
     * 
     * @param operUID
     */
    ...
    /**
     * Gets the status value for this CardToIMAAddRs_Type.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this CardToIMAAddRs_Type.
     * 
     * @param status
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CardToIMAAddRs_Type)) return false;
        CardToIMAAddRs_Type other = (CardToIMAAddRs_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CardToIMAAddRs_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "CardToIMAAddRs_Type"));

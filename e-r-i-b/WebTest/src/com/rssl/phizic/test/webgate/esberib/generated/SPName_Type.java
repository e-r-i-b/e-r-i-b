...
public class SPName_Type implements java.io.Serializable {
    ...
    public static final java.lang.String _BP_BS = "BP_BS";
    public static final java.lang.String _BP_INFOBANK = "BP_INFOBANK";
	public static final java.lang.String _AUTOPAY = "urn:sbrfsystems:99-autopay";
	public static final java.lang.String _CRM = "urn:sbrfsystems:99-crm";
	public static final java.lang.String _WAY = "urn:sbrfsystem:99-way";
    ...
    public static final SPName_Type BP_BS = new SPName_Type(_BP_BS);
    public static final SPName_Type BP_INFOBANK = new SPName_Type(_BP_INFOBANK);
	public static final SPName_Type AUTOPAY = new SPName_Type(_AUTOPAY);
	public static final SPName_Type CRM = new SPName_Type(_CRM);
	public static final SPName_Type WAY = new SPName_Type(_WAY);

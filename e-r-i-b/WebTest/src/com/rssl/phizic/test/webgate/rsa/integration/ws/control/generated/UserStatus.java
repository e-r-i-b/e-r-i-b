...
public class UserStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _NOTENROLLED = "NOTENROLLED";
    ...
    public static final UserStatus NOTENROLLED = new UserStatus(_NOTENROLLED);
    public static final UserStatus UNVERIFIED = new UserStatus(_UNVERIFIED);
    public static final UserStatus VERIFIED = new UserStatus(_VERIFIED);
    public static final UserStatus DELETE = new UserStatus(_DELETE);
    public static final UserStatus LOCKOUT = new UserStatus(_LOCKOUT);
    public static final UserStatus UNLOCKED = new UserStatus(_UNLOCKED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.csd.rsa.com", "UserStatus"));
    }
    /**

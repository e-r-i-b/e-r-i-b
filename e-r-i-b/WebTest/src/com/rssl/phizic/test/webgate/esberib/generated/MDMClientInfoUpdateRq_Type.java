...
public class MDMClientInfoUpdateRq_Type  implements java.io.Serializable {
    ...
    /* Информация о пользователе, осуществившим изменения */
    private com.rssl.phizic.test.webgate.esberib.generated.UserInfo_Type userInfo;
    ...
    public MDMClientInfoUpdateRq_Type(
           ...
           com.rssl.phizic.test.webgate.esberib.generated.UserInfo_Type userInfo) {
           this.rqUID = rqUID;
           this.rqTm = rqTm;
    ...
    /**
     * Gets the userInfo value for this MDMClientInfoUpdateRq_Type.
     * 
     * @return userInfo   * Информация о пользователе, осуществившим изменения
     */
    public com.rssl.phizic.test.webgate.esberib.generated.UserInfo_Type getUserInfo() {
        return userInfo;
    }


    /**
     * Sets the userInfo value for this MDMClientInfoUpdateRq_Type.
     * 
     * @param userInfo   * Информация о пользователе, осуществившим изменения
     */
    public void setUserInfo(com.rssl.phizic.test.webgate.esberib.generated.UserInfo_Type userInfo) {
        this.userInfo = userInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "MDMClientInfoUpdateRq_Type"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "UserInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://sbrf.ru/baseproduct/erib/adapter/1", "UserInfo_Type"));

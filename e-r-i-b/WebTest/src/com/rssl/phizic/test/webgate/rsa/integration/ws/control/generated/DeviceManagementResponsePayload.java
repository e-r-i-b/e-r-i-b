...
public class DeviceManagementResponsePayload  implements java.io.Serializable {
    ...
    public com.rssl.phizic.test.webgate.rsa.integration.ws.control.generated.DeviceData getDeviceData(int i) {
        return this.deviceData[i];
    }

    public void setDeviceData(int i, com.rssl.phizic.test.webgate.rsa.integration.ws.control.generated.DeviceData _value) {

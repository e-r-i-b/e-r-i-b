 ...
 * За дополнительной информацией GOTO http://www.javaexchange.com
 *
 * @author Kidyaev
 * @ created 26.07.2006
 * @ $Author$
...
public class RandomGUID
{
	...
	{
		String raw = getStringValue().toUpperCase();
	...
	public UUID toUUID()
	{
		return UUID.fromValue(getStringValue());
	}

	/**
	 * @return значение guid в виде массива байт.
	 */

...
public class ResidentBank_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns1_our_QNAME = new QName("", "our");
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank instance = new com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank();
        com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_BIC_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank_SOAPBuilder();
                    }
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_our_QNAME)) {
                member = ns4_myns4__boolean__java_lang_Boolean_Boolean_Serializer.deserialize(ns1_our_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myOUR_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setOur((java.lang.Boolean)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_place_QNAME)) {
                member = ns2_myns2_string__java_lang_String_String_Serializer.deserialize(ns1_place_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank instance = (com.rssl.phizicgate.wsgateclient.services.dictionary.generated.ResidentBank)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns4_myns4__boolean__java_lang_Boolean_Boolean_Serializer.serialize(instance.getOur(), ns1_our_QNAME, null, writer, context);
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getPlace(), ns1_place_QNAME, null, writer, context);

...
public class CommissionOptions_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgateclient.services.documents.update.generated.CommissionOptions instance = new com.rssl.phizicgate.wsgateclient.services.documents.update.generated.CommissionOptions();
        com.rssl.phizicgate.wsgateclient.services.documents.update.generated.CommissionOptions_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_account_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgateclient.services.documents.update.generated.CommissionOptions_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_target_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_target_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgateclient.services.documents.update.generated.CommissionOptions_SOAPBuilder();
                    }
                    ...
                    instance.setTarget((java.lang.String)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgateclient.services.documents.update.generated.CommissionOptions instance = (com.rssl.phizicgate.wsgateclient.services.documents.update.generated.CommissionOptions)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getTarget(), ns1_target_QNAME, null, writer, context);
    }
}

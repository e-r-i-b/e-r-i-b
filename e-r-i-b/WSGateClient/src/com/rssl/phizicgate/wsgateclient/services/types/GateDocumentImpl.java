...
public class GateDocumentImpl implements GateDocument, SynchronizableDocument, EditDocument, WithdrawDocument, CardBlockingClaim, LoanOpeningClaim, AccountClosingClaim, LossPassbookApplicationClaim,
		...
		AccountIntraBankPayment, InternalCardsTransfer, ExternalCardsTransferToOtherBank, ExternalCardsTransferToOurBank, AccountToCardTransfer, CardToAccountTransfer, CardJurIntraBankTransferLongOffer, LoanTransferLongOffer, AutoPayment, PossibleAddingOperationUIDObject, InvoiceAcceptPayment
{
	private Long id;

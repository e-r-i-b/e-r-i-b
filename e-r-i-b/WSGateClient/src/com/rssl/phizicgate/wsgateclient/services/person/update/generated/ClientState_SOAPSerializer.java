...
public class ClientState_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgateclient.services.person.update.generated.ClientState instance = new com.rssl.phizicgate.wsgateclient.services.person.update.generated.ClientState();
        com.rssl.phizicgate.wsgateclient.services.person.update.generated.ClientState_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_category_QNAME)) {
                member = ns2_myns2_string__java_lang_String_String_Serializer.deserialize(ns1_category_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgateclient.services.person.update.generated.ClientState_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgateclient.services.person.update.generated.ClientState instance = (com.rssl.phizicgate.wsgateclient.services.person.update.generated.ClientState)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getCategory(), ns1_category_QNAME, null, writer, context);

...
public class BackRefBankrollService_PortType_getStoredCard_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public BackRefBankrollService_PortType_getStoredCard_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgateclient.services.bankroll.generated.BackRefBankrollService_PortType_getStoredCard_RequestStruct instance = new com.rssl.phizicgate.wsgateclient.services.bankroll.generated.BackRefBankrollService_PortType_getStoredCard_RequestStruct();
        com.rssl.phizicgate.wsgateclient.services.bankroll.generated.BackRefBankrollService_PortType_getStoredCard_RequestStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<2; i++) {
            ...
            if (elementName.equals(ns1_Long_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgateclient.services.bankroll.generated.BackRefBankrollService_PortType_getStoredCard_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgateclient.services.bankroll.generated.BackRefBankrollService_PortType_getStoredCard_RequestStruct instance = (com.rssl.phizicgate.wsgateclient.services.bankroll.generated.BackRefBankrollService_PortType_getStoredCard_RequestStruct)obj;

 ...
 * @ $Revision$
 */
public class SofiaMessageGenerator extends MessageGenerator
{
	public MessageData buildMessage(Document document, MessageInfo info, MessageHead messageHead) throws GateException
	{
		try
		{
			...
			writeText(serializer, Constants.ABONENT_ESK);
			...
			SofiaMessageData messageData = new SofiaMessageData(text);

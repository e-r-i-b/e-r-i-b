...
public class WebBankServiceIF_Stub
		...
		implements com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.WebBankServiceIF
{
	...
	public WebBankServiceIF_Stub(HandlerChain handlerChain)
	{
		...
		_setProperty(ENDPOINT_ADDRESS_PROPERTY, connectionConfig.getURL());
	}
			...
			throws java.rmi.RemoteException
	{
		...
		try
		{
			...
			com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.SendMessage _mySendMessage = new com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.SendMessage();
			...
			com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.SendMessageResponse _result = null;
			java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
			if (_responseObj instanceof SOAPDeserializationState)
			{
				_result = (com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.SendMessageResponse) ((SOAPDeserializationState) _responseObj).getInstance();
			}
			else
			{
				_result = (com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.SendMessageResponse) _responseObj;
			}
	...
	public void _initialize(InternalTypeMappingRegistry registry) throws Exception
	{
		...
		ns1_mySendMessage_LiteralSerializer = (CombinedSerializer) registry.getSerializer("", com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.SendMessage.class, ns1_sendMessage_TYPE_QNAME);
		ns1_mySendMessageResponse_LiteralSerializer = (CombinedSerializer) registry.getSerializer("", com.rssl.phizicgate.sofia.messaging.jaxrpc.generated.SendMessageResponse.class, ns1_sendMessageResponse_TYPE_QNAME);
	}

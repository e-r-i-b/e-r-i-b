 ...
 * @ $Revision$
 */
public class ExecuteBillPaymentQHandler implements MockQHandler
{
	public Document makeRequest(MessageData messageData, MessageInfo messageInfo) throws Exception
	{
		return XmlHelper.loadDocumentFromResource("com/rssl/phizicgate/sofia/messaging/mock/xml/executeBillingPaymentA.xml");
	}
}

...
public class SofiaDocumentSender extends AbstractDocumentSender
{
	...
	private static final String PAYMENT_TYPE_ERROR = "Неверный тип платежа - ожидается PaymentSystemPayment";
	private static final int MAX_COUNT_TRANSACTIONS = 20; //максимальное количество прверок при получении комиссии

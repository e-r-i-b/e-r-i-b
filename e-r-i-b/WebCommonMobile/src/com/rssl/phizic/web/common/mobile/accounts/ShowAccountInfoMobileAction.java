...
public class ShowAccountInfoMobileAction extends ShowAccountInfoAction
{
    ...
    public ActionForward start(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        if (checkAccess(MoneyBoxListOperation.class, "MoneyBoxManagement")) {
            MoneyBoxListOperation moneyBoxOperation = createOperation("MoneyBoxListOperation","MoneyBoxManagement");
            AccountLink accountLink = PersonContext.getPersonDataProvider().getPersonData().getAccount(frm.getId());
            moneyBoxOperation.initialize(accountLink);
            frm.setMoneyBoxes(moneyBoxOperation.getData());
	    }

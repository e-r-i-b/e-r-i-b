package com.rssl.phizic.web.common.mobile.version;
...
public class VersionControlAction extends OperationalActionBase
{
	...
	public ActionForward start(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			Long minDeviceVersion = platform.getVersion();

			if (frm.getAppVersion() < minDeviceVersion)
			{
				String deviceText = platform.getErrorText();
				throw new BusinessLogicException(deviceText);
			}
		}

package com.rssl.phizic.web.common.mobile.devicecheck;
...
public class DeviceCheckAction extends OperationalActionBase
{
    ...
    public ActionForward start(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        if(jailbreakEnabled)
        {
	        String jailbreakEnabledText = MultiLocaleContext.isDefaultLocale()?mobileApiConfig.getJailbreakEnabledText():mobileApiConfig.getJailbreakEnabledText(MultiLocaleContext.getLocaleId());
	        if (StringHelper.isNotEmpty(jailbreakEnabledText))
		        saveMessage(request, jailbreakEnabledText);
        }
        else
        {
            String jailbreakDisabledText = MultiLocaleContext.isDefaultLocale()?mobileApiConfig.getJailbreakDisabledText():mobileApiConfig.getJailbreakDisabledText(MultiLocaleContext.getLocaleId());

...
public class ChooseNotificationTypeForm extends EditFormBase
{
	...
	public static final Form EDIT_LOGIN_CONFIRM_SETTINGS_FORM = createLoginConfirmSettingsForm();
	public static final Form EDIT_OPERATION_CONFIRM_SETTINGS_FORM = createOperationConfirmSettingsForm();
	...
	// форма для настроек канала для подтверждения входа
	private static Form createLoginConfirmSettingsForm()
	{
		FormBuilder formBuilder = new FormBuilder();
		FieldBuilder fb;
	...
	// форма для настроек канала для подтверждения операций
	private static Form createOperationConfirmSettingsForm()
	{
		FormBuilder formBuilder = new FormBuilder();
		FieldBuilder fb;

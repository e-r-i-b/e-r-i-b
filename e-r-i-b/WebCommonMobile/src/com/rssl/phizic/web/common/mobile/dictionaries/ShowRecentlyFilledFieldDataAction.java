...
public class ShowRecentlyFilledFieldDataAction extends OperationalActionBase
{
	public ActionForward start(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
        ...
        ShowRecentlyFilledFieldDataOperation operation = null;
        ...
        if (PermissionUtil.impliesOperation("ShowRecentlyFilledFieldDataOperation", "SelfRecentlyFilledFieldDataManagement")

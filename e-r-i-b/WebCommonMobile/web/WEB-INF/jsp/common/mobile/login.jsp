...
<tiles:insert definition="iphone" flush="false">
    <tiles:put name="data"> 
        ...
        <c:set var="isLightSchemeERIB" value="${mobile:isLightSchemeAuthContext()}"/>
        <c:if test="${not empty isLightSchemeERIB}">
            <isLightSchemeERIB>${isLightSchemeERIB}</isLightSchemeERIB>
        </c:if>
    </tiles:put>

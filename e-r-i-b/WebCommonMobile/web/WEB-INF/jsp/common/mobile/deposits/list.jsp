                                ...
                                <deposit>
                                    ...
                                    <conditionsList>
                                        <c:forEach items="${depositEntity.depositDescriptions}" var="row" varStatus="rowNum">
                                            <condition>
                                                <minimumBalance><fmt:formatNumber value="${row.sumBegin}" pattern="0.00"/></minimumBalance>
                                                <currency>
                                                ...
                                                <interestRate>
                                                    <from><fmt:formatNumber value="${row.minRate}" pattern="0.00"/></from>
                                                    <c:if test="${row.minRate != row.maxRate}">
                                                        <to><fmt:formatNumber value="${row.maxRate}" pattern="0.00"/></to>
                                                    </c:if>
                                                </interestRate>
                                            </condition>
                                        </c:forEach>

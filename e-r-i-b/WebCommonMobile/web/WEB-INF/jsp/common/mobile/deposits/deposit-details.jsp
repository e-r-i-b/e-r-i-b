                                                ...
                                                <c:forEach items="${balanceRatesEntry.value}" var="periodRatesEntry">
                                                    <c:if test="${periodRatesEntry.key == period}">
                                                            <condition>
                                                                ...
                                                                <amountOf><fmt:formatNumber value="${balanceRatesEntry.key}" pattern="0.00"/></amountOf>
                                                                <period>
                                                                ...
                                                                <interestRate><fmt:formatNumber value="${periodRatesEntry.value[0].baseRate}" pattern="0.00"/></interestRate>
                                                            </condition>
                                                    </c:if>
                                                </c:forEach>
                                            </c:forEach>
                        ...
                        <minAditionalFee>
                            <c:forEach items="${form.minAdditionalFee}" var="minAdditionalFeeValue">
                                <currencyList>
                                    ...
                                    <amount><fmt:formatNumber value="${minAdditionalFeeValue.value}" pattern="0.00"/></amount>
                                </currencyList>
                            </c:forEach>
                        </minAditionalFee>
                    </c:if>

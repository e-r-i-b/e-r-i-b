        ...
        <tiles:put name="data">
            <sl:collection id="listElement" property="data" model="xml-list" title="operations">
                <sl:collectionItem title="operation">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${not empty businessDocument}">
                                    <c:choose>
                                        ...
                                        <%--Для формы оплаты услуг "RurPayJurSB" поле ground заполняется только для случаев быстрой оплаты
                                            услуг сотовой связи--%>
                    ...
                    <invoiceReminderSupported>${supportedActions['isTemplateSupported'] && phiz:impliesService('ReminderManagment')}</invoiceReminderSupported>

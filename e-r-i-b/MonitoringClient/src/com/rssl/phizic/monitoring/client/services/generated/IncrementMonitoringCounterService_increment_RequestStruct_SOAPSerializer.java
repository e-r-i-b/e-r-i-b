...
public class IncrementMonitoringCounterService_increment_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public IncrementMonitoringCounterService_increment_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_increment_RequestStruct instance = new com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_increment_RequestStruct();
        com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_increment_RequestStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<2; i++) {
            ...
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_increment_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_increment_RequestStruct instance = (com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_increment_RequestStruct)obj;

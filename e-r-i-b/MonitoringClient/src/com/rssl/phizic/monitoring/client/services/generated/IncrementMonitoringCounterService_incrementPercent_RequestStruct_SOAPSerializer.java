...
public class IncrementMonitoringCounterService_incrementPercent_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public IncrementMonitoringCounterService_incrementPercent_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_incrementPercent_RequestStruct instance = new com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_incrementPercent_RequestStruct();
        com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_incrementPercent_RequestStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<3; i++) {
            ...
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_incrementPercent_RequestStruct_SOAPBuilder();
                    }
            ...
            if (elementName.equals(ns1_boolean_3_QNAME)) {
                member = ns2_myns2__boolean__boolean_Boolean_Serializer.deserialize(ns1_boolean_3_QNAME, reader, context);
                instance.setBoolean_3(((Boolean)member).booleanValue());
                reader.nextElementContent();
                continue;
            } else {
                throw new DeserializationException("soap.unexpectedElementName", new Object[] {ns1_boolean_3_QNAME, elementName});
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_incrementPercent_RequestStruct instance = (com.rssl.phizic.monitoring.client.services.generated.IncrementMonitoringCounterService_incrementPercent_RequestStruct)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns2_myns2__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isBoolean_3()), ns1_boolean_3_QNAME, null, writer, context);
    }
}

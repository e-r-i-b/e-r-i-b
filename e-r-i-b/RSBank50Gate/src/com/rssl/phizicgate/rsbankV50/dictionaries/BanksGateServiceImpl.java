...
public class BanksGateServiceImpl extends AbstractService implements BanksGateService
{
	...
	public List<Bank> getAll(final int firstResult, final int maxResults) throws GateException, GateLogicException
	{
		try
		{
			...
			return RSBankV50HibernateExecutor.getInstance().execute(new HibernateAction<List<Bank>>()
			   {
	...
	public	List<Bank> getAll(final Bank template, final int firstResult, final int listLimit) throws GateException
	{
		try
		{

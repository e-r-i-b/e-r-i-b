...
public class TaskWebService_ServiceLocator extends org.apache.axis.client.Service implements com.rssl.phizic.ermb.migration.list.service.generated.TaskWebService_Service {
    ...
    public com.rssl.phizic.ermb.migration.list.service.generated.TaskWebService_PortType getTaskWebServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.rssl.phizic.ermb.migration.list.service.generated.TaskWebService_PortType getTaskWebServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.rssl.phizic.ermb.migration.list.service.generated.TaskWebServiceBindingStub _stub = new com.rssl.phizic.ermb.migration.list.service.generated.TaskWebServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.rssl.phizic.ermb.migration.list.service.generated.TaskWebService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.rssl.phizic.ermb.migration.list.service.generated.TaskWebServiceBindingStub _stub = new com.rssl.phizic.ermb.migration.list.service.generated.TaskWebServiceBindingStub(new java.net.URL(TaskWebServicePort_address), this);
                _stub.setPortName(getTaskWebServicePortWSDDServiceName());
                return _stub;
            }
        }

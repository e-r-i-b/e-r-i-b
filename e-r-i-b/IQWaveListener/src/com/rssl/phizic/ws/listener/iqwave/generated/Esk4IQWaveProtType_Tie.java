...
public class Esk4IQWaveProtType_Tie
    extends com.sun.xml.rpc.server.TieBase implements SerializerConstants {
    
    
    
    public Esk4IQWaveProtType_Tie() throws Exception {
        super(new com.rssl.phizic.ws.listener.iqwave.generated.Esk4IQWaveService_SerializerRegistry().getRegistry());
    ...
    private void invoke_getXMLmessage(StreamingHandlerState state) throws Exception {
        ...
        try {
            java.lang.String response = ((com.rssl.phizic.ws.listener.iqwave.generated.Esk4IQWaveProtType) getTarget()).getXMLmessage(myString);
            ...
            case getXMLmessage_OPCODE:
                {
                    ...
                    theMethod = (com.rssl.phizic.ws.listener.iqwave.generated.Esk4IQWaveProtType.class).getMethod("getXMLmessage", carray);
                }
                break;
    ...
    private static final javax.xml.namespace.QName portName = new QName("http://www.sbrf.ru/sbol/esk", "Esk4IQWave");

...
public class CurrencyType implements java.io.Serializable {
    ...
    public static final CurrencyType RUB = new CurrencyType(_RUB);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://generated.shop.webgate.test.phizic.rssl.com", "CurrencyType"));
    }
    /**

 ...
 * @ $Revision$
 */
//TODO Перенести всю "низкоуовневую" работу со счетами из BankrollServiceImpl 
public class AccountService
{
	...
	public AccountImpl getAccount(final Long id) throws GateException
	{
	    try
	    {
	        AccountImpl account = GateRSV55Executor.getInstance().execute(new HibernateAction<AccountImpl>()
	        {

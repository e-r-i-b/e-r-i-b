...
public class PaymentDemand extends PaymentDemandBase
{
	...
	*/
	...
	/**
    * @return transferLink  Ссылка на список безнал зачисления  (соответствует pstrans.AutoKey)
    */
	...
	/**
    * @param transferLink Ссылка на список безнал зачисления (соответствует pstrans.AutoKey)
    */

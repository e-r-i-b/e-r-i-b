...
public class EditEmailForm extends EditFormBase
{
	...
	private static Form createForm()
	{
		...
		fieldBuilder.addValidators(new RegexpFieldValidator(".{0,30}", "E-mail должен содержать не более 30 символов"),
				new RegexpFieldValidator("^[\\.\\-_A-Za-z0-9]+?@[\\.\\-A-Za-z0-9]+?\\.[A-Za-z0-9]{2,6}$", "Неверно введен e-mail."));

 ...
 */
@Deprecated
//todo CHG059734 перенести из WebCommonMobile в архив
public class ListMobileBankTemplatesAction extends OperationalActionBase
{
			...
			throws BusinessException, BusinessLogicException
	{
		ListMobilePaymentTemplatesOperation operation
				= createOperation(ListMobilePaymentTemplatesOperation.class,"MobileBank");
	...
	) throws BusinessException, BusinessLogicException
	{
	    ...
	    ListMobileBankTemplatesForm form = (ListMobileBankTemplatesForm) frm;

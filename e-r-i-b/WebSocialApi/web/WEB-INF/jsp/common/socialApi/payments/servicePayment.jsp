                    ...
                    <fields>
                        ...
                        <c:forEach var="field" items="${provider.fieldDescriptions}">
                            ...
                            <c:if test="${empty defaultValue}">
                                <c:set var="defaultValue" value="${phiz:getDefaultValueProviderField(provider, field.externalId)}"/>
                            ...
                            <c:if test="${isDictField}">
                                ...
                                <c:if test="${dictFieldId == null && isProviderDefaultValue}">
                                    ...
                                    <c:set var="defaultValue" value="${((dictField != null) && phiz:isRequireMasking()) ? phiz:getCutPhoneNumber(defaultValue) : defaultValue}"/>
                                    <c:set var="dictFieldId" value="${dictField != null ? dictField.id : null}"/>
                                </c:if>

...
/**
 * Сообщение для передачи СМС клиенту с проверкой IMSI
 * Маршрут сообщения: ЕРИБ -> СОС
 */
@PlainOldJavaObject
@SuppressWarnings("JavaDoc")
@XmlType(name = "SendSMSWithIMSIRqType")
@XmlRootElement(name = "SendSMSWithIMSIRq")
@XmlAccessorType(XmlAccessType.NONE)
public class SendSmsWithImsiRequest
{
	/**
	 * Тип сообщения
	 */
	public static final String TYPENAME = "SendSMSWithIMSIRq";

 ...
 * @ $Revision$
 *
 * Процессор запроса на получение списка входящих писем.
 */
public class IncomeMailListProcessor extends MultiNodeProcessorBase
{
	private static final String QUERY_NAME = "com.rssl.phizic.operations.mail.ListMailOperation.list";

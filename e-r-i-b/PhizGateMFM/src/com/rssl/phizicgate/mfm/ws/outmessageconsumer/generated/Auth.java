...
public class Auth  implements java.io.Serializable {
    ...
    /**
     * Gets the login value for this Auth.
     * 
     * @return login
     */
    ...
    /**
     * Sets the login value for this Auth.
     * 
     * @param login
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.mfms.ru/sb/ifm/sms/sb0/out-message-consumer", "Auth"));

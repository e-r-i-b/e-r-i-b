...
*/
	...
	/
    CREATE SEQUENCE  S_CONVERTER_LOGINS INCREMENT BY 1 START WITH 10000 MAXVALUE 999999999999 MINVALUE 10000 NOCYCLE 
	/	
    ...
    CREATE TABLE CONVERTER_ACCESSSCHEMES ( 
                            "ID"							NUMBER(15) NOT NULL,
							"ID_SCHEME_SBOL"        		VARCHAR2(32) NULL,
	...
	/
	insert into CONVERTER_ACCESSSCHEMES	select S_CONVERTER_SET.NEXTVAL, ROLE_ID, DESCR, '0' 
	from ( select distinct(ROLE) as ROLE_ID, T_USER_ROLE_ROLE_NAME||' ('||T_USER_ROLE_ROLE_DESCR||')' as DESCR from V_EMPLOYEES@psiLink where TB in ('009','018','074')	)
	/
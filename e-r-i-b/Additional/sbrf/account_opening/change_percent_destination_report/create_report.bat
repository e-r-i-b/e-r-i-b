...
set SCRIPT_HOME="c:\Work\v.1.18\Additional\sbrf\account_opening\change_percent_destination_report"

:: Куда сохранять файл отчета
SET OUTPUT_PATH="c:\Work\v.1.18\Additional\sbrf\account_opening\change_percent_destination_report"

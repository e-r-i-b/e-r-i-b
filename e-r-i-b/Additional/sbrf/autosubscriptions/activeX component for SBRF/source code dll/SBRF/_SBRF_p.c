...
/* Object interface: IServer, ver. 0.0,
   GUID={0x5537E0C6,0x5683,0x49C0,{0xA9,0x58,0x61,0x9E,0xFF,0x13,0x01,0xE6}} */
...
static const MIDL_SERVER_INFO IServer_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(11) _IServerProxyVtbl = 
{
    &IServer_ProxyInfo,
    &IID_IServer,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IServer::NFun */ ,
    (void *) (INT_PTR) -1 /* IServer::GParamString */ ,
    (void *) (INT_PTR) -1 /* IServer::SÐaram */ ,
    (void *) (INT_PTR) -1 /* IServer::Clear */
};
...
const CInterfaceProxyVtbl * __SBRF_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * __SBRF_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IServerStubVtbl,
    0
...
PCInterfaceName const __SBRF_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "IServer",
    0
...
#define __SBRF_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __SBRF, pIID, n)

int __stdcall __SBRF_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( __SBRF, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( __SBRF, 2, *pIndex )
    
}

const ExtendedProxyFileInfo _SBRF_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __SBRF_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __SBRF_StubVtblList,
    (const PCInterfaceName * ) & __SBRF_InterfaceNamesList,
    (const IID ** ) & __SBRF_BaseIIDList,
    & __SBRF_IID_Lookup, 
    2,
    2,

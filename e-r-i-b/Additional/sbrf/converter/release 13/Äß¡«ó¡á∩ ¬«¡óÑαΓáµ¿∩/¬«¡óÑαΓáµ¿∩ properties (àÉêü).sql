...
--Номер ревизии: 59376(ПСИ) был изменен тип признака «Проверка кратности суммы в PRO–зоне».
update PROPERTIES set PROPERTY_VALUE = 'true' where PROPERTY_KEY like ('com.rssl.iccs.use.template.factor.in.full.mapi|%') and PROPERTY_VALUE = 'on'
/

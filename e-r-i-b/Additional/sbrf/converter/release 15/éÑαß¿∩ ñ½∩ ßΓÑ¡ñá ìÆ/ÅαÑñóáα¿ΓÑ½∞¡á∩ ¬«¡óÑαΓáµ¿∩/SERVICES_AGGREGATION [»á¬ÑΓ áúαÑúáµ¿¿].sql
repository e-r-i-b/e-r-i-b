...
create or replace package body SERVICES_AGGREGATION is
  ...
  begin
	...
	update PROPERTIES set PROPERTY_VALUE = 3-to_number(PROPERTY_VALUE) where PROPERTY_KEY='com.rssl.iccs.phizic.catalog.aggreagation.current.partition' and CATEGORY='phiz' 
    ...
    from (
      ...
      --unpivot exclude nulls (AVAILABLE_VAL for AVAILABLE in ("AVAILABLE_PAYMENTS" as 'PAYMENTS', "AVAILABLE_ESB_AUTOP" as 'ESB_AUTOPAYMENTS', "AVAILABLE_IQW_AUTOP" as 'IQW_AUTOPAYMENTS', "AVAILABLE_TEMPLATES" as 'TEMPLATES', "AVAILABLE_MB_TEMPLATES" as 'MB_TEMPLATES', "AVAILABLE_BASKET" as 'BASKET'))
    );

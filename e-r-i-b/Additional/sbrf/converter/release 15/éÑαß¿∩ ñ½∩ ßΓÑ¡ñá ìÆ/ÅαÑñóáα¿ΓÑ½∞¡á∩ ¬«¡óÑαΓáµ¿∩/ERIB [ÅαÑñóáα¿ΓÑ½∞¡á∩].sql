...
create table SRB_IKFL.BKI_ACCOUNT_PAYMENT_STATUS 
(
   CODE                 varchar2(2)          not null,
   NAME                 varchar2(60)         not null,
...
(
   ...
   ESB_CODE             varchar2(22),
   IS_DEFAULT           CHAR(1)              not null,
   constraint PK_BKI_PRIMARY_ID_TYPE primary key (CODE) using index (
	create unique index SRB_IKFL.PK_BKI_PRIMARY_ID_TYPE on SRB_IKFL.BKI_PRIMARY_ID_TYPE ( CODE ) tablespace INDX
   ),

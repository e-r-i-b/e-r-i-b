...
create table PROFILE tablespace USERS nologging as
...
alter table SRB_IKFL.PROFILE add constraint PK_PROFILE primary key (ID) using index SRB_IKFL.PK_PROFILE enable novalidate;

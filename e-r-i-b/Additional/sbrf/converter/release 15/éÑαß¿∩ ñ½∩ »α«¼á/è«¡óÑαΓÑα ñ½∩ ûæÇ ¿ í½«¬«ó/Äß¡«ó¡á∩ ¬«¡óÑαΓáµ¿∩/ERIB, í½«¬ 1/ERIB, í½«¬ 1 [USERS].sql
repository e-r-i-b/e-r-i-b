...
create table USERS tablespace USERS nologging as
...
alter table SRB_IKFL.USERS add constraint PK_USERS primary key (ID) using index SRB_IKFL.PK_USERS enable novalidate;

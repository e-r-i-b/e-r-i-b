...
create table SRB_IKFL.ACCOUNT_LINKS tablespace USERS nologging as 
...
create unique index PSRB_IKFL.PK_ACCOUNT_LINKS on SRB_IKFL.ACCOUNT_LINKS (ID)  parallel 32 tablespace INDX;

alter table SRB_IKFL.ACCOUNT_LINKS add constraint PK_ACCOUNT_LINKS primary key (ID) using index PSRB_IKFL.PK_ACCOUNT_LINKS enable novalidate;

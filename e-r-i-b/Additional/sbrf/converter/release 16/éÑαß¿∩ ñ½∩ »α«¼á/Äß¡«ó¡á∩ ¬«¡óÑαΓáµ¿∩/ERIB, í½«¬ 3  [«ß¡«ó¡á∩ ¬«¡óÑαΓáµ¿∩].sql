...
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages72', '/mobile5*', 'phiz')
/
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages73', '/mobile6*', 'phiz')
/
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages74', '/mobile7/checkPassword.do', 'phiz')
/
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages75', '/mobile7/private/graphics/finance.do', 'phiz')
/
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages76', '/mobile7/private/permissions.do', 'phiz')
/
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values  ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages77', '/mobile7/private/rates/list.do', 'phiz')
/
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values  ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages78', '/mobile7/private/profile/loyaltyURL.do', 'phiz')
/
insert into SRB_IKFL3.PROPERTIES (ID, PROPERTY_KEY, PROPERTY_VALUE, CATEGORY) 
	values  ( SRB_IKFL3.S_PROPERTIES.nextval, 'com.rssl.phizic.logging.messagesLog.excluded.messages79', '/mobile7/version/control.do', 'phiz')
/

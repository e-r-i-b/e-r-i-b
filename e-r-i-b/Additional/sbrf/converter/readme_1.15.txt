Конвертер предназанчен для приведения структуры и содержания БД с верси 1.15 к 1.16 (по состоянию на 16.09.2009)
Пордок действий:
1. Настроить систему на БД версии 1.15
2. Положить файл converter-v1_15.sql в папку AntBuilds\db-data

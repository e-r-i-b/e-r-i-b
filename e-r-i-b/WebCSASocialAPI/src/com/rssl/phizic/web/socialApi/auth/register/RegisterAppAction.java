...
import com.rssl.auth.csasocial.operations.ConfirmRegistrationOperation;
import com.rssl.auth.csasocial.operations.FinishRegistrationOperation;
import com.rssl.auth.csasocial.operations.ShowCaptchaRegistrationOperation;
import com.rssl.auth.csasocial.operations.StartRegistrationOperation;
...
import com.rssl.phizic.web.socialApi.auth.OperationalActionBase;
...
public class RegisterAppAction extends LookupDispatchAction
{
	...
	public ActionForward register(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
        ...
        boolean useCaptcha = mobilePlatformService.isRegistrationUseCaptcha(request.getParameter(Constants.APP_TYPE_FIELD));

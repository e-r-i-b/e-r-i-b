...
/**
 * Бросается в случае невозможности совершить требуемое действие из-за
 * того что не прошли требуемые проверки. Гарантируетя что после возникновения этого исключения
 * прорамма остается в рабочем состоянии
 * @author Evgrafov
 * @ created 23.12.2005
 * @ $Author: erkin $
 * @ $Revision: 47998 $
 */
public class SecurityLogicException extends Exception
{
	/**
	 * Constructs a new exception with <code>null</code> as its detail message. The cause is not initialized, and
	 * may subsequently be initialized by a call to {@link #initCause}.
	 */
	public SecurityLogicException()
	{
	}
	 ...
	 *                #getMessage()} method.
	 */
	public SecurityLogicException(String message)
	{
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public SecurityLogicException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * associated with <code>cause</code> is <i>not</i> automatically incorporated in this exception's detail
	 * message.
	 *
	 ...
	 * @since 1.4
	 */
	public SecurityLogicException(String message, Throwable cause)
	{
		super(message, cause);
	}
}

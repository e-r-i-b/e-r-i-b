...
/**
 * Бросается в случае проблем в работе с БД
 * При возникновении данного исключения не гарантируется
 * возможность восстановления работы в нормальном режиме
 * @author Evgrafov
 * @ created 23.12.2005
 * @ $Author: erkin $
 * @ $Revision: 47998 $
 */
public class SecurityDbException extends Exception
{
	/**
	 ...
	 *                #getMessage()} method.
	 */
	public SecurityDbException(String message)
	{
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public SecurityDbException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 * @since 1.4
	 */
	public SecurityDbException(String message, Throwable cause)
	{
		super(message, cause);
	}
}

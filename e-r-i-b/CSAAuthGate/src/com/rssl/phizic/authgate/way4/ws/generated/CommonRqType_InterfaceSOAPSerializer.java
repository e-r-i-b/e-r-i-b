...
public class CommonRqType_InterfaceSOAPSerializer extends InterfaceSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_myVerifySIDRqType_InterfaceSOAPSerializer = (CombinedSerializer)registry.getSerializer("", com.rssl.phizic.authgate.way4.ws.generated.VerifySIDRqType.class, ns1_VerifySIDRqType_TYPE_QNAME);
        ...
        CombinedSerializer interfaceSerializer = new com.rssl.phizic.authgate.way4.ws.generated.CommonRqType_LiteralSerializer(type, "", DONT_ENCODE_TYPE);
    ...
    public void doSerializeInstance(java.lang.Object obj, javax.xml.namespace.QName name, SerializerCallback callback,
        ...
        com.rssl.phizic.authgate.way4.ws.generated.CommonRqType instance = (com.rssl.phizic.authgate.way4.ws.generated.CommonRqType)obj;
        
        if (obj instanceof com.rssl.phizic.authgate.way4.ws.generated.PrepareOTPRqType) {
            ns1_myPrepareOTPRqType_LiteralSerializer.serialize(obj, name, callback, writer, context);
        } else if (obj instanceof com.rssl.phizic.authgate.way4.ws.generated.VerifyPasswordRqType) {
            ns1_myVerifyPasswordRqType_LiteralSerializer.serialize(obj, name, callback, writer, context);
        } else if (obj instanceof com.rssl.phizic.authgate.way4.ws.generated.VerifySPRqType) {
            ns1_myVerifySPRqType_LiteralSerializer.serialize(obj, name, callback, writer, context);
        } else if (obj instanceof com.rssl.phizic.authgate.way4.ws.generated.VerifySIDRqType) {

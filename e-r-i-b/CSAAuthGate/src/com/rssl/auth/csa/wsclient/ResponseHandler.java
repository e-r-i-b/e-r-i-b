...
import com.rssl.auth.csa.wsclient.responses.ResponseDataImpl;
...
public class ResponseHandler extends DefaultHandler
{
	...
	public ResponseHandler(String requestName) throws ParserConfigurationException
	{
	...
	{
		return new ResponseDataImpl((Document) bodyHandler.getRootDocument());
	}

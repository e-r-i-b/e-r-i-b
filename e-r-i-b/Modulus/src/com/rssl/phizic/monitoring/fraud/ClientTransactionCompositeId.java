...
/**
 * Композитный идентификатор клиентской транзакции во ФМ
 * Состоит из: рандомной составляющей + "|" + groupId блока + "|" + nodeId блока + "|" CSAProfileId + "|" + nodeProfileId + "|" + nodeLoginId;
 *
 * @author khudyakov
 * @ created 22.07.15
 * @ $Author$

...
public class FullPersonFormBuilder extends PersonFormBuilderBase
{
    ...
    protected void initializeValidators()
    {
	    ...
	    validators = new ArrayList<FieldValidator>();
	    validators.add( new RegexpFieldValidator("\\d{15}", "Поле [" + PENSION_CERTIFICATE_NUMBER_FIELD_DESCRIPTION  + "] должно содержать 15 цифр"));
...
//	    validators.add(specialCharacter(EMAIL_FIELD_DESCRIPTION));
	...
	{
		return   new RegexpFieldValidator("[^<>!#$%^&*{}|\\]\\[''\"~=]*","Поле [" + stringName + "] не должно содержать спецсимволов");
	}
}

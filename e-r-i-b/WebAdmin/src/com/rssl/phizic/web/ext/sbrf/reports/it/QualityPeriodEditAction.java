...
import com.rssl.phizic.operations.ext.sbrf.reports.it.QualityPeriodEditOperation;
...
public class QualityPeriodEditAction    extends ReportsEditAction
{
    public ReportEditOperation getReportOperation() throws Exception
    {
	    return createOperation(QualityPeriodEditOperation.class);
    }

...
import com.rssl.phizic.operations.ext.sbrf.reports.CountContractOKREditOperation;
...
public class ContractOKREditAction extends ReportsEditAction
{
    public ReportEditOperation getReportOperation() throws Exception
    {
	    return createOperation(CountContractOKREditOperation.class);
    }

...
/**
 * экшн создания/редактирования тарифов на перевод в другой банк
 * @author niculichev
 * @ created 19.04.2012
 * @ $Author$
 * @ $Revision$
 */
public class EditTariffTransferOtherBankAction extends EditActionBase
{
	protected EditEntityOperation createEditOperation(EditFormBase frm) throws BusinessException, BusinessLogicException
	{
		EditTariffOperation operation =	createOperation("EditTariffTransferOtherBankOperation", "TariffTransferOtherBankService");
	...
	{
		return EditTariffTransferOtherBankForm.EDIT_FORM;
	}
	...
	protected void updateEntity(Object entity, Map<String, Object> data) throws Exception
	{
		...
		{
			tariff.setTransferType(TransferType.OTHER_BANK);

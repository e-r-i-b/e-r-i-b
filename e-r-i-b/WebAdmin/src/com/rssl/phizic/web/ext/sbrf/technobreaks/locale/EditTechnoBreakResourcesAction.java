...
import com.rssl.phizic.operations.ext.sbrf.technobreaks.locale.EditTechnoBreakResourcesOperation;
 ...
 * @ $Revision$
 */
public class EditTechnoBreakResourcesAction extends EditLanguageResourcesBaseAction
{
	@Override
	protected void updateForm(EditLanguageResourcesBaseForm frm, LanguageResources entity) throws Exception
	{
		EditTechnoBreakResourcesForm form = (EditTechnoBreakResourcesForm) frm;
		TechnoBreakResources resources = (TechnoBreakResources) entity;
		form.setField(Constants.MESSAGE, resources.getMessage());
	}
	...
	{
		TechnoBreakResources resources = (TechnoBreakResources) entity;
		resources.setMessage((String)data.get(Constants.MESSAGE));
	}
	...
	{
		return EditTechnoBreakResourcesForm.EDIT_FORM;
	}
	...
	{
		return createOperation(EditTechnoBreakResourcesOperation.class);
	}
}

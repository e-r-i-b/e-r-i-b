...
<html:form action="/loans/offers/cardLoad" enctype="multipart/form-data">
    ...
    <tiles:insert definition="loansMain">
        ...
        <tiles:put name="data" type="string">
            <tiles:insert definition="paymentForm" flush="false">
                ...
                <tiles:put name="name" value="Загрузка предложений по картам"/>
                <tiles:put name="description" value="Выберите файл для загрузки предложений по кредитным картам"/>
                <tiles:put name="data">
                    <h4>Файл</h4>

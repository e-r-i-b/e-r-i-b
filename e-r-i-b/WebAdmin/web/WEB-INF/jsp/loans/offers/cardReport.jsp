    ...
    <tiles:insert definition="loansMain">
        ...
        <tiles:put name="data" type="string">
            <tiles:insert definition="paymentForm" flush="false">
                ...
                <tiles:put name="name" value="ѕротокол загрузки предложений по картам"/>
                <tiles:put name="description" value="ѕротокол загрузки предложений по картам"/>
                <tiles:put name="data">
                    <p> ќбщее количество обработанных предложений: <c:out value="${frm.totalCount}"/></p>
                    <p>«агружено в базу данных: <c:out value="${frm.loadCount}"/></p>

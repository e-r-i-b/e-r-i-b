	...
	<tiles:insert definition="personEdit">
		...
		<tiles:put name="data" type="string">
			<script type="text/javascript">
                ...
                {
                    setElement('field(alias)',                providerInfo["name"].substring(0, 16)); //В соответствии с ТЗ обрезаем поле name до 16 символов, тк в базе поле alias длиной 16 - ограничение для ЦОД

    ...
    <html:form action="/persons/print">
                      ...
                      <c:otherwise>
                          <tr>
                              ...
                              <td class="docTdBorder textPadding" width="50%">
	                              ...
	                              <c:if test="${(document.documentType == 'RESIDENTIAL_PERMIT_RF')}">
                                     &nbsp;Вид на жительство РФ
                                  </c:if>
      ...
      <tr>
          <td>
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
                  <tr>
                      <td class="docTdBorder textPadding" width="10%">
                          Адрес регистрации
                      </td>
	                  <td class="docTdBorder textPadding" width="10%">
          ...
          <td>
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
                  ...
                  <tr>
                      ...
                      <td class="docTdBorder textPadding">
                          &nbsp;${PrintPersonForm.department.name}
                      </td>
                  </tr>
                  <tr>
                      <td class="docTdBorder textPadding">
              ...
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
                  ...
                  <logic:iterate id="entry" name="PrintPersonForm" property="accountLinks">
                      ...
                      <tr>
                         ...
                         <td class="docTdBorder" align="center">&nbsp;${entry.account.number}</td>
      ...
      <c:set var="lineNumber" value= "0"/>
      <logic:iterate id="entry" name="PrintPersonForm" property="cardLinks">
          <c:set var="lineNumber" value="${lineNumber+1}"/>
      </logic:iterate>
      <c:if test="${(lineNumber > 0)}">
      <tr>
      ...
      <tr>
          <td>
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
                  <tr>
                      <td valign="top" class="docTdBorder textPadding" width="10%" align="center">
                          № п/п
                      </td>
                      <td valign="top" class="docTdBorder textPadding" width="70%" align="center">
                          Номер карты
                      </td>
	                  <td valign="top" class="docTdBorder textPadding" width="70%" align="center">
		                  Тип карты
                  ...
                  <logic:iterate id="entry" name="PrintPersonForm" property="cardLinks">
                      ...
                      <tr>
                         <td class="docTdBorder" align="center">&nbsp;<c:out value="${lineNumber}"/>&nbsp;</td>
                         <td class="docTdBorder" align="center">&nbsp;${entry.number}</td>
	                     <td class="docTdBorder" align="center">&nbsp;${entry.description}</td>
                      </tr>
                  </logic:iterate>
              </table>
          </td>
              ...
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
                  ...
                  <logic:iterate id="entry" name="PrintPersonForm" property="receivers">
                      ...
                      <tr>
                          ...
                          <td class="docTdBorder">&nbsp;${entry.branch}</td>
                      </tr>
                      <tr>
                          <td class="docTdBorder textPadding">
                             Филиал
                          </td>
                          <td class="docTdBorder">&nbsp;${entry.office}</td>
                      </tr>
	                  </c:if>
                  </logic:iterate>
              </table>
              ...
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
                      ...
                      <logic:iterate id="receiver" name="PrintPersonForm" property="receivers">
                          ...
                          <tr>
                              ...
                              <td class="docTdBorder">&nbsp;${receiver.bankCode}</td>
                          </tr>
                          <tr>
                              <td class="docTdBorder textPadding">
                                 Корр.счет

    ...
    <tiles:insert definition="tableTemplate" flush="false">
            ...
            <tiles:put name="grid">
                <sl:collection id="listElement" model="list" property="data" bundle="personsBundle">
                    ...
                    <sl:collectionItem title="label.receiver.name"  value="${listElement.name}">
                        <sl:collectionItemParam
                                id="action"
                                value="/persons/receivers/edit.do?person=${param.person}&kind=${listElement.kind}&id=${listElement.id}"
                                condition="${phiz:impliesOperation('EditPaymentReceiverOperationAdmin', 'PersonManagement')}"
                                />
                    </sl:collectionItem>
                    <sl:collectionItem title="label.receiver.inn"     value="${listElement.INN}"/>

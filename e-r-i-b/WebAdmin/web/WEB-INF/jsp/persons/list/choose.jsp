...
<html:form action="/persons/list/choose">
                    ...
                    <tiles:insert definition="clientButton" flush="false" operation="ChangeLockClientOperation">
                      ...
                      <tiles:insert definition="commandButton" flush="false" operation="ChangeLockClientOperation">
                        ...
                        <tiles:put name="validationFunction">
                            function(){return checkOneSelection("selectedIds", "<bean:message key='form.list.full.table.message.lock.oneSelection.unlock' bundle='personsBundle'/>")}
                        </tiles:put>
                    </tiles:insert>
                </tiles:put>
                <tiles:put name="grid">
                    <html:hidden property="field(blockReason)"    name="form" styleId="blockReason"/>
                    <html:hidden property="field(blockStartDate)" name="form" styleId="blockStartDate"/>
                    <html:hidden property="field(blockEndDate)"   name="form" styleId="blockEndDate"/>
                    <html:hidden property="field(firstname)"      name="form"/>
                    <html:hidden property="field(patrname)"       name="form"/>
                    <html:hidden property="field(surname)"        name="form"/>
                    <html:hidden property="field(birthDay)"       name="form"/>
                    <%--<c:set var="birthDateStr"><fmt:formatDate value="${form.fields.birthDay}" pattern="dd.MM.yyyy"/></c:set>
                    <html:hidden property="field(birthDay)" name="form" value="${birthDateStr}"/>--%>
                    <html:hidden property="field(passport)" name="form"/>
                    <html:hidden property="field(tb)" name="form"/>
    ...
    <script type="text/javascript">
        function callReasonWindow()
        {
            ...
            if(blockReason != null && blockStartDate != null)
            {
                setReason(blockReason.value, blockStartDate.value, blockEndDate == null ? null : blockEndDate.value);
                return;
            }

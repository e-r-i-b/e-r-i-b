...
<tiles:put name="data" type="string">
    ...
    <tr>
        <td align="right">Код 014180001/2</td>
    </tr>
    ...
    <tr>
        <td>
            ...
            <tr>
                <td width="70%"><nobr>г. <input value='${department.city}' type="Text" class="insertInput" style="width: 50%"></nobr></td>
                <td>&nbsp;</td>
    ...
    <tr>
        <td>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            В соответствии с Заявлением  № <input value='<bean:write name='person' property="agreementNumber"/>' type="Text" class="insertInput" style="width: 21%"> от <input value='<bean:write name="agreementDate" format="dd.MM.yyyy"/>' type="Text" class="insertInput" style="width: 13%">  и Условиями Банк вправе списывать в безакцептном порядке без дополнительных распоряжений Вкладчика
        </td>
    </tr>
    <logic:iterate id="accountLink" name="PrintPersonForm" property="accountLinks">
    ...
    <tr>
        <td>плату за услуги Банка, предусмотренную Заявлением  № <input value='<bean:write name='person' property="agreementNumber"/>' type="Text" class="insertInput" style="width: 21%"> от <input value='<bean:write name="agreementDate" format="dd.MM.yyyy"/>' type="Text" class="insertInput" style="width: 13%">, в соответствии с тарифами Банка.</td>
    </tr>
    <tr>
        <td>
            <table width="100%" cellpadding="0" cellspacing="0" class="textDoc">
            ...
            <tr>
                <td valign="top">3.&nbsp;&nbsp;</td>
                <td>
                    <bean:message bundle="commonBundle" key="text.additional.agreement.stop"/>&nbsp;<input value='<bean:write name='person' property="agreementNumber"/>' type="Text" class="insertInput" style="width: 22%"> от
	                <c:choose>
                        <c:when test="${empty agreementDate}">
                            &ldquo;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&rdquo;<input id='monthStr101' value='' type="Text" class="insertInput" style="width: 17%">20&nbsp;&nbsp;&nbsp;года.
                        </c:when>
                        <c:otherwise>
                            &ldquo;<bean:write name='agreementDate' format="dd"/>&rdquo;<input id='monthStr101' value='' type="Text" class="insertInput" style="width: 17%"> 20<bean:write name='agreementDate' format="y"/>года
                        </c:otherwise>
                    </c:choose>
                    и Условия.
                </td>

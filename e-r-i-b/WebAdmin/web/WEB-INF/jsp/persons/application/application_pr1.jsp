...
<tr>
	<td align="center">
		<bean:message bundle="commonBundle" key="label.client.delegates.list.text"/>
	</td>
</tr>
<tr>
	<td>
		...
		<tr>
			...
			<td class="docTdBorder" valign="top" align="center"><b>&nbsp;<bean:message bundle="commonBundle" key="label.client.delegate.id.text"/></b></td>
...
<c:forEach var="empoweredPerson" items="${empoweredPersons}">
    ...
    <tr>
        <td>
            ...
            <tr>
                <td colspan="3" class="docTdBorder textPadding" width="100%"><bean:message bundle="commonBundle" key="label.paid.operations.list"/></td>
            </tr>
            <tr>
                <td class="docTdBorder" align="center" valign="top">1</td>
                <td class="docTdBorder textPadding">Перевод (перечисление)  денежных средств, хранящихся на счете на другой действующий счет, в том числе открытый в другом филиале Банка (Операционном управлении Сбербанка России ОАО) или в другой кредитной организации</td>
                <c:choose>
            ...
            <tr>
                ...
                <td class="docTdBorder textPadding">Перевод денежных средств, хранящихся на счете6, в рублях в другой филиал Банка для выплаты без открытия счета</td>
                <td class="docTdBorder" align="center">Запрещена</td>
            </tr>                
            <tr>
            ...
            <tr>
                ...
                <td class="docTdBorder textPadding">Продажа Банком иностранной валюты в безналичном порядке за счет средств на счете в рублях (с зачислением полученной суммы на действующий счет Клиента в иностранной валюте в том же филиале Банка)</td>
                <c:choose>
    ...
    (с зачислением полученной суммы на действующий счет Клиента в иностранной валюте в том же филиале Банка)
            ...
            <tr>
                <td class="docTdBorder" align="center" valign="top" width="5%">7</td>
                <td class="docTdBorder textPadding" width="47%">Списание денежных средств со счета в рублях (в бюджет и государственные внебюджетные фонды, в пользу получателей платежей - юридических лиц или индивидуальных предпринимателей, как имеющих, так и не имеющих договорные отношения с Банком).</td>
                <c:choose>
            ...
            <tr>
                <td class="docTdBorder" align="center" valign="top" width="5%">8</td>
                <td class="docTdBorder textPadding" width="47%">Оформление и отмена длительных поручений по счету:<br/>
                    <span style="padding-left:5mm">-на перевод (перечисление) сумм на другие счета физических лиц в рублях;</span><br/>
                    <span style="padding-left:5mm">-на покупку и продажу (конверсию) в безналичном порядке иностранной валюты с зачислением полученной суммы на действующий счет Клиента в том же филиале Банка;</span><br/>
                    <span style="padding-left:5mm">-на списание денежных средств в рублях в пользу юридических лиц–получателей платежей, как имеющих, так и не имеющих договорные отношения с Банком.</span>
                </td>
                <td class="docTdBorder" align="center">Запрещена</td>
            </tr>
            <tr>
                <td class="docTdBorder" align="center" valign="top" width="5%">9</td>
                <td class="docTdBorder textPadding" width="47%">Списание денежных средств со счета6 в рублях (в бюджет и государственные внебюджетные фонды, в пользу юридических лиц или индивидуальных предпринимателей, с которыми Сбербанком России ОАО заключены или не заключены договоры на прием и перечисление платежей).
                </td>
                <td class="docTdBorder" align="center">Запрещена</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="docTdBorder" align="center" valign="top" width="5%">4</td>
                <td class="docTdBorder textPadding" width="47%">Отчет об исполнении длительных поручений по вкладу (счету) Клиента в заданном периоде (не более шести последних месяцев, включая текущий)
                </td>
                <td class="docTdBorder" align="center">Запрещена</td>
            </tr>
            <tr>

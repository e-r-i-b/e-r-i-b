...
<tfoot>
      <th>
         <table class="textDoc font10" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td colspan="4">
            ...
            <tr>
			    <td style="padding-top:5mm; padding-bottom:2mm;"><nobr>От&nbsp;имени&nbsp;Банка</nobr></td>
			    <td width="50%"><input type="Text" readonly="true" class="insertInput" style="width:98%"></td>
    			<td style="padding-top:5mm; padding-bottom:2mm;">Вкладчик</td>

     ...
     <table style="width:169mm;margin-left:15mm;margin-top:15mm;">
      <tr>
         <td align="center" valign="bottom" style="height:25mm">
            <b>
            ЗАЯВЛЕНИЕ<br/>
            на прекращение предоставления услуг с использованием системы “Интернет-клиент<br>
            для физ. лиц” и расторжение договора<br/>
            </b>
         </td>
      </tr>
      <tr>
      ...
      <tr>
         <td align="left">
            ...
            системы “Интернет-клиент для физ. лиц” и расторгнуть “Договор о предоставлении услуг с
            использованием системы “Интернет-клиент для физ. лиц” <nobr>№ <bean:write name="agrNum"/></nobr>
         ...
         <td >
            <table>
               <tr>
                  ...
                  <td style="width:15mm" align="left">
                      <table><tr><td height="9px" width="11px" style="border:1px solid black;font-size:10px;text-align:center;font-family:Verdana;">
		                  <c:choose><c:when test="${cancellationCause eq 'B'}">X</c:when><c:otherwise>&nbsp;</c:otherwise></c:choose></td></tr></table>
                  </td>
                  <td  align="left">
                     - инициатива Банка.
                  </td>

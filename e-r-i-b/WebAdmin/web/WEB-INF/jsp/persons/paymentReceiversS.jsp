		...
		<tiles:put name="menu" type="string">
			...
			<c:if test="${isShowSaves}">
				<tiles:insert definition="clientButton" flush="false" operation="EditPaymentReceiverOperationAdmin">
					...
					<tiles:put name="action"  value="/persons/receivers/edit.do?person=${param.person}&kind=S"/>
                    ...
                    <sl:collection id="listElement" model="list" property="data" bundle="personsBundle">
                        ...
                        <sl:collectionItem title="label.receiver.fio"   value="${listElement.name}">
                            <sl:collectionItemParam
                                    id="action"
                                    value="/persons/receivers/edit.do?person=${param.person}&kind=S&id=${listElement.id}"
                        ...
                        <sl:collectionItem title="label.receiver.sbrf.tb" value="${listElement.officeKey.code.fields[region]}"/>
                        <sl:collectionItem title="label.receiver.sbrf.branch" value="${listElement.officeKey.code.fields[branch]}"/>
                        <sl:collectionItem title="label.receiver.sbrf.office" value="${listElement.officeKey.code.fields[office]}"/>
                    </sl:collection>

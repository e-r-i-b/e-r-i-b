...
<html:form action="/log/operations" onsubmit="return checkData(event);">
<tiles:insert definition="logMain">
<tiles:put name="submenu" type="string" value="Operation"/>
<tiles:put name="pageTitle" type="string">
	Выгрузка журнала действий клиента
</tiles:put>
...
<tiles:put name="data" type="string">
	...
	<table cellspacing="4" cellpadding="1" class="filterBorder" onkeypress="onEnterKey(event);"
		...
		<tr>
			...
			<td>
				Фамилия&nbsp;
				<html:text property="filter(surName)" styleClass="filterInput" size="20"/>
			</td>
		</tr>
	</table>

...
<html:form action="/socialApi/configurePlatform" onsubmit="return setEmptyAction(event);">
        ...
        <tiles:put name="data" type="string">
            ...
            <tiles:put name="menu" type="string">
                <tiles:insert definition="commandButton" flush="false">
                    ...
                    <tiles:put name="action" value="/socialApi/configurePlatform/edit.do"/>
            ...
            <tiles:insert definition="tableTemplate" flush="false">
                ...
                <tiles:put name="id" value="SocialPlatformConfig"/>
                ...
                <tiles:put name="grid">
                   <sl:collection id="device" model="list" property="data">
                       ...
                       <sl:collectionItem title="ID" property="platformId">
                          <sl:collectionItemParam id="action" value="/socialApi/configurePlatform/edit.do?id=${device.id}"/>
                      </sl:collectionItem>
                ...
                <tiles:put name="buttons">
                    <script type="text/javascript">
                        var addUrl = "${phiz:calculateActionURL(pageContext,'/socialApi/configurePlatform/edit')}";
                        function doEdit()
                        {

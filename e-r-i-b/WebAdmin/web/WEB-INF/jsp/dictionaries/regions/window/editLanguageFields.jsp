...
<html:form action="/private/async/dictionaries/regions/locale/save">
    &nbsp;
    ...
    <tiles:insert definition="paymentForm" flush="false">
        ...
        <tiles:put name="data">
            ...
            <fieldset>
                <tiles:insert definition="simpleFormRow" flush="false">
                    ...
                    <tiles:put name="data">
                        <html:text styleId="name_lang" property="fields(name)" size="60" maxlength="100"/>
                    </tiles:put>
                </tiles:insert>
        ...
        <tiles:put name="buttons">
            ...
            <tiles:insert definition="clientButton" flush="false" operation="EditRegionResourcesOperation">

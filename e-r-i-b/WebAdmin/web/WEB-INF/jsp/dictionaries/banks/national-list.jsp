...
<html:form action="/private/multiblock/dictionary/banks/national" onsubmit="return setAction();">
...
<tiles:insert definition="${layoutDefinition}">
   ...
   <tiles:put name="data" type="string">
      ...
      <tiles:insert definition="tableTemplate" flush="false">
         ...
         <tiles:put name="emptyMessage" value="Не найдено ни одного банка, <br/>соответсвующей заданному фильтру!"/>
      </tiles:insert>
   </tiles:put>
</tiles:insert>

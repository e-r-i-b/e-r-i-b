...
<tiles:insert definition="propertyField" flush="false">
    ...
    <tiles:put name="fieldHint">Укажите адрес к обратному веб-сервису на стороне ИКФЛ.</tiles:put>
        ...
        <fieldset>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tiles:insert definition="propertyField" flush="false">
                    ...
                    <tiles:put name="textSize" value="60"/>
                    <tiles:put name="fieldHint">Укажите имя домена или IP-адрес сервера, на котором установлен XML-шлюз для ИСППН «Город».</tiles:put>
                    <tiles:put name="imagePath" value="${imagePath}"/>
                    <tiles:put name="tdStyle" value="vertical-align rightAlign paymentLabelTable"/>
                </tiles:insert>
                <tiles:insert definition="propertyField" flush="false">
                    ...
                    <tiles:put name="fieldHint">Укажите номер порта, через который настроен шлюз для взаимодействия с ИСППН «Город».</tiles:put>
                    <tiles:put name="imagePath" value="${imagePath}"/>
                    <tiles:put name="tdStyle" value="vertical-align rightAlign paymentLabelTable"/>
                </tiles:insert>
                <tiles:insert definition="propertyField" flush="false">
                    ...
                    <tiles:put name="fieldHint">Укажите ПАН карты, под которой работает шлюз для взаимодействия с ИСППН «Город».</tiles:put>
                    <tiles:put name="imagePath" value="${imagePath}"/>
                    <tiles:put name="tdStyle" value="vertical-align rightAlign paymentLabelTable"/>
                </tiles:insert>
                <tiles:insert definition="propertyField" flush="false">
                    ...
                    <tiles:put name="textSize" value="10"/>
                    <tiles:put name="fieldHint">Укажите ПИН карты, под которой работает шлюз для взаимодействия с ИСППН «Город».</tiles:put>
                    <tiles:put name="imagePath" value="${imagePath}"/>
                    <tiles:put name="tdStyle" value="vertical-align rightAlign paymentLabelTable"/>
                </tiles:insert>
            </table>
...
<tiles:insert definition="propertyField" flush="false">
    ...
    <tiles:put name="selectItems" value="true@Задолженность|false@Переплата"/>
    <tiles:put name="fieldHint">Укажите показатель отрицательной суммы задолженности.</tiles:put>
    <tiles:put name="imagePath" value="${imagePath}"/>
    <tiles:put name="tdStyle" value="vertical-align rightAlign paymentLabelTable"/>
</tiles:insert>
<!-- end generated code -->

...
<tiles:insert definition="propertyField" flush="false">
    ...
    <tiles:put name="fieldDescription"><bean:message bundle="adapterBundle" key="SofiaVMS.com.rssl.phisicgate.sbrf.ws.sbol.url"/></tiles:put>
    <tiles:put name="textSize" value="60"/>
    <tiles:put name="fieldHint">Укажите адрес веб-сервиса Сбербанка для передачи необработанных сообщений.</tiles:put>
...
<tiles:insert definition="propertyField" flush="false">
    ...
    <tiles:put name="fieldDescription"><bean:message bundle="adapterBundle" key="SofiaVMS.com.rssl.phizic.wsgate.listener.url"/></tiles:put>
    <tiles:put name="textSize" value="60"/>
    ...
    <tr>
        <td class="vertical-align rightAlign">
            <bean:message bundle="adapterBundle" key="SofiaVMS.com.rssl.gate.office.code.region.number"/>
        </td>
        <td>
            <nobr>
...
<tiles:insert definition="propertyField" flush="false">
            ...
            <fieldset>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tiles:insert definition="propertyField" flush="false">
                        ...
                        <tiles:put name="fieldDescription"><bean:message bundle="adapterBundle" key="SofiaVMS.com.rssl.phizic.gate.payments.AccountJurTransfer.usePaymentOrder"/></tiles:put>
                    ...
                    <tiles:insert definition="propertyField" flush="false">
                        ...
                        <tiles:put name="fieldDescription"><bean:message bundle="adapterBundle" key="SofiaVMS.com.rssl.phizic.gate.payments.AccountJurIntraBankTransfer.usePaymentOrder"/></tiles:put>
                        <tiles:put name="fieldType" value="select"/>
                        <tiles:put name="selectItems" value="false@Стандартный режим|true@Полноформатный режим"/>
                        <tiles:put name="fieldHint">Укажите способ формирования платежного поручения.</tiles:put>
                        <tiles:put name="imagePath" value="${imagePath}"/>
                    ...
                    <tiles:insert definition="propertyField" flush="false">
                        ...
                        <tiles:put name="fieldDescription"><bean:message bundle="adapterBundle" key="SofiaVMS.com.rssl.phizic.gate.payments.AccountRUSTaxPayment.usePaymentOrder"/></tiles:put>
                        <tiles:put name="fieldType" value="select"/>
                        <tiles:put name="selectItems" value="false@Стандартный режим|true@Полноформатный режим"/>
                        <tiles:put name="fieldHint">Укажите способ формирования платежного поручения.</tiles:put>
                        <tiles:put name="imagePath" value="${imagePath}"/>
                    ...
                    <tiles:insert definition="propertyField" flush="false">
                        <tiles:put name="fieldName" value="com.rssl.phizic.gate.payments.AccountPaymentSystemPayment.usePaymentOrder"/>
                        <tiles:put name="fieldDescription"><bean:message bundle="adapterBundle" key="SofiaVMS.com.rssl.phizic.gate.payments.systems.AccountPaymentSystemPayment.usePaymentOrder"/></tiles:put>
                        <tiles:put name="fieldType" value="select"/>
                        <tiles:put name="selectItems" value="false@Стандартный режим|true@Полноформатный режим"/>
                        <tiles:put name="fieldHint">Укажите способ формирования платежного поручения.</tiles:put>
                        <tiles:put name="imagePath" value="${imagePath}"/>
    ...
    <script type="text/javascript">
        ...
        var uniqWOBProperties = ["wrongOfficeBranchesProperties_osbCode_"];
        var wrongOfficeBranchesHelper = new TablePropertiesHelper('wrongOfficeBranchesProperties',
                                            fieldsWOBProperties, initFieldsWOBProperties, '${imagePath}', uniqWOBProperties);
        ...
        var ourTBCodesPropertiesHelper = new TablePropertiesHelper('ourTBCodesProperties',
                                            fieldsOTCProperties, ${OTCFieldsFormatedForJSArray}, '${imagePath}', uniqOTCProperties);

...
<script language="JavaScript">
	...
	function checkData()
	{
		var n = document.getElementsByName("login");
		var p = document.getElementsByName("password");

		if (n[0].value.length == 0 || p[0].value.length == 0)
		{
...
<input type="hidden" name="accessType" value="employee"/>
		...
		<tr>
			...
			<td valign="middle">
				...
				<tr>
					<td colspan="5" align="center" class="lpSystemTitle">Интернет-клиент<br><span>для физических лиц<br>АРМ Сотрудника</span></td>
				</tr>
				<tr>
							...
							<td align="left" width="340px">
										...
										<tr>
											<td>
												...
												<tr>
													...
													<td width="1%" valign="top" class="lpMessage">
												...
												<tr>
													...
													<td class="lpInputArea">
														...
														<tr>
															...
															<td width="30%" rowspan="2" class="tableArea"></td>
														</tr>
														<tr>
															<td>Пароль</td>
															<td align="right">
												...
												<tr>
													...
													<td align="center" class="lpInputAreaBtm">
								...
								<%--<tr>--%>
									<%--<td style="padding-left:25px;" colspan="3">--%>
										<%--<b>Примечание:</b><br>--%>
										<%--<li>При вводе логина и пароля учтите, что он чувствителен к регистру символов--%>
										<%--<li>Если у вас нет логина и пароля на доступ в систему обратитесь в банк.--%>
										<%--<li>Ещё какой-то крайне полезный текст чтобы занять место										--%>
									<%--</td>--%>
								<%--</tr>--%>
								<tr>

...
<html:form action="/reports/contract/okr">
    ...
    <tiles:insert definition="reports">
        ...
        <tiles:put name="submenu" type="string" value="BusinessReport/CountContract/OKR"/>
        <tiles:put name="pageTitle" type="string"><bean:message key="label.contractOKR" bundle="${bundle}"/></tiles:put>

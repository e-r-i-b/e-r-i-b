...
<html:form action="/reports/contract/vsp">
    ...
    <tiles:insert definition="reports">
        ...
        <tiles:put name="submenu" type="string" value="BusinessReport/CountContract/VSP"/>
        <tiles:put name="pageTitle" type="string"><bean:message key="label.contractVSP" bundle="${bundle}"/></tiles:put>

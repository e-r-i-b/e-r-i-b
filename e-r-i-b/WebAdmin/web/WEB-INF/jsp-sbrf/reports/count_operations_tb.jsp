...
<html:form action="/reports/operations/tb">
    ...
    <tiles:insert definition="reports">
        ...
        <tiles:put name="submenu" type="string" value="BusinessReport/CountOperations/TB"/>
        <tiles:put name="pageTitle" type="string"><bean:message key="label.operationTB" bundle="${bundle}"/></tiles:put>

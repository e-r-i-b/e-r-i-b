...
<html:form action="/reports/active_users/tb">
    ...
    <tiles:insert definition="reports">
        ...
        <tiles:put name="submenu" type="string" value="BusinessReport/CountUsers/TB"/>
        <tiles:put name="pageTitle" type="string"><bean:message key="label.activeUserTB" bundle="${bundle}"/></tiles:put>

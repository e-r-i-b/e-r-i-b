...
<html:form action="/reports/contract/osb">
    ...
    <tiles:insert definition="reports">
        ...
        <tiles:put name="submenu" type="string" value="BusinessReport/CountContract/OSB"/>
        <tiles:put name="pageTitle" type="string"><bean:message key="label.contractOSB" bundle="${bundle}"/></tiles:put>

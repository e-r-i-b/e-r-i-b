...
<html:form action="/reports/contract/vsp/report">
    ...
    <c:set value="reportsBundle" var="bundle"/>
        ...
        <tiles:put name="pageTitle" type="string"><bean:message key="label.countContractVSP" bundle="${bundle}"/></tiles:put>
        <tiles:put name="data" type="string">
            <c:set var="date_report" value="${phiz:dateToString(form.reportStartDate.time)}"/>
            <tiles:insert definition="tableTemplate" flush="false">
                    <tiles:put name="text"><bean:message key="label.countContractVSP" bundle="${bundle}"/> <bean:message key="label.fromDate" bundle="${bundle}" arg0="${date_report}"/></tiles:put>

...
<html:form action="/reports/active_users/vsp">
    ...
    <tiles:insert definition="reports">
        ...
        <tiles:put name="submenu" type="string" value="BusinessReport/CountUsers/VSP"/>
        <tiles:put name="pageTitle" type="string"><bean:message key="label.activeUserVSP" bundle="${bundle}"/></tiles:put>

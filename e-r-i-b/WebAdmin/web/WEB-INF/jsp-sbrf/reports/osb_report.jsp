...
<html:form action="/reports/contract/osb/report">
    ...
    <tiles:insert definition="reportsList">
        ...
        <tiles:put name="pageTitle" type="string"><bean:message key="label.countContractOSB" bundle="${bundle}"/></tiles:put>
        <tiles:put name="data" type="string">
            <c:set var="date_report" value="${phiz:dateToString(form.reportStartDate.time)}"/>
            <tiles:insert definition="tableTemplate" flush="false">
                    <tiles:put name="text"><bean:message key="label.countContractOSB" bundle="${bundle}"/> <bean:message key="label.fromDate" bundle="${bundle}" arg0="${date_report}"/></tiles:put> 

...
<html:form action="/autotransfer/payment/info" onsubmit="return setEmptyAction(event);">
    ...
    <tiles:insert definition="autoSubscriptions">
        ...
        <tiles:put name="data" type="string">
            <script type="text/javascript">
                ...
                {
                    var url = "${phiz:calculateActionURL(pageContext,'/autotransfer/payment/info/print.do')}";
            ...
            <tiles:insert definition="paymentForm" flush="false">
                ...
                <tiles:put name="data">
                        <%@ include file="/WEB-INF/jsp/common/autosubscription/employee-p2p-payment-info.jsp" %>
                </tiles:put>
                <tiles:put name="buttons">
                    <tiles:insert definition="clientButton" flush="false">
                        ...
                        <tiles:put name="action">/autotransfer/info.do?id=<bean:write name="form" property="subscriptionId"/></tiles:put>
                    </tiles:insert>
                    <tiles:insert definition="clientButton" flush="false">

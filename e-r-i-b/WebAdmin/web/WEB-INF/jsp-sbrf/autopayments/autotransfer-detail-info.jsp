...
<tiles:insert definition="paymentForm" flush="false">
    ...
    <tiles:put name="name"          value="Детальная информация по автопереводу"/>
    <tiles:put name="description"       value="На данной странице Вы можете посмотреть детальную информацию по автопереводу, изменить данные и статус автоперевода."/>
        ...
        <tiles:insert definition="simpleTableTemplate" flush="false" >
            ...
            <tiles:put name="emptyMessage">
                <c:choose>
                    ...
                    <c:otherwise>
                        В рамках автоперевода не было выполнено ни одной оплаты<c:if test="${form.showPaymentForPeriod}"> за указанный период</c:if>.
                    </c:otherwise>
                </c:choose>
            </tiles:put>
        </tiles:insert>

                  ...
                  <tr>
                      ...
                      <td class="docTdBorder textPadding">
                          ...
                          <c:if test="${not empty person.birthDay}">
                               <bean:write name="person" property="birthDay.time" format="dd.MM.yyyy"/>
                          </c:if>
                      </td>
                  </tr>
                  <tr>
              ...
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
	              ...
	              <c:if test="${empty PrintPersonForm.principalPerson}">
					  <tr>
						  ...
						  <td class="docTdBorder textPadding">
							  &nbsp;${PrintPersonForm.messageService}
						  </td>
					  </tr>
	              </c:if>
                  <tr>
          ...
          <td>
              <table cellspacing="0" class="textDoc docTableBorder" width="100%">
                  ...
                  <tr>
                      ...
                      <td class="docTdBorder textPadding">
                          &nbsp;${PrintPersonForm.department.code.fields.branch}/${PrintPersonForm.department.code.fields.office} ${PrintPersonForm.department.name}
                      </td>
                  </tr>
                  <tr>
                      <td class="docTdBorder textPadding">

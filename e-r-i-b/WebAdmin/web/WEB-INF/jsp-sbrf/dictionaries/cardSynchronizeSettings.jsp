...
<html:form action="/dictionaries/synchronize/card_settings" onsubmit="return setEmptyAction(event);">
    ...
    <tiles:insert definition="propertiesForm">
        ...
        <tiles:put name="submenu" type="string" value="CardSettings"/>
        <tiles:put name="pageName" type="string" value="Настройка карт для загрузки"/>
        <tiles:put name="pageDescription"
                  value="Для добавления вида вклада укажите код вида и код подвидов вклада и нажмите на кнопку «Сохранить»."/>
        ...
        <tiles:put name="data">
            ...
            <table>
                <tiles:insert definition="propertyField" flush="false">
                    <tiles:put name="fieldName" value="com.rssl.iccs.cardproduct.uploading.mode"/>
                    <tiles:put name="showHint" value="none"/>
                    <tiles:put name="fieldType" value="radio"/>
                    <tiles:put name="selectItems" value="ALL@Все виды вкладов для карточных продуктов|OPTIONALLY@Укажите номера видов вкладов для карточных продуктов"/>
            ...
            <c:choose>
                <c:when test="${showCheckbox == 'true'}">
                    <div class="propertySplitter">
                        <input type="checkbox" id="replicationSelect" value="com.rssl.iccs.cardproduct.kinds.allowed.uploading" name="selectedProperties" style="display: none;"/>
                ...
                <c:otherwise>
                    ...
                    <div id="titleRow">
                        <b>Загружать следующие номера вкладов:</b>
                    </div>
        ...
        <tiles:put name="formButtons">
            <tiles:insert definition="commandButton" flush="false"
                          operation="EditCardSynchronizeSettingsOperation">
    ...
    <script type="text/javascript">
        ...
        {
            var radioValue = getRadioValue(document.getElementsByName('field(com.rssl.iccs.cardproduct.uploading.mode)'));
        ...
        function openEditNumberWindow(update)
        {
            ...
            var winpar = "resizable=1,menubar=1,toolbar=0,scrollbars=1"+
                    ",width=1000" +
                    ",height=0" + height +
                    ",left=0" + (screen.width / 2 - width / 2) +
                    ",top=0" + (screen.height / 2 - height / 2);
         ...
         * -1 если вид вклада не является карточным (com.rssl.iccs.cards.kinds.allowed.downloading)

...
<c:set  scope="request" var="serviceName"               value="EmployeeRecoverMoneyBoxPayment"/>
...
<c:set  scope="request" var="description"               value="Для того чтобы возобновить автоплатеж, проверьте реквизиты заявки и нажмите на кнопку «Оформить заявку». В результате после исполнения операции автоплатеж будет подключен."/>

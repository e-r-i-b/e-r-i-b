...
<c:set  scope="request" var="serviceName"               value="EmployeeEditP2PAutoTransferClaim"/>

<c:set  scope="request" var="subMenu"                   value="AutoTransfers"/>

<c:set  scope="request" var="title"                     value="Заявка на редактирование автоперевода."/>
<c:set  scope="request" var="description"               value="Укажите параметры автоперевода и нажмите на кнопку «Оформить заявку»."/>
...
<c:set  scope="request" var="isEditClaim"               value="${true}"/>

...
<c:set  scope="request" var="serviceName"               value="EmployeeCloseP2PAutoTransferClaim"/>

<c:set  scope="request" var="subMenu"                   value="AutoTransfers"/>

<c:set  scope="request" var="title"                     value="Заявка на отключение автоперевода."/>
<c:set  scope="request" var="description"               value="Для того чтобы отменить автоперевод, проверьте реквизиты заявки и нажмите на кнопку «Сохранить». В результате после исполнения операции автоперевод будет отменен."/>

...
<c:set  scope="request" var="serviceName"               value="EmployeeDelayP2PAutoTransferClaim"/>

<c:set  scope="request" var="subMenu"                   value="AutoTransfers"/>

<c:set  scope="request" var="title"                     value="Заявка на приостановление выполнения автоперевода."/>
<c:set  scope="request" var="description"               value="Для того чтобы приостановить автоперевод, проверьте реквизиты заявки и нажмите на кнопку «Сохранить». В результате после исполнения операции автоперевод будет приостановлен."/>

...
<c:set  scope="request" var="serviceName"               value="EmployeeRefuseMoneyBoxPayment"/>
...
<c:set  scope="request" var="description"               value="Для того чтобы приостановить автоплатеж, проверьте реквизиты заявки и нажмите на кнопку «Оформить заявку». В результате после исполнения операции автоплатеж будет приостановлен."/>

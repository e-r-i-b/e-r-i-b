...
<c:set  scope="request" var="serviceName"               value="EditEmployeeAutoSubscriptionPayment"/>

<c:set  scope="request" var="subMenu"                   value="AutoSubscriptions"/>

<c:set  scope="request" var="title"                     value="Заявка на редактирование автоплатежа."/>
<c:set  scope="request" var="description"               value="Укажите параметры автоплатежа и нажмите на кнопку «Сохранить»."/>

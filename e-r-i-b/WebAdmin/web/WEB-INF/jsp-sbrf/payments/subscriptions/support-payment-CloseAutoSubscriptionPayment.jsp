...
<c:set  scope="request" var="serviceName"               value="CloseEmployeeAutoSubscriptionPayment"/>
...
<c:set  scope="request" var="description"               value="Для того чтобы отменить автоплатеж, проверьте реквизиты заявки и нажмите на кнопку «Сохранить». В результате после исполнения операции автоплатеж будет отменен."/>

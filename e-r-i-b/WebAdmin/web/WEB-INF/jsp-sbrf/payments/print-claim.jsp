                ...
                <table style="width:172mm;height:100%;" cellpadding="0" cellspacing="0" class="textDoc">
                    ...
                    <tr>
                        <td align="left">
                            ...
                            Банк <c:out value="${printActionDescription}"/> автоматический платеж "<c:out value="${document.friendlyName}"/>",
                            заключающийся в произведении периодических списаний с карты
                            № <c:out value="${phiz:getCutCardNumber(document.chargeOffCard)}"/> <c:if test="${document.type.simpleName == 'ExternalCardsTransferToOurBankLongOffer'}">в пользу <c:out value="${document.receiverName}"/></c:if>.
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <table cellspacing="0" class="textDoc" width="100%">
                            <tr>
                                <td align="left">
                                    <b>Дата</b> &nbsp;<fmt:formatDate value="${phiz:currentDate().time}" pattern="dd.MM.yyyy"/>
                                </td>
                            </tr>
                            <tr>
                                <td align="left">

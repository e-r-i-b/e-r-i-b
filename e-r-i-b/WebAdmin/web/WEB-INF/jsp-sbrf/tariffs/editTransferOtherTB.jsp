...
<html:form action="/dictionary/tariffs/transferOtherTB/edit" onsubmit="return setEmptyAction(event);">
    <c:set var="form" value="${phiz:currentForm(pageContext)}"/>
    <c:set var="isEdit" value="${form.id != null && form.id != 0}"/>

    <tiles:insert definition="editTariffTransferOtherTB">
        <tiles:put name="data" type="string">
            <tiles:insert definition="paymentForm" flush="false">
                <tiles:put name="name"><bean:message key="tariff.transfer.other.tb.edit.title" bundle="tariffsBundle"/></tiles:put>
                <tiles:put name="description"><bean:message key="tariff.transfer.other.tb.edit.description" bundle="tariffsBundle"/></tiles:put>
                <tiles:put name="data" type="string">
                    ...
                    <tiles:insert definition="simpleFormRow" flush="false">
                        <tiles:put name="title">
                            <bean:message key="tariff.operation.field.name" bundle="tariffsBundle"/>
                        </tiles:put>
                        <tiles:put name="isNecessary" value="true"/>
                        <tiles:put name="data">
                            <html:select property="field(operation)" disabled="${isEdit}" style="width: 320px;">
                                <html:option value="OTHER_TB_OWN_ACCOUNT">
                                    <bean:message key="transfer.other.tb.own.account" bundle="tariffsBundle"/>
                                </html:option>
                                <html:option value="OTHER_TB_ANOTHER_ACCOUNT">
                                    <bean:message key="transfer.other.tb.another.account" bundle="tariffsBundle"/>
                                </html:option>
                            </html:select>
                        </tiles:put>
                    </tiles:insert>

...
<tiles:put name="menu" type="string">
	...
	<tiles:insert definition="clientButton" flush="false">
		...
		<tiles:put name="bundle" value="personsBundle"/>
		<tiles:put name="action" value="persons/receivers/list.do?kind=P&person=${form.person}"/>
        <tiles:put name="viewType" value="buttonGrey"/>
	</tiles:insert>
</tiles:put>
...
<tiles:put name="data" type="string">
	...
	<tiles:put name="name" value="Анкета получателя (физ.лица)"/>
	...
	<tiles:put name="data">
		...
		<tr style="height:20px">
			<td class="Width120 LabelAll">
				<bean:message key="label.receiver.fio" bundle="personsBundle"/>
				<span class="asterisk">*</span>
			</td>
			<td>
		...
		<html:hidden property="kind" value="P"/>
	</tiles:put>

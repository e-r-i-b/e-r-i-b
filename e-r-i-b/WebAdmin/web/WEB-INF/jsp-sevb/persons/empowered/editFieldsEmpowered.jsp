...
<script type="text/javascript">
	...
	{
		clear();
		var elemType = document.getElementById("field(documentType)");
...
<tiles:insert definition="paymentForm" flush="false">
	...
	<tiles:put name="name" value="Анкета представителя."/>
	...
	<tr>
		...
		<table cellpadding="0"cellspacing="0" width="100%">
			<tr>
				...
				<td>
                    <html:text property="field(id)" styleClass="contactInput" readonly="true"/>
                    <html:hidden property="field(clientId)"/>
                </td>
			</tr>
			<tr>
				...
				<td>
					<html:text readonly="true" property="field(pinEnvelopeNumber)" size="20" styleClass="contactInput"/>
			...
			<tr>
				<td class="Width200 LabelAll"><nobr><bean:message key="label.birthDay" bundle="personsBundle"/> <span
						class="asterisk">*</span></nobr></td>
				<td>
					<input type="text"
						   name="field(birthDay)"
			...
			<tr>
				<td colspan="2">
					<table style="width:100%;" cellspacing="0" cellpadding="0" border="0" id="forNotResidentDocument">
						<tr>
							<td class="pmntInfAreaTitle" colspan="2" nowrap="true"><bean:message key="label.document.rightProve" bundle="personsBundle"/></td>
						</tr>
						<tr>
							<td class="Width200 LabelAll"><bean:message key="label.documentType" bundle="personsBundle"/> <span
									class="asterisk">*</span></td>

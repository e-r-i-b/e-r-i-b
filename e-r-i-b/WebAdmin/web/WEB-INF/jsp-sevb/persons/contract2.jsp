            ...
            <tr>
                <td>
                    ...
                    <tr>
                        ...
                        <td width="100%">
                            <nobr>&ldquo;<input value="${accountLink.account.description}" type="Text" readonly="true" class="insertInput" style="width:97%">&rdquo;</nobr>
                        </td>
                    </tr>
                    </table>
                </td>
    ...
    <tr>
        <td>
            ...
            <tr>
                ...
                <td width="100%">
                    <nobr><input value="${department.address}" type="Text" readonly="true" class="insertInput" style="width:100%"></nobr>
                </td>
            </tr>
            </table>
        </td>

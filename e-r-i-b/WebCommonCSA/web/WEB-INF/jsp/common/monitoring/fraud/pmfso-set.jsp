...
<c:if test="${phiz:isFSOTokenValid()}">
    ...
    <noscript>
        <object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' width='1' height='1'>
            ...
            <embed src='${initParam.resourcesRealPath}/images/swf/pmfso.swf' FlashVars='pmdata=${FSOTokenValue}' quality='low' bgcolor='#FFFFFF' width='1' height='1' type='application/x-shockwave-flash'>
                <noembed></noembed>
                <noobject></noobject>
            </embed>
            <noobject></noobject>

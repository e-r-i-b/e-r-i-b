...
public class CurrencyOperationType_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public CurrencyOperationType_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.dictionaries.generated.CurrencyOperationType instance = new com.rssl.phizicgate.wsgate.dictionaries.generated.CurrencyOperationType();
        com.rssl.phizicgate.wsgate.dictionaries.generated.CurrencyOperationType_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_code_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.dictionaries.generated.CurrencyOperationType_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_description_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setDescription((String)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        com.rssl.phizicgate.wsgate.dictionaries.generated.CurrencyOperationType instance = (com.rssl.phizicgate.wsgate.dictionaries.generated.CurrencyOperationType)obj;

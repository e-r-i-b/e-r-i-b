 ...
 * @ $Revision$
 */
public class CountriesGateServiceWrapper  extends JAXRPCClientSideServiceBase<GateService_Stub> implements CountriesGateService
{
	public CountriesGateServiceWrapper(GateFactory factory) throws GateException
	{
		super(factory);
		String url = factory.config(WSGateConfig.class).getURL() + "/CountriesGateServiceImpl";
	...
	public List<Country> getAll(int firstResult, int maxResults) throws GateException, GateLogicException
	{
		try
		{
			List<com.rssl.phizicgate.wsgate.dictionaries.generated.Currency>  generatedCountries =  getStub().getAll(firstResult, maxResults);
			List<Country> countries = new ArrayList<Country>();

			BeanHelper.copyPropertiesWithDifferentTypes(countries, generatedCountries, TypesCorrelation.types);

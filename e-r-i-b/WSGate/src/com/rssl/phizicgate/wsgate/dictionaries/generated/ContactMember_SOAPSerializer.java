...
public class ContactMember_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns1_countryId_QNAME = new QName("", "countryId");
    private static final javax.xml.namespace.QName ns1_deleted_QNAME = new QName("", "deleted");
    ...
    private static final javax.xml.namespace.QName ns1_regMask_QNAME = new QName("", "regMask");
    ...
    public ContactMember_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember instance = new com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember();
        com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_address_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember_SOAPBuilder();
                    }
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_countryId_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_countryId_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myCOUNTRYID_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setCountryId((java.lang.String)member);
                }
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_deleted_QNAME)) {
                member = ns3_myns3__boolean__boolean_Boolean_Serializer.deserialize(ns1_deleted_QNAME, reader, context);
                instance.setDeleted(((Boolean)member).booleanValue());
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_regMask_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_regMask_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myREGMASK_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setRegMask((java.lang.String)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember instance = (com.rssl.phizicgate.wsgate.dictionaries.generated.ContactMember)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getCountryId(), ns1_countryId_QNAME, null, writer, context);
        ns3_myns3__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isDeleted()), ns1_deleted_QNAME, null, writer, context);
        ...
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getRegMask(), ns1_regMask_QNAME, null, writer, context);
    }
}

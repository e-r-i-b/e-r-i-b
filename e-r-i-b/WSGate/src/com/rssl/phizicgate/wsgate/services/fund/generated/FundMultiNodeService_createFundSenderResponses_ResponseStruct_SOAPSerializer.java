...
public class FundMultiNodeService_createFundSenderResponses_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public FundMultiNodeService_createFundSenderResponses_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.fund.generated.FundMultiNodeService_createFundSenderResponses_ResponseStruct instance = new com.rssl.phizicgate.wsgate.services.fund.generated.FundMultiNodeService_createFundSenderResponses_ResponseStruct();
        com.rssl.phizicgate.wsgate.services.fund.generated.FundMultiNodeService_createFundSenderResponses_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.fund.generated.FundMultiNodeService_createFundSenderResponses_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.fund.generated.FundMultiNodeService_createFundSenderResponses_ResponseStruct instance = (com.rssl.phizicgate.wsgate.services.fund.generated.FundMultiNodeService_createFundSenderResponses_ResponseStruct)obj;

...
public class LongOffer_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final int myENDDATE_INDEX = 1;
    private static final int myEXECUTIONEVENTTYPE_INDEX = 2;
    private static final int myEXTERNALID_INDEX = 3;
    private static final int myNUMBER_INDEX = 4;
    private static final int myOFFICE_INDEX = 5;
    private static final int myPAYDAY_INDEX = 6;
    private static final int myPERCENT_INDEX = 7;
    private static final int mySTARTDATE_INDEX = 8;
    private static final int mySUMTYPE_INDEX = 9;
    private static final int myTYPE_INDEX = 10;
    
    public LongOffer_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.cache.generated.LongOffer instance = new com.rssl.phizicgate.wsgate.services.cache.generated.LongOffer();
        com.rssl.phizicgate.wsgate.services.cache.generated.LongOffer_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_amount_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.cache.generated.LongOffer_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_percent_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setPercent((com.rssl.phizicgate.wsgate.services.cache.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.cache.generated.LongOffer instance = (com.rssl.phizicgate.wsgate.services.cache.generated.LongOffer)obj;

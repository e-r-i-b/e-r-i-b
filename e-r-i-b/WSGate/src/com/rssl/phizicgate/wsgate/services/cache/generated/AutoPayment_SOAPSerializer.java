...
public class AutoPayment_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns1_getNumber_QNAME = new QName("", "getNumber");
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.cache.generated.AutoPayment instance = new com.rssl.phizicgate.wsgate.services.cache.generated.AutoPayment();
        com.rssl.phizicgate.wsgate.services.cache.generated.AutoPayment_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_amount_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.cache.generated.AutoPayment_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_floorLimit_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setFloorLimit((com.rssl.phizicgate.wsgate.services.cache.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_getNumber_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_getNumber_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.cache.generated.AutoPayment_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myGETNUMBER_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setGetNumber((java.lang.String)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_totalAmountLimit_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setTotalAmountLimit((com.rssl.phizicgate.wsgate.services.cache.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.cache.generated.AutoPayment instance = (com.rssl.phizicgate.wsgate.services.cache.generated.AutoPayment)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getGetNumber(), ns1_getNumber_QNAME, null, writer, context);

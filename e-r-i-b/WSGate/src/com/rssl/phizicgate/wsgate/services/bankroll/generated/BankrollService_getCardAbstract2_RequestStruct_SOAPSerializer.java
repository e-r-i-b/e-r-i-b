...
public class BankrollService_getCardAbstract2_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.bankroll.generated.BankrollService_getCardAbstract2_RequestStruct instance = new com.rssl.phizicgate.wsgate.services.bankroll.generated.BankrollService_getCardAbstract2_RequestStruct();
        com.rssl.phizicgate.wsgate.services.bankroll.generated.BankrollService_getCardAbstract2_RequestStruct_SOAPBuilder builder = null;
        ...
        for (int i=0; i<4; i++) {
            ...
            if (elementName.equals(ns1_Card_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.bankroll.generated.BankrollService_getCardAbstract2_RequestStruct_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myCARD_1_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setCard_1((com.rssl.phizicgate.wsgate.services.bankroll.generated.Card)member);
                }
                reader.nextElementContent();
                continue;
            }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.bankroll.generated.BankrollService_getCardAbstract2_RequestStruct instance = (com.rssl.phizicgate.wsgate.services.bankroll.generated.BankrollService_getCardAbstract2_RequestStruct)obj;

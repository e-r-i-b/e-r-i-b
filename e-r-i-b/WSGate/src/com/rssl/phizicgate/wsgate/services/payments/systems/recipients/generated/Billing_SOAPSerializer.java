...
public class Billing_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.payments.systems.recipients.generated.Billing instance = new com.rssl.phizicgate.wsgate.services.payments.systems.recipients.generated.Billing();
        com.rssl.phizicgate.wsgate.services.payments.systems.recipients.generated.Billing_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_code_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.payments.systems.recipients.generated.Billing_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_needUploadJBT_QNAME)) {
                member = ns4_myns4__boolean__java_lang_Boolean_Boolean_Serializer.deserialize(ns1_needUploadJBT_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.payments.systems.recipients.generated.Billing_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.payments.systems.recipients.generated.Billing instance = (com.rssl.phizicgate.wsgate.services.payments.systems.recipients.generated.Billing)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns4_myns4__boolean__java_lang_Boolean_Boolean_Serializer.serialize(instance.getNeedUploadJBT(), ns1_needUploadJBT_QNAME, null, writer, context);

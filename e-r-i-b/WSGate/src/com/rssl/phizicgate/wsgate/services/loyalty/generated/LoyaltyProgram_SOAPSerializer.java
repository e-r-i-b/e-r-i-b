...
public class LoyaltyProgram_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public LoyaltyProgram_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.loyalty.generated.LoyaltyProgram instance = new com.rssl.phizicgate.wsgate.services.loyalty.generated.LoyaltyProgram();
        com.rssl.phizicgate.wsgate.services.loyalty.generated.LoyaltyProgram_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_balance_QNAME)) {
                member = ns3_myns3_decimal__java_math_BigDecimal_Decimal_Serializer.deserialize(ns1_balance_QNAME, reader, context);
                instance.setBalance((java.math.BigDecimal)member);
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_email_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.loyalty.generated.LoyaltyProgram_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.loyalty.generated.LoyaltyProgram instance = (com.rssl.phizicgate.wsgate.services.loyalty.generated.LoyaltyProgram)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns3_myns3_decimal__java_math_BigDecimal_Decimal_Serializer.serialize(instance.getBalance(), ns1_balance_QNAME, null, writer, context);

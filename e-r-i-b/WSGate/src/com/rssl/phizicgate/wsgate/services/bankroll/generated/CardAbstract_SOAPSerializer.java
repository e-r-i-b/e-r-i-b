...
public class CardAbstract_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns1_unsettledOperations_QNAME = new QName("", "unsettledOperations");
    ...
    private static final int myTODATE_INDEX = 3;
    private static final int myTRANSACTIONS_INDEX = 4;
    private static final int myUNSETTLEDOPERATIONS_INDEX = 5;
    
    public CardAbstract_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.bankroll.generated.CardAbstract instance = new com.rssl.phizicgate.wsgate.services.bankroll.generated.CardAbstract();
        com.rssl.phizicgate.wsgate.services.bankroll.generated.CardAbstract_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_closingBalance_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.bankroll.generated.CardAbstract_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myCLOSINGBALANCE_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setClosingBalance((com.rssl.phizicgate.wsgate.services.bankroll.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_openingBalance_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setOpeningBalance((com.rssl.phizicgate.wsgate.services.bankroll.generated.Money)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_unsettledOperations_QNAME)) {
                member = ns5_myns5_list__CollectionInterfaceSerializer.deserialize(ns1_unsettledOperations_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.bankroll.generated.CardAbstract_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myUNSETTLEDOPERATIONS_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setUnsettledOperations((java.util.List)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.bankroll.generated.CardAbstract instance = (com.rssl.phizicgate.wsgate.services.bankroll.generated.CardAbstract)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns5_myns5_list__CollectionInterfaceSerializer.serialize(instance.getUnsettledOperations(), ns1_unsettledOperations_QNAME, null, writer, context);
    }
}

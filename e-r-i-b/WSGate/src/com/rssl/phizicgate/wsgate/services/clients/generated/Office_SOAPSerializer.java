...
public class Office_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns3_Code_TYPE_QNAME = new QName("http://generated.clients.services.gate.web.phizic.rssl.com", "Code");
    private CombinedSerializer ns3_myCode_SOAPSerializer;
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ...
        ns3_myCode_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizicgate.wsgate.services.clients.generated.Code.class, ns3_Code_TYPE_QNAME);
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.clients.generated.Office instance = new com.rssl.phizicgate.wsgate.services.clients.generated.Office();
        com.rssl.phizicgate.wsgate.services.clients.generated.Office_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_BIC_QNAME)) {
                member = ns2_myns2_string__java_lang_String_String_Serializer.deserialize(ns1_BIC_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.clients.generated.Office_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_code_QNAME)) {
                member = ns3_myCode_SOAPSerializer.deserialize(ns1_code_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.clients.generated.Office_SOAPBuilder();
                    }
                    ...
                    instance.setCode((com.rssl.phizicgate.wsgate.services.clients.generated.Code)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_parentSynchKey_QNAME)) {
                member = ns2_myns2_string__java_lang_String_String_Serializer.deserialize(ns1_parentSynchKey_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.clients.generated.Office_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_sbidnt_QNAME)) {
                member = ns2_myns2_string__java_lang_String_String_Serializer.deserialize(ns1_sbidnt_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.clients.generated.Office_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_telephone_QNAME)) {
                member = ns2_myns2_string__java_lang_String_String_Serializer.deserialize(ns1_telephone_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.clients.generated.Office_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_creditCardOffice_QNAME)) {
                member = ns2_myns2__boolean__boolean_Boolean_Serializer.deserialize(ns1_creditCardOffice_QNAME, reader, context);
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_openIMAOffice_QNAME)) {
                member = ns2_myns2__boolean__boolean_Boolean_Serializer.deserialize(ns1_openIMAOffice_QNAME, reader, context);
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_needUpdateCreditCardOffice_QNAME)) {
                member = ns2_myns2__boolean__boolean_Boolean_Serializer.deserialize(ns1_needUpdateCreditCardOffice_QNAME, reader, context);
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.clients.generated.Office instance = (com.rssl.phizicgate.wsgate.services.clients.generated.Office)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getBIC(), ns1_BIC_QNAME, null, writer, context);
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getAddress(), ns1_address_QNAME, null, writer, context);
        ns3_myCode_SOAPSerializer.serialize(instance.getCode(), ns1_code_QNAME, null, writer, context);
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getName(), ns1_name_QNAME, null, writer, context);
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getParentSynchKey(), ns1_parentSynchKey_QNAME, null, writer, context);
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getSbidnt(), ns1_sbidnt_QNAME, null, writer, context);
        ...
        ns2_myns2_string__java_lang_String_String_Serializer.serialize(instance.getTelephone(), ns1_telephone_QNAME, null, writer, context);
        ns2_myns2__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isCreditCardOffice()), ns1_creditCardOffice_QNAME, null, writer, context);
        ns2_myns2__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isOpenIMAOffice()), ns1_openIMAOffice_QNAME, null, writer, context);
        ns2_myns2__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isNeedUpdateCreditCardOffice()), ns1_needUpdateCreditCardOffice_QNAME, null, writer, context);
    }
}

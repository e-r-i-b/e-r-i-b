...
public class CalendarGateService___forField_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ns2_myField_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizicgate.wsgate.services.utils.calendar.generated.Field.class, ns2_Field_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.utils.calendar.generated.CalendarGateService___forField_ResponseStruct instance = new com.rssl.phizicgate.wsgate.services.utils.calendar.generated.CalendarGateService___forField_ResponseStruct();
        com.rssl.phizicgate.wsgate.services.utils.calendar.generated.CalendarGateService___forField_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.utils.calendar.generated.CalendarGateService___forField_ResponseStruct_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myRESULT_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setResult((com.rssl.phizicgate.wsgate.services.utils.calendar.generated.Field)member);
                }
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.utils.calendar.generated.CalendarGateService___forField_ResponseStruct instance = (com.rssl.phizicgate.wsgate.services.utils.calendar.generated.CalendarGateService___forField_ResponseStruct)obj;

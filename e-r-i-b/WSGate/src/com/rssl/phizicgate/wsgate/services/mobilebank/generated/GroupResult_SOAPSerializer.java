...
public class GroupResult_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.mobilebank.generated.GroupResult instance = new com.rssl.phizicgate.wsgate.services.mobilebank.generated.GroupResult();
        com.rssl.phizicgate.wsgate.services.mobilebank.generated.GroupResult_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_exceptions_QNAME)) {
                member = ns4_myns4_map__MapInterfaceSerializer.deserialize(ns1_exceptions_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.mobilebank.generated.GroupResult_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_results_QNAME)) {
                member = ns4_myns4_map__MapInterfaceSerializer.deserialize(ns1_results_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.mobilebank.generated.GroupResult_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.mobilebank.generated.GroupResult instance = (com.rssl.phizicgate.wsgate.services.mobilebank.generated.GroupResult)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns4_myns4_map__MapInterfaceSerializer.serialize(instance.getExceptions(), ns1_exceptions_QNAME, null, writer, context);
        ns4_myns4_map__MapInterfaceSerializer.serialize(instance.getResults(), ns1_results_QNAME, null, writer, context);
    }
}

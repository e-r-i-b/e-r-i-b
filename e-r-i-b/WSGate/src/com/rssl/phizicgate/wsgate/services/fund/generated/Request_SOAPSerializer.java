...
public class Request_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns1_expectedClosedDate_QNAME = new QName("", "expectedClosedDate");
    ...
    private static final javax.xml.namespace.QName ns1_reccomendSum_QNAME = new QName("", "reccomendSum");
    ...
    private static final javax.xml.namespace.QName ns1_requiredSum_QNAME = new QName("", "requiredSum");
    private static final javax.xml.namespace.QName ns1_resource_QNAME = new QName("", "resource");
    ...
    public Request_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.fund.generated.Request instance = new com.rssl.phizicgate.wsgate.services.fund.generated.Request();
        com.rssl.phizicgate.wsgate.services.fund.generated.Request_SOAPBuilder builder = null;
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_expectedClosedDate_QNAME)) {
                member = ns3_myns3_dateTime__java_util_Calendar_DateTimeCalendar_Serializer.deserialize(ns1_expectedClosedDate_QNAME, reader, context);
                instance.setExpectedClosedDate((java.util.Calendar)member);
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_externalId_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.fund.generated.Request_SOAPBuilder();
                    }
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_reccomendSum_QNAME)) {
                member = ns3_myns3_decimal__java_math_BigDecimal_Decimal_Serializer.deserialize(ns1_reccomendSum_QNAME, reader, context);
                instance.setReccomendSum((java.math.BigDecimal)member);
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_requiredSum_QNAME)) {
                member = ns3_myns3_decimal__java_math_BigDecimal_Decimal_Serializer.deserialize(ns1_requiredSum_QNAME, reader, context);
                instance.setRequiredSum((java.math.BigDecimal)member);
                reader.nextElementContent();
            }
        }
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_resource_QNAME)) {
                member = ns3_myns3_string__java_lang_String_String_Serializer.deserialize(ns1_resource_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.fund.generated.Request_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myRESOURCE_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setResource((java.lang.String)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.fund.generated.Request instance = (com.rssl.phizicgate.wsgate.services.fund.generated.Request)obj;
    ...
    public void doSerializeInstance(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        ...
        ns3_myns3_dateTime__java_util_Calendar_DateTimeCalendar_Serializer.serialize(instance.getExpectedClosedDate(), ns1_expectedClosedDate_QNAME, null, writer, context);
        ...
        ns3_myns3_decimal__java_math_BigDecimal_Decimal_Serializer.serialize(instance.getReccomendSum(), ns1_reccomendSum_QNAME, null, writer, context);
        ns3_myns3_decimal__java_math_BigDecimal_Decimal_Serializer.serialize(instance.getRequiredSum(), ns1_requiredSum_QNAME, null, writer, context);
        ns3_myns3_string__java_lang_String_String_Serializer.serialize(instance.getResource(), ns1_resource_QNAME, null, writer, context);

...
public class CurrencyRate_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.rssl.phizicgate.wsgate.services.cache.generated.CurrencyRate instance = new com.rssl.phizicgate.wsgate.services.cache.generated.CurrencyRate();
        com.rssl.phizicgate.wsgate.services.cache.generated.CurrencyRate_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_dynamicExchangeRate_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.cache.generated.CurrencyRate_SOAPBuilder();
                    }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_fromCurrency_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setFromCurrency((com.rssl.phizicgate.wsgate.services.cache.generated.Currency)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_toCurrency_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setToCurrency((com.rssl.phizicgate.wsgate.services.cache.generated.Currency)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.cache.generated.CurrencyRate instance = (com.rssl.phizicgate.wsgate.services.cache.generated.CurrencyRate)obj;

...
public class EmployeeInfo_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final javax.xml.namespace.QName ns2_PersonName_TYPE_QNAME = new QName("http://generated.services.templates.gate.phizic.rssl.com", "PersonName");
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws java.lang.Exception {
        ...
        ns2_myPersonName_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, com.rssl.phizicgate.wsgate.services.template.generated.PersonName.class, ns2_PersonName_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.template.generated.EmployeeInfo instance = new com.rssl.phizicgate.wsgate.services.template.generated.EmployeeInfo();
        com.rssl.phizicgate.wsgate.services.template.generated.EmployeeInfo_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_employeeOffice_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.rssl.phizicgate.wsgate.services.template.generated.EmployeeInfo_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myEMPLOYEEOFFICE_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setEmployeeOffice((com.rssl.phizicgate.wsgate.services.template.generated.Office)member);
                }
                reader.nextElementContent();
            }
        }
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_personName_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    ...
                    instance.setPersonName((com.rssl.phizicgate.wsgate.services.template.generated.PersonName)member);
                }
                reader.nextElementContent();
            }
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.rssl.phizicgate.wsgate.services.template.generated.EmployeeInfo instance = (com.rssl.phizicgate.wsgate.services.template.generated.EmployeeInfo)obj;

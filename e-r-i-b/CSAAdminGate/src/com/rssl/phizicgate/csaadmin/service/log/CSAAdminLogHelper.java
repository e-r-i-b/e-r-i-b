 ...
 * @ $Revision$
 *
 * ’елпер логировани€ сообщений CSAAdmin
 */

public class CSAAdminLogHelper
{
	private static final Log log = PhizICLogFactory.getLog(Constants.LOG_MODULE_CORE);
	private static final com.rssl.phizic.logging.messaging.System SYSTEM_ID = System.CSAAdmin;
	...
	private static String serializeMessage(Message message) throws Exception
	{
		...
		SerializationContext context = new CSAAdminSerializationContext(writer, msgContext);

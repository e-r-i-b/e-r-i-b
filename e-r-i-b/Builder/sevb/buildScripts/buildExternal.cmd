...
call %~dp0\api\build.cmd "%~dp0\Toolkit\MS2005" HaspDummy
echo -----------------end compile retailJNI,armourJNI-----------------------

set MS_ROOT_FOLDER=%~dp0\Toolkit\MS
...
call %~dp0\tools\rsbridge\build.cmd
echo -----------------end compile RSBridge ----------------------------------

set IS5_ROOT_FOLDER=%~dp0\Toolkit\IS

echo -----------------start compile RSAlarm ----------------------------------
call %~dp0\tools\rsalarm\build.cmd 

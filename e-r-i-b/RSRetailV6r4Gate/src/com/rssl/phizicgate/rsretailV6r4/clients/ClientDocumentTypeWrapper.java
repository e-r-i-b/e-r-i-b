...
public class ClientDocumentTypeWrapper implements UserType
{
	...
	private static final String PENSION_CERTIFICATE     = "Пенсионное удостоверение";
	...
	static
	{
		...
		mapping.put(PENSION_CERTIFICATE, ClientDocumentType.PENSION_CERTIFICATE);
	}
	...
	public static ClientDocumentType parseState(String state)
	{

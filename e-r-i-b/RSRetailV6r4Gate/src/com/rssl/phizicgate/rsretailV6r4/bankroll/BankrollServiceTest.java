 ...
 * @ $Revision$
 */
public class BankrollServiceTest extends RSRetailV6r4GateTestCaseBase
{
	...
	public void testGetAdditionalCards() throws GateException, GateLogicException
    {
        try
        {
    ...
    public void testGetCardPrimaryAccount() throws IKFLException
    {
        BankrollServiceImpl service  = new BankrollServiceImpl(gateFactory);
	...
	public void testGetAccount() throws IKFLException
	{
		BankrollServiceImpl service  = new BankrollServiceImpl(gateFactory);
		Account account = GroupResultHelper.getOneResult(service.getAccount("10000012"));
	...
	public void testGetClientCards() throws IKFLException
    {
	...
	public void testGetCardInfo() throws IKFLException
    {
        BankrollServiceImpl service  = new BankrollServiceImpl(gateFactory);
        Card card = GroupResultHelper.getOneResult(service.getCard(EXTERNAL_CARD_ID));
	...
	public void testGetCardOverdraftInfo() throws IKFLException
    {
        BankrollServiceImpl service  = new BankrollServiceImpl(gateFactory);
        Card card = GroupResultHelper.getOneResult(service.getCard(EXTERNAL_CARD_ID));

...
public class DeviceActionTypeList  extends com.rssl.phizic.rsa.integration.ws.control.generated.ActionTypeList  implements java.io.Serializable {
    private com.rssl.phizic.rsa.integration.ws.control.generated.DeviceActionType[] deviceActionTypes;

    public DeviceActionTypeList() {
    }

    public DeviceActionTypeList(
           com.rssl.phizic.rsa.integration.ws.control.generated.DeviceActionType[] deviceActionTypes) {
     ...
     */
    public com.rssl.phizic.rsa.integration.ws.control.generated.DeviceActionType[] getDeviceActionTypes() {
        return deviceActionTypes;
    }
     ...
     */
    public void setDeviceActionTypes(com.rssl.phizic.rsa.integration.ws.control.generated.DeviceActionType[] deviceActionTypes) {
        this.deviceActionTypes = deviceActionTypes;
    }

    public com.rssl.phizic.rsa.integration.ws.control.generated.DeviceActionType getDeviceActionTypes(int i) {
        return this.deviceActionTypes[i];
    }

    public void setDeviceActionTypes(int i, com.rssl.phizic.rsa.integration.ws.control.generated.DeviceActionType _value) {

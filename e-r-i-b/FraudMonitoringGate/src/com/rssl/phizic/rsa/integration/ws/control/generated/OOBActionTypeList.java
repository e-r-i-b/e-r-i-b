...
public class OOBActionTypeList  extends com.rssl.phizic.rsa.integration.ws.control.generated.ActionTypeList  implements java.io.Serializable {
    private com.rssl.phizic.rsa.integration.ws.control.generated.OOBActionType[] oobActionType;

    public OOBActionTypeList() {
    }

    public OOBActionTypeList(
           com.rssl.phizic.rsa.integration.ws.control.generated.OOBActionType[] oobActionType) {
     ...
     */
    public com.rssl.phizic.rsa.integration.ws.control.generated.OOBActionType[] getOobActionType() {
        return oobActionType;
    }
     ...
     * @param oobActionType
     */
    public void setOobActionType(com.rssl.phizic.rsa.integration.ws.control.generated.OOBActionType[] oobActionType) {
        this.oobActionType = oobActionType;
    }

    public com.rssl.phizic.rsa.integration.ws.control.generated.OOBActionType getOobActionType(int i) {
        return this.oobActionType[i];
    }

    public void setOobActionType(int i, com.rssl.phizic.rsa.integration.ws.control.generated.OOBActionType _value) {

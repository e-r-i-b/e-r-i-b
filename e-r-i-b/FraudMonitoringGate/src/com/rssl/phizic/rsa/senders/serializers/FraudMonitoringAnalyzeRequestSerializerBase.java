...
import com.rssl.phizic.rsa.integration.ws.control.generated.RunRiskType;
 ...
 * @ $Author$
 * @ $Revision$
 * Базовый класс сериализации аналитических запросов во фрод-мониторинг
 */
public abstract class FraudMonitoringAnalyzeRequestSerializerBase extends FraudMonitoringCommonRequestSerializerBase<AnalyzeRequest>
{
	@Override
	...
	{
		RunRiskType runRiskType = getRequest().getRunRiskType();
		...
		return getRequest().getRunRiskType().getValue();
	}

 ...
 * @ $Author$
 * @ $Revision$
 * Билдер запросов на оповещение во фрод-мониторинг
 */
public class FraudMonitoringNotifyOfflineRequestBuilder extends FraudMonitoringAdaptiveAuthenticationOfflineRequestBuilderBase<NotifyRequest>
{
	@Override
	...
	{
		NotifyRequest result = super.build();

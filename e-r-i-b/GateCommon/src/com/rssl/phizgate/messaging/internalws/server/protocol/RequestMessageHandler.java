...
public class RequestMessageHandler extends DefaultHandler implements RequestInfo
{
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
	{
		...
		switch (state)
		{
			...
			case IP_CLOSE:
				assertStartTag(qName, Constants.MESSAGE_SYSTEM_TAG);
				state = State.SYSTEM_OPEN;
				break;
			case SYSTEM_OPEN:
				throw new SAXException("Ошибка разбора сообщения. Ожидается закрывающий тег: " + Constants.MESSAGE_SYSTEM_TAG);
			case SYSTEM_CLOSE:
				type = qName;
	...
	public void endElement(String uri, String localName, String qName) throws SAXException
	{
		switch (state)
		{
			...
			case VERSION_OPEN:
				...
				break;
			case VERSION_CLOSE:
				throw new SAXException("Ошибка разбора сообщения. Ожидается тег: " + Constants.MESSAGE_IP_TAG);
			case IP_OPEN:
				ip = getNotEmptyText(Constants.MESSAGE_IP_TAG);
				state = State.IP_CLOSE;
				break;
			case IP_CLOSE:
				throw new SAXException("Ошибка разбора сообщения. Ожидается тег: " + Constants.MESSAGE_SYSTEM_TAG);
			case SYSTEM_OPEN:
				state = State.SYSTEM_CLOSE;
				break;
			case SYSTEM_CLOSE:

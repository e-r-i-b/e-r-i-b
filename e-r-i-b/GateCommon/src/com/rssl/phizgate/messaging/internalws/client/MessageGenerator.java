...
public class MessageGenerator
{
	...
	public String buildMessage(Document body, String systemName)
	{
		...
		try
		{
			...
			serializer.startElement("", "", SYSTEM_TAG, empty);
			writeText(serializer, systemName);
			serializer.endElement("", "", SYSTEM_TAG);

...
public class ViewConfigRootImpl
    extends com.rssl.phizic.web.config.view.impl.ViewConfigTypeImpl
    implements com.rssl.phizic.web.config.view.ViewConfigRoot, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.rssl.phizic.web.config.view.impl.runtime.UnmarshallableObject, com.rssl.phizic.web.config.view.impl.runtime.XMLSerializable, com.rssl.phizic.web.config.view.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.rssl.phizic.web.config.view.ViewConfigRoot.class);
    }
    ...
    public com.rssl.phizic.web.config.view.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.rssl.phizic.web.config.view.impl.runtime.UnmarshallingContext context) {
        return new com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.Unmarshaller(context);
    }

    public void serializeBody(com.rssl.phizic.web.config.view.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("", "view-config");
...
+"eURIq\u0000~\u0000 xq\u0000~\u0000\u001bt\u00008com.rssl.phizic.web.config.view.ViewConfig"
+"Type.ListsTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elements"
...
+"g/2001/XMLSchema-instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0005listst\u0000\u0000q\u0000~\u0000\u001esq\u0000~\u0000\npp"
+"sq\u0000~\u0000\u0015q\u0000~\u0000\u000epq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000bview-configq\u0000~\u0000>sr\u0000\"com."
...
+"\u0000\u0007\u0001pq\u0000~\u0000\u0014q\u0000~\u0000\u000fq\u0000~\u0000$q\u0000~\u0000?q\u0000~\u0000\u0011q\u0000~\u0000\u000bq\u0000~\u0000\tx"));
        ...
        extends com.rssl.phizic.web.config.view.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("lists" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.rssl.phizic.web.config.view.impl.ViewConfigTypeImpl)com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        spawnHandlerFromEnterElement((((com.rssl.phizic.web.config.view.impl.ViewConfigTypeImpl)com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("view-config" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveElement((((com.rssl.phizic.web.config.view.impl.ViewConfigTypeImpl)com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromEnterAttribute((((com.rssl.phizic.web.config.view.impl.ViewConfigTypeImpl)com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((com.rssl.phizic.web.config.view.impl.ViewConfigTypeImpl)com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                    case  3 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            spawnHandlerFromText((((com.rssl.phizic.web.config.view.impl.ViewConfigTypeImpl)com.rssl.phizic.web.config.view.impl.ViewConfigRootImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                        case  3 :

...
<div class="workspace-box ${color} <c:if test="${not empty rightDataArea}">float</c:if>">
    <c:if test="${title != ''}">
        <div class="RTC mainTitle">
            <div class="Title <c:if test='${!empty controlLeft or !empty control}'>regionTitle</c:if>">

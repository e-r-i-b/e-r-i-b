...
<tiles:insert definition="paymentCurrent">
	...
	<tiles:put name="menu" type="string">
		 <tiles:insert definition="clientButton" flush="false" service="Abstract">
		 ...
		 <tiles:insert definition="clientButton" flush="false" service="Abstract">
		        <tiles:put name="commandTextKey" value="buttton.nex"/>
...
<c:set var="imagePath" value="${skinUrl}/images"/>
	...
	function displayPeriodList(event,action)
	{
		...
		win=window.open("${phiz:calculateActionURL(pageContext, '/private/PD4.do')}?action="+action,"","resizable=0,menubar=0,toolbar=0,scrollbars=0,status=0");

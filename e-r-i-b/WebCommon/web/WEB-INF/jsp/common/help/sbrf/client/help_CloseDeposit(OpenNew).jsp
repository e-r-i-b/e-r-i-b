...
<head>
<title>Помощь. Открытие вклада (закрыть счет списания)</title>
    ...
    <div class="help-container">
        ...
        <div id="help-content">
                ...
                <ul class="help-menu">
									...
									<li><a class="parentItem" href="/PhizIC/help.do?id=/private/accounts/list">Вклады и счета</a>
										<ul class="page-content">
											...
											<li><a class="active-menu" href="/PhizIC/help.do?id=/private/payments/payment/AccountOpeningClaimWithClose/null">
											Открытие вклада (закрыть счет списания)</a></li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Заявка на открытие вклада (закрыть счет списания)</div>
                    <ul class="page-content">
								...
								<p>На странице данной 
								Вы можете подать в банк заявку на открытие вклада с закрытием счета списания.</p>
								...
								<p>Для того чтобы закрыть вклад и перевести средства с него на новый вклад, Вам необходимо 
								в пункте главного меню <b>Вклады и счета</b> щелкнуть по ссылке <b>Открытие вклада
								 (закрыть счет списания)</b>.
								</p>
								...
								<p>Для каждого вида вклада отображается минимальный взнос или неснижаемый остаток, валюта, в которой можно открыть вклад, процентная ставка по вкладу и возможность совершения приходных и расходных операций. Если Вы хотите просмотреть полную информацию о вкладе,
                                ...
                                <p>Промовклады, то есть вклады с льготными ставками, выделены с списке оранжевым цветом.</p>

								<p>Для того чтобы открыть выбранный вклад, установите напротив него флажок и нажмите на кнопку <b>Продолжить</b>.
								Откроется форма заявки на открытие вклада с закрытием счета списания.
								</p>
								<h2><a id="p2">Создать заявку</a></h2>
								<p>При открытии вклада с закрытием счета списания на форме заявки нужно указать следующую информацию:

								<div class="help-important">
								<p>
								<span class="help-attention">Обратите 
								внимание</span>: поля "Номер документа", "Дата документа", "Дата закрытия", "Открыть вклад"
								 и "Дата открытия" заполнятся автоматически.  
								</p>
								</div> 
								<ul>
								<li>В поле "Закрыть вклад" выберите из выпадающего списка вклад, который Вы хотите закрыть.
								</li>
								...
								<li>Поле "Курс конверсии" заполняется автоматически по курсу банка.
								</li>
								...
								<ul>
								<li>Если Вы хотите вложить деньги на конкретный период, то установите переключатель в поле "На" и 
								введите период действия вклада, указав
								количество дней, месяцев и лет.
								</li>
								<li>Если Вы хотите вложить деньги до какой-либо конкретной даты, то установите
								переключатель в поле "До" и введите нужную дату, до которой будет действовать Ваш вклад. 
								Также Вы можете выбрать дату из календаря, щелкнув по кнопке <IMG border="0" src="${globalUrl}/commonSkin/images/datePickerCalendar.gif" alt=" height="20" width="20"">.
								</li>
								</ul>
								</li>
								</ul>							
							<div class="help-important">
								...
								<p>На форме создания заявки на открытие вклада по специальным ставкам в зависимости от бонусной программы будет дополнительно показана следующая информация:</p>
									...
									нажмите на кнопку <b>Отменить</b>. В 
								...
								действий:
									...
									<ul>
									<li><b>Просмотреть условия вклада</b>. Перед подтверждением заявки Вам необходимо сначала ознакомиться 
									с подробной информацией об условиях вклада, для этого щелкните по ссылке  <b>Просмотр условий вклада</b>. 
									</li>
									<li><b>Подтвердить заявку</b>. Убедитесь, что вся информация указана 
									верно. Затем, если Вы хотите закрыть счет списания и открыть вклад на предлагаемых условиях,
									...
									Затем при необходимости подтвердите операцию 
									...
									<li><b>Отредактировать заявку</b>. Если Вы хотите изменить реквизиты заявки, то нажмите на 
									ссылку <b>Редактировать</b>. В результате откроется страница создания заявки на открытие вклада с закрытием счета списания.
									</li>
								...
								<h2><a id="p4">Просмотреть заявку</a></h2>
									...
									<p>Для того чтобы распечатать чек, подтверждающий создание заявки на закрытие вклада, нажмите на кнопку 

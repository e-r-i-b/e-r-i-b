...
<head>
<title>Помощь. Перевод частному лицу</title>
    ...
    <div class="help-container">
        ...
        <div id="help-content">
                ...
                <ul class="help-menu">
									...
									<li><a class="parentItem" href="/PhizIC/help.do?id=/private/payments">Переводы и платежи</a>
										<ul class="page-content">
											...
											<li><a class="active-menu" href="/PhizIC/help.do?id=/private/payments/payment/NewRurPayment/null/ourBank">Перевод частному лицу</a></li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Переводы и платежи. Перевод частному лицу</div>
								...
								<ul class="page-content">
									...
									<p>На странице <b>Перевод частному лицу</b> Вы сможете 
									перевести деньги 
									...
									Личном меню</b>. Для того чтобы перейти на данную страницу,
									 ...
									 ссылке <b>Перевод частному лицу</b>.</p>
								...
								<h2><a id="p2">Перевести деньги</a></h2>
										...
										действия:</p>
									<ol>
									    <li>Выберите, кому Вы хотите перевести деньги. Для этого нажмите на одну их кнопок: <b>Клиенту Сбербанка</b>, <b>На Яндекс.Деньги</b>, <b>На карту другого банка</b>, <b>На банковский счет</b>.</li>
                                        <li>Если Вы выбрали операцию <b>Клиенту Сбербанка</b> или <b>На карту другого банка</b>, то заполните следующие поля:
                                            <ul>
                                                <li>В поле "Получатель" введите номер карты или номер телефона получателя перевода.
                                                    <div class="help-important">
                                                        <p>
                                                            ...
                                                            Для этого нажмите на ссылку <b>Выбрать из адресной книги</b>, затем укажите интересующего Вас получателя и щелкните по кнопке <b>Выбрать</b>.
                                                        </p>
                                                    </div>
                                                </li>
                                                ...
                                                <li> В поле "Написать сообщение получателю" укажите сообщение, которое будет отправлено получателю денежных средств на мобильный телефон, например, "Отдаю долг".</li>
                                            </ul>
                                        </li>
                                        <li>Если Вы выбрали операцию <b>На Яндекс.Деньги</b>, то
                                            заполните следующие поля формы:
                                            <ul>
                                                <li>В поле "Получатель" введите номер телефона или номер кошелька получателя перевода.
                                                    <div class="help-important">
                                                        <p>
                                                            <span class="help-attention">Обратите внимание</span>:
                                                            если Ваше мобильное приложение "Сбербанк Онлайн" синхронизировано с полной версией системы, то
                                                ...
                                                перевести деньги.</li>
                                                <li>В поле "Сумма" введите сумму перевода.</li>
                                                <li>Если Вы выполняете перевод по номеру телефона, то в поле "Написать сообщение получателю" укажите сообщение, которое будет отправлено получателю денежных средств на мобильный телефон, например, "Вернул 500 рублей".</li>

                                            </ul>
                                        </li>
                                        <li>Если Вы выбрали перевод <b>На банковский счет</b>, то
                                            заполните следующие поля:
									        <ul>
									
                                                <li>В поле "Номер счета" введите номер счета получателя перевода.</li>
                                                <li>Затем укажите фамилию получателя перевода, его имя и отчество.</li>
                                                <li>Далее в поле "ИНН" укажите идентификационный номер получателя в качестве налогоплательщика. </li>
                                                <li>В поле "Адрес" введите адрес проживания частного лица, которому переводите деньги.</li>
                                                <li>В поле <b>Наименование банка</b> выберите из справочника банк, в котором открыт счет получателя. Для того чтобы
                                                воспользоваться справочником, нажмите на ссылку <b>Выбрать из справочника</b>. В открывшемся окне установите флажок
                                                напротив нужного банка и нажмите на кнопку <b>Выбрать</b>. В результате поля "Наименование банка", "БИК" и "Корр. счет" заполнятся автоматически.
                                                </li>
                                                <li>В поле "Счет списания" выберите счет или карту, с которой Вы хотите перевести деньги.</li>

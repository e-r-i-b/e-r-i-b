...
<head>
<title>Помощь.Сберегательные Сертификаты</title>
        ...
        <div id="help-content">
            <div id="help-left-section">
                ...
                <ul class="help-menu">
									...
									<li><a class="active-menu" href="/PhizIC/help.do?id=/private/security/list ">Сертификаты</a>
									<ul>
									<li><a href="/PhizIC/help.do?id=/private/security/view">Информация по сертификату</a></li>
									</ul>
									</li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Сберегательные сертификаты</div>
								<p>На странице <b>Сертификаты</b> Вы можете
								просмотреть список всех непогашенных 
								сертификатов, которые Вы приобрели в Сбербанке РФ. 
								В случае если Вы передали сертификат третьему лицу, 
								он продолжит отображаться в списке Ваших 
								сертификатов до тех пор, пока не будет 
								обналичен новым владельцем. </p>
								<p>По каждому сертификату в списке Вы 
								можете просмотреть следующую информацию: 
								название сертификата, сумму, размещенную на вкладе, 
								к которому был выпущен сертификат, серию и номер сертификата, 
								процентную ставку по вкладу (% годовых), сумму дохода по 
								сертификату, дату его востребования и место хранения 
								сертификата.</P>
																																																				
									<p>Также Вы можете 
									перейти на страницу <b>с детальной 
									информацией по сертификату</b>. Для этого щелкните по названию
									интересующего Вас сертификата. В результате 
									система откроет страницу с подробной 
									информацией по данному сертификату. </P>
								...
								<p>В системе "Сбербанк Онлайн" на каждой странице можно обратиться 

...
<head>
<title>Помощь. Приостановление автоплатежа</title>
   ...
   <div class="help-container">
        ...
        <div id="help-content">
									...
									<li><a href="/PhizIC/help.do?id=/private/PersonMenu">Личное меню</a>
										<ul class="page-content">
											...
											<li><a class="parentItem" href="/PhizIC/help.do?id=/private/favourite/list/AutoPayments">Мои автоплатежи</a>
												<ul>
											<li><a class="active-menu" href="/PhizIC/help.do?id=/private/payments/payment/DelayAutoSubscriptionPayment/null/LongOffer">
											Приостановление автоплатежа</a></li>
												</ul>	
											</li>
											</ul>
											</li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Заявка на приостановление автоплатежа</div>
								<ul class="page-content">
									...
									<li><a href="#p4">Просмотреть заявку</a></li>
										...
										<p> На этой странице Вы можете подать в банк заявку на приостановление автоплатежа. 
										 Для этого Вам нужно на странице просмотра автоплатежа нажать на ссылку 
										<b>Приостановить</b>. Откроется форма создания заявки на приостановление автоплатежа.</p>
							...
							<p> Вы можете приостановить выполнение автоплатежа. Для этого на странице просмотра автоплатежа нажмите на ссылку <b>Приостановить</b>. 
							Откроется страница создания заявки на приостановку автоплатежа, на которой Вы можете просмотреть параметры автоплатежа. </p>
							<p>Затем если Вы хотите приостановить автоплатеж, нажмите на кнопку <b>Оформить заявку</b>. В результате Вы перейдете на страницу 
							подтверждения заявки. </p>
							<p>Для того чтобы вернуться на страницу детальной информации по автоплатежу, нажмите на ссылку <b>Назад</b>.</p>
								...
								то щелкните по ссылке <b>Отменить</b>.</p>

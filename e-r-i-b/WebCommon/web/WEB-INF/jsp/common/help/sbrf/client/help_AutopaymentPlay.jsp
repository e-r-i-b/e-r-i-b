...
<head>
<title>Помощь. Возобновление автоплатежа</title>
...
<div class="help-container">
        ...
        <div id="help-content">
                ...
                <p class="sidebarTitle">разделы руководства</p>
								...
								<li><a href="/PhizIC/help.do?id=/private/connectUdbo/connectUdbo">Больше Сбербанк Онлайн</a></li>
									...
									<li><a href="/PhizIC/help.do?id=/private/graphics/finance">Мои финансы</a></li>
											...
											<li><a class="active-menu" href="/PhizIC/help.do?id=/private/payments/payment/PlayAutoSubscriptionPayment/null/LongOffer">
											Возобновление автоплатежа</a></li>
										</ul>	</li>
										</ul></li>
										...
										<li><a href="/PhizIC/help.do?id=/private/userprofile">Настройки</a></li>								</ul>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Заявка на возобновление автоплатежа</div>
                   				<ul class="page-content">
									...
									<li><a href="#p4">Просмотреть заявку</a></li>
										...
										<p> На этой странице Вы можете подать в банк заявку на возобновление автоплатежа, который 
										был приостановлен. 
								...
								<div class="help-important">
									<p>
										...
										<p>Для того чтобы подать в банк заявку на возобновление автоплатежа, Вам нужно на 
										форме создания заявки просмотреть реквизиты заявки.
										</p>
										<p>Затем, если Вы хотите возобновить автоплатеж, нажмите на кнопку <b>Оформить заявку</b>. В результате Вы перейдете на страницу подтверждения заявки. </p>
							...
							<div class="help-important">
								...
								<h2><a id="p4">Просмотреть заявку</a></h2>
									...
									увидите заполненный документ.</p>
 										   ...
 										   <p>О том, что что заявка передана в банк, 

...
<head>
<title>Помощь. Отмена автоплатежа (регулярной операции)</title>
    ...
    <div class="help-container">
        ...
        <div id="help-content">
									...
									<li><a href="/PhizIC/help.do?id=/private/PersonMenu">Личное меню</a></li>
										<ul class="page-content">
											...
											<li><a class="parentItem" href="/PhizIC/help.do?id=/private/favourite/list/AutoPayments">Мои автоплатежи</a>
												<ul>
													<li><a class="active-menu" href="/PhizIC/help.do?id=/private/payments/payment/RefuseLongOffer/refuse-long-offer-extended-fields">Отмена автоплатежа</a></li>
												</ul>	
											</li>
										</ul>
									</li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Заявка на отмену автоплатежа</div>
...
<ul class="page-content">
							...
							<p>Для того чтобы отменить автоплатеж
 										   до наступления даты его окончания, Вам необходимо на форме просмотра регулярной операции нажать на кнопку <b>Отменить платеж</b>. 
 										   Откроется форма отмены автоплатежа. </p>
									...
									<p>
										...
										<p>На форме отмены автоплатежа (регулярной операции) проверьте реквизиты платежа и 
 										   нажмите на кнопку <b>Продолжить</b>. В результате Вы перейдете на форму подтверждения заявки на
 										   отмену автоплатежа. </p>
 										<p>Для того чтобы вернуться на предыдущую страницу, щелкните по ссылке <b>Назад</b>.</p>
 										   <p>Если Вы не хотите отменять платеж, 
 										   то нажмите на ссылку <b>Отменить</b>, и Вы вернетесь на страницу <b>Переводы и платежи</b>.</p>
												<div class="help-important">
		<p>
		<span class="help-attention">Обратите 
		...
		"Подтверждение".  
								...
								сведений.</p> 
								<p>На этой странице Вам нужно подтвердить операцию 
								одноразовым паролем из SMS, Push-сообщения или паролем с чека. Для того чтобы подтвердить операцию по SMS, нажмите на кнопку <b>Подтвердить по SMS</b>.</p>  
								<p>В случае если Вы хотите подтвердить операцию другим способом, нажмите на 
									...
									Затем откроется всплывающее окно, в котором введите одноразовый пароль и нажмите на кнопку <b>Подтвердить</b>. В результате 
									Вы перейдете на страницу просмотра заявки.</p>
									<p>Если Вы не хотите отменять платеж, 
 										   то нажмите на ссылку <b>Отменить</b>, и Вы вернетесь на страницу <b>Переводы и платежи</b>.</p>
								...
								<h2><a id="p4">Просмотреть заявку</a></h2>
									...
									увидите заполненный документ. О том, что что операция успешно выполнена банком, 
 									свидетельствует отображаемый на форме документа штамп "Исполнено". </p>
									<p>На этой странице Вы 
									сможете <b>просмотреть реквизиты</b> выполненной 
									заявки.</p>
									<p>Если Вы хотите перейти к странице <b>Переводы и платежи</b>, то щелкните по ссылке <b>Перейти к странице платежей</b>.</p>

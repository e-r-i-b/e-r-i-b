...
<head>
<title>Помощь. Перевод частному лицу на карту в другой банк</title>
    ...
    <div class="help-container">
        ...
        <div id="help-content">
                ...
                <ul class="help-menu">
									...
									<li><a class="parentItem" href="/PhizIC/help.do?id=/private/payments">Переводы и платежи</a>
										<ul class="page-content">
											...
											<li><a class="active-menu" href="/PhizIC/help.do?id=/private/payments/payment/RurPayment/null/externalCard">Перевод на карту в другом банке</a></li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Переводы и платежи. Перевод на карту в другом банке</div>
								<ul class="page-content">
									<li><a href="#p2">Перевести деньги</a></li>
									<li><a href="#p3">Подтвердить перевод</a></li>
									<li><a href="#p4">Просмотреть перевод</a></li>
								</ul>
									<p>На странице <b>Перевод на карту в другом банке</b> Вы сможете 
									...
									Личном меню</b>. Для того чтобы перейти на данную страницу,
									 ...
									 ссылке <b> Перевод на карту в другом банке</b>.</p>
								...
								<h2><a id="p2">Перевести деньги</a></h2>
										<p>Если Вы хотите совершить перевод денежных средств на карту частному лицу, то заполните следующие поля:</p>
								<div class="help-important">
									<p>
									...
									<ul>
									<li>В поле "Номер карты получателя" 
									введите номер карты получателя платежа. 
									</li>
									...
									<p>
										<span class="help-attention">Обратите 
										внимание</span>: если Вы указали карту получателя, оформленную в Сбербанке, то на следующей странице автоматически будет заполнено поле "ФИО" получателя, и появится дополнительное поле для ввода сообщения, которое будет отправлено получателю перевода на мобильный телефон.  
									</p>
								</div> 

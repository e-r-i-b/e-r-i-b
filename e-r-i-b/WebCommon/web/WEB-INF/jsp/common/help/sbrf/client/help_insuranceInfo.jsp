...
<head>
<title>Помощь. Информация по страховому продукту</title>
        ...
        <div id="help-content">
            <div id="help-left-section">
                ...
                <ul class="help-menu">
									...
									<li><a class="parentItem" href="/PhizIC/help.do?id=/private/insurance/list">Страховые программы</a>
										<ul>
											<li><a class="active-menu" href="/PhizIC/help.do?id=/private/insurance/view">Информация по страховому продукту</a></li>
										</ul>
									</li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Страховые программы. Информация по страховому продукту</div>

									<p>По каждому страховому продукту Вы можете 
									просмотреть детальную информацию. Для этого 
									в пункте главного меню <b>Страховые программы</b> щелкните по названию или номеру 
									выбранной страховой программы. В результате откроется 
									страница детальной информации, на 
									которой будет показано название программы, номер Вашего индивидуального лицевого счета, страховая компания, статус программы и срок ее окончания. </P>
								<p>В блоке <b>Детальная информация</b> система выведет на экран следующие сведения:</P>
									<ul>
										...
										например, "Страхование жизни жены". Для того чтобы 
										отредактировать название программы, нажмите на значок <IMG border="0" src="${globalUrl}/commonSkin/images/pencil.gif" alt="">, измените наименование и нажмите на 
										кнопку <b>Сохранить</b>. Если Вы не укажете 
										название, то в списке для данной программы 
										будет вместо названия отображаться название, заданное по умолчанию.
										</li>
										...
										<li><b>Дата начала действия страховки</b> - дата, когда был заключен договор страхования;</li>
										...
										<li><b>Дополнительная информация</b> - дополнительная информация о программе страхования;
										<li><b>Статус</b> - состояние, в котором находится программа на данный момент, например, "Действует";
										</li>
										<li> <b>№ СНИЛС</b> - номер Вашего индивидуального лицевого счета по договору страхования;</li>
									</ul>
							<p>Также Вы можете <b>распечатать дополнительную информацию по страховой программе</b>, для этого щелкните по ссылке <b>Печать</b>.</p>

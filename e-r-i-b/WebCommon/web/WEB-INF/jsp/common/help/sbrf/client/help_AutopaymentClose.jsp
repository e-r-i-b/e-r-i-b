...
<head>
<title>Помощь. Закрыть автоплатеж (регулярную операцию)</title>
  ...
  <div class="help-container">
        ...
        <div id="help-content">
                ...
                <p class="sidebarTitle">разделы руководства</p>
								<ul class="help-menu">
									...
									<ul>
											...
											<li><a class="active-menu" href="/PhizIC/help.do?id=/private/payments/payment/CloseAutoSubscriptionPayment/null/LongOffer">
											Закрытие автоплатежа</a></li>
										</ul>	</li>
            ...
            <div id="help-workspace">
                <div class="contextTitle">Заявка на отключение автоплатежа</div>
						<ul class="page-content">
							...
							<p>Для того чтобы отключить автоплатеж (прекратить выполнение операций по нему), Вам необходимо на форме просмотра автоплатежа/регулярной операции нажать на ссылку <b>Отключить</b>. 
 										   Откроется заявка на отключение автоплатежа. </p>
								<div class="help-important">
									<p>
										...
										<p>На форме отключения автоплатежа (регулярной операции) проверьте реквизиты платежа и 
 										   нажмите на кнопку <b>Оформить заявку</b>. В результате Вы перейдете на форму подтверждения заявки на
 										   закрытие автоплатежа. </p>
 										<p>Для того чтобы вернуться на страницу детальной информации по автоплатежу, щелкните по ссылке <b>Назад</b>.</p>
 										   <p>Если Вы не хотите отменять автоплатеж, 
 										   то нажмите на ссылку <b>Отменить</b>, и Вы вернетесь на страницу <b>
		...
		"Подтверждение".  
								...
								действий:
									...
									На странице подтверждения Вам необходимо выбрать, 
									каким способом Вы хотите подтвердить заявку:</p>
										<ul>

...
<c:choose>
    <c:when test="${hideable}">
                ${gridData}
                    ...
                    <c:set var="relText" value="Скрыть операции"/>
                    <c:set var="mainText" value="Показать операции"/>
                    <c:set var="aditionalClass" value=""/>
                    <c:if test="${empty show or show}">
                        <c:set var="relText" value="Показать операции"/>
                        <c:set var="mainText" value="Скрыть операции"/>
